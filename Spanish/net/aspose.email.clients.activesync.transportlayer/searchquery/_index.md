...
type: docs
weight: 1960
url: /es/net/aspose.email.clients.activesync.transportlayer/searchquery/
---
## SearchQuery class
...
| Nombre | Descripción |
| --- | --- |
| [SearchQuery](searchquery)() | Constructor predeterminado |

## Propiedades

| Nombre | Descripción |
| --- | --- |
| [And](../../aspose.email.clients.activesync.transportlayer/searchquery/and) { get; set; } | Especifica las palabras clave que se utilizarán para hacer coincidir las entradas en la tienda que se está buscando. |
| [EqualTo](../../aspose.email.clients.activesync.transportlayer/searchquery/equalto) { get; set; } | Especifica una propiedad y un valor que se comparan para una condición "Igual a" durante una búsqueda. |
