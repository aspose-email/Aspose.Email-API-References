...
type: docs
weight: 12760
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/removeimgroupresponsemessagetype/
---
## RemoveImGroupResponseMessageType class

```csharp
public class RemoveImGroupResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [RemoveImGroupResponseMessageType](removeimgroupresponsemessagetype)() | Constructor predeterminado |
