...
type: docs
weight: 13880
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/setteammailboxresponsemessagetype/
---
## SetTeamMailboxResponseMessageType class

```csharp
public class SetTeamMailboxResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [SetTeamMailboxResponseMessageType](setteammailboxresponsemessagetype)() | Constructor predeterminado |
