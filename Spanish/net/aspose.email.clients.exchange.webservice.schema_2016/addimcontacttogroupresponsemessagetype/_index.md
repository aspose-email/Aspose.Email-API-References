...
type: docs
weight: 4340
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/addimcontacttogroupresponsemessagetype/
---
## AddImContactToGroupResponseMessageType class

```csharp
public class AddImContactToGroupResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [AddImContactToGroupResponseMessageType](addimcontacttogroupresponsemessagetype)() | Constructor predeterminado |
