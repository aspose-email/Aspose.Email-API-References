...
type: docs
weight: 6870
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/disconnectphonecallresponsemessagetype/
---
## DisconnectPhoneCallResponseMessageType class

```csharp
public class DisconnectPhoneCallResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [DisconnectPhoneCallResponseMessageType](disconnectphonecallresponsemessagetype)() | Constructor predeterminado |
