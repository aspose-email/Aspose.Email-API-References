...
type: docs
weight: 150
url: /fr/net/aspose.email.personalinfo.vcard/vcardcontact/save/
---
## Save(string) {#save_3}
...
Enregistre ceci[`MapiContact`](../../../aspose.email.mapi/mapicontact) dans le fichier à l'aide des options d'enregistrement spécifiées. Les options d'enregistrement prises en charge sont[`VCardSaveOptions`](../../vcardsaveoptions)
...
Enregistre ceci[`MapiContact`](../../../aspose.email.mapi/mapicontact) au flux donné avec un format utilisant les options par défaut. Le format de sauvegarde pris en charge est vCard
...
Enregistre ceci[`MapiContact`](../../../aspose.email.mapi/mapicontact) au flux donné en utilisant les options de sauvegarde spécifiées. Les options de sauvegarde prises en charge sont[`VCardSaveOptions`](../../vcardsaveoptions)
