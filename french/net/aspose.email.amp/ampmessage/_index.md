...
description: Message qui permet aux expéditeurs dinclure des composants AMP dans les e-mails.
type: docs
weight: 140
url: /fr/net/aspose.email.amp/ampmessage/
---
## AmpMessage class

Message qui permet aux expéditeurs d'inclure des composants AMP dans les e-mails.
...
| Nom | La description |
| --- | --- |
| [AmpMessage](ampmessage)() | Initialise une nouvelle instance du[`MailMessage`](../../aspose.email/mailmessage) classe |
...
| virtual [AmpHtmlBody](../../aspose.email.amp/ampmessage/amphtmlbody) { get; set; } | Obtient la représentation AmpHtml du corps du message. |
...
| [AddAmpComponent](../../aspose.email.amp/ampmessage/addampcomponent)(AmpComponent) | Ajouter un composant Amp à ce message. |
| virtual [AddAttachment](../../aspose.email/mailmessage/addattachment)(Attachment) | Ajouter une pièce jointe au message |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner) | Crée un message signé. Crée une copie en lecture seule du MailMessage spécifié et y ajoute une signature numérique. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2) | Crée un message signé. Crée une copie en lecture seule du MailMessage spécifié et y ajoute une signature numérique. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner, bool) | Crée un message signé. Crée une copie en lecture seule du MailMessage spécifié et y ajoute une signature numérique. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2, bool) | Crée un message signé. Crée une copie en lecture seule du MailMessage spécifié et y ajoute une signature numérique. |
...
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt)() | décrypte ce message |
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt)(X509Certificate2) | décrypte ce message |
...
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt)(X509Certificate2) | Crypte ce message |
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt)(X509Certificate2[]) | Crypte ce message |
...
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext)(bool) | Récupère le corps du message HTML en texte brut. Cette méthode analyse la propriété HtmlBody et renvoie le contenu en texte brut en ignorant le balisage html. |
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext)(HyperlinkRenderingCallback) | Obtient le message htmlbody en texte brut. |
...
| virtual [Save](../../aspose.email/mailmessage/save)(Stream) | Enregistrer le message en tant que flux |
| virtual [Save](../../aspose.email/mailmessage/save)(string) | Enregistrer le message en tant que fichier |
| override [Save](../../aspose.email.amp/ampmessage/save#save_1)(Stream, SaveOptions) | Enregistrer le message en tant que flux |
| virtual [Save](../../aspose.email/mailmessage/save)(string, SaveOptions) | Enregistrer le message dans un fichier avec des options supplémentaires. |
