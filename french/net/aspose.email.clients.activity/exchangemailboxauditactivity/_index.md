...
type: docs
weight: 2520
url: /fr/net/aspose.email.clients.activity/exchangemailboxauditactivity/
---
...
| [Item](../../aspose.email.clients.activity/exchangemailboxauditactivity/item) { get; set; } | Représente l'élément sur lequel l'opération a été effectuée |
| [ModifiedProperties](../../aspose.email.clients.activity/exchangemailboxauditactivity/modifiedproperties) { get; set; } | À déterminer |
...
| [SendAsUserMailboxGuid](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendasusermailboxguid) { get; set; } | Le GUID Exchange de la boîte aux lettres à laquelle on a accédé pour envoyer des e-mails en tant que. |
| [SendAsUserSmtp](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendasusersmtp) { get; set; } | Adresse SMTP de l'utilisateur dont l'identité est usurpée. |
| [SendonBehalfOfUserMailboxGuid](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendonbehalfofusermailboxguid) { get; set; } | Le GUID Exchange de la boîte aux lettres à laquelle on a accédé pour envoyer du courrier au nom de. |
| [SendOnBehalfOfUserSmtp](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendonbehalfofusersmtp) { get; set; } | Adresse SMTP de l'utilisateur au nom duquel l'e-mail est envoyé. |
