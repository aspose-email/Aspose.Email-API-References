...
description: Le MessageInfo représente les informations sur lélément de serveur extraites du service Graph.
type: docs
weight: 15990
url: /fr/net/aspose.email.clients.graph/messageinfo/
---
## MessageInfo class

Le MessageInfo représente les informations sur l'élément de serveur extraites du service Graph.
...
| virtual [ItemId](../../aspose.email.clients.graph/messageinfo/itemid) { get; } | Obtient l'URI du message. |
