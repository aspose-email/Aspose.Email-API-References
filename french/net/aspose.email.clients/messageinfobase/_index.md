...
description: Le MessageInfo représente les informations de message e-mail extraites du serveur de messagerie.
type: docs
weight: 16760
url: /fr/net/aspose.email.clients/messageinfobase/
---
## MessageInfoBase class

Le MessageInfo représente les informations de message e-mail extraites du serveur de messagerie.
...
| Nom | La description |
| --- | --- |
| [MessageInfoBase](messageinfobase)() | Initialise une nouvelle instance du[`MessageInfoBase`](../messageinfobase) classe. |
