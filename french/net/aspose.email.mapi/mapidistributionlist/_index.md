...
description: Représente lobjet Liste de diffusion personnelle.
type: docs
weight: 18360
url: /fr/net/aspose.email.mapi/mapidistributionlist/
---
## MapiDistributionList class

Représente l'objet Liste de diffusion personnelle.
...
| Nom | La description |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Initialise une nouvelle instance du[`MapiDistributionList`](../mapidistributionlist) classe. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Initialise une nouvelle instance du[`MapiDistributionList`](../mapidistributionlist) classe. |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | Obtient ou définit le nom visible par l'utilisateur de la liste de distribution personnelle. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | L'identifiant de l'élément, utilisé avec un serveur |
| [Members](../../aspose.email.mapi/mapidistributionlist/members) { get; } | Obtient la liste des membres de la liste de diffusion personnelle. |
...
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save)(Stream) | Enregistre le flux spécifié. |
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save_1)(string) | Enregistre le nom de fichier spécifié. |
