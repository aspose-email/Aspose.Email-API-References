...
description: Représente la classe de base pour MapiAttachment./mapiattachment  MapiRecipient./mapirecipient  MapiMessage./mapimessage .
type: docs
weight: 18580
url: /fr/net/aspose.email.mapi/mapipropertycontainer/
---
## MapiPropertyContainer class

Représente la classe de base pour [`MapiAttachment`](../mapiattachment) , [`MapiRecipient`](../mapirecipient) , [`MapiMessage`](../mapimessage) .
...
| [GetPropertyString](../../aspose.email.mapi/mapipropertycontainer/getpropertystring#getpropertystring)(long) | Obtient la valeur de chaîne de la propriété spécifiée par tag. |
| [GetPropertyString](../../aspose.email.mapi/mapipropertycontainer/getpropertystring#getpropertystring_1)(long, int) | Obtient la valeur de chaîne de la propriété spécifiée par tag. |
...
| virtual [SetProperty](../../aspose.email.mapi/mapipropertycontainer/setproperty#setproperty)(MapiProperty) | Définit la propriété. |
| virtual [SetProperty](../../aspose.email.mapi/mapipropertycontainer/setproperty#setproperty_1)(PropertyDescriptor, object) | Définit la propriété MAPI. |
...
| [TryGetPropertyString](../../aspose.email.mapi/mapipropertycontainer/trygetpropertystring#trygetpropertystring_2)(long) | Essayez d'obtenir une donnée de propriété sous forme de chaîne avec la balise spécifiée. |
| [TryGetPropertyString](../../aspose.email.mapi/mapipropertycontainer/trygetpropertystring#trygetpropertystring_3)(long, int) | Essayez d'obtenir une donnée de propriété sous forme de chaîne avec une balise et une page de code spécifiées. |
| [TryGetPropertyString](../../aspose.email.mapi/mapipropertycontainer/trygetpropertystring#trygetpropertystring)(long, ref string) | Obtient la valeur de la propriété spécifiée en tant que type String. Une valeur de retour indique si l'opération a réussi. |
| [TryGetPropertyString](../../aspose.email.mapi/mapipropertycontainer/trygetpropertystring#trygetpropertystring_1)(long, ref string, int) | Obtient la valeur de la propriété spécifiée en tant que type String. Une valeur de retour indique si l'opération a réussi. |
