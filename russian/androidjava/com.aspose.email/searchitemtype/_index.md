...
description: Обеспечивает значения типов элементов для ограничения результатов поиска только определённым типом элемента.
type: docs
weight: 382
url: /ru/androidjava/com.aspose.email/searchitemtype/
---
...
Обеспечивает значения типов элементов для ограничения результатов поиска только определённым типом элемента.
## Поля
