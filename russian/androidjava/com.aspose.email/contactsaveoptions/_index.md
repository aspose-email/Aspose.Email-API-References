...
description: Представляет базовые параметры сохранения контакта
type: docs
weight: 84
url: /ru/androidjava/com.aspose.email/contactsaveoptions/
---
...
Представляет базовые параметры сохранения контакта
## Methods
