...
description: Представляет доступные форматы, в которые можно сохранить.
type: docs
weight: 317
url: /ru/androidjava/com.aspose.email/messageobjectsaveformat/
---
...
Представляет доступные форматы, в которые можно сохранить [MessageObject](../../com.aspose.email/messageobject).
## Поля
