...
description: Перечисляет тип завершения повторения.
type: docs
weight: 219
url: /ru/androidjava/com.aspose.email/mapicalendarrecurrenceendtype/
---
...
Перечисляет тип завершения повторения.
## Поля

| Поле | Описание |
| --- | --- |
| [EndAfterDate](#EndAfterDate) | Окончание после даты. |
| [EndAfterNOccurrences](#EndAfterNOccurrences) | Окончание после N повторений. |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NeverEnd](#NeverEnd) | Никогда не заканчивается. |
| [None](#None) | Значения не установлены |
## Methods
