...
description: Определяет классификацию доступа для встречи.
type: docs
weight: 28
url: /ru/androidjava/com.aspose.email/appointmentclass/
---
...
Определяет классификацию доступа для встречи.
## Поля
