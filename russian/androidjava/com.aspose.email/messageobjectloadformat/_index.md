...
description: Представляет доступные форматы, из которых можно загрузить.
type: docs
weight: 312
url: /ru/androidjava/com.aspose.email/messageobjectloadformat/
---
...
Представляет доступные форматы, из которых можно загрузить [MessageObject](../../com.aspose.email/messageobject).
## Поля
