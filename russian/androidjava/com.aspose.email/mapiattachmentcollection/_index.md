...
description: Представляет коллекцию объектов MapiAttachment.
type: docs
weight: 204
url: /ru/androidjava/com.aspose.email/mapiattachmentcollection/
---
...
Представляет коллекцию объектов MapiAttachment.
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiAttachmentCollection()](#MapiAttachmentCollection--) | Инициализирует новый экземпляр класса [MapiAttachmentCollection](../../com.aspose.email/mapiattachmentcollection). |
| [MapiAttachmentCollection(MapiMessageItemBase owner)](#MapiAttachmentCollection-com.aspose.email.MapiMessageItemBase-) | Инициализирует новый экземпляр класса MapiAttachmentCollection. |
## Methods
...
| [add(String name, byte[] data)](#add-java.lang.String-byte---) | Добавляет новое вложение. |
| [add(String name, MapiMessage msg)](#add-java.lang.String-com.aspose.email.MapiMessage-) | Добавляет новое вложение как встроенное сообщение. |
...
| [addMapiAttachment(MapiAttachment item)](#addMapiAttachment-com.aspose.email.MapiAttachment-) | Добавляет объект в конец System.Collections.ObjectModel.Collection1. |
...
| [insert(int index, String name, MapiMessage msg)](#insert-int-java.lang.String-com.aspose.email.MapiMessage-) | Вставляет сообщение в виде вложения в [MapiAttachmentCollection](../../com.aspose.email/mapiattachmentcollection) по указанному индексу. |
| [insertItem(int arg0, T arg1)](#insertItem-int-T-) |  |
| [insertMapiAttachment(int index, MapiAttachment item)](#insertMapiAttachment-int-com.aspose.email.MapiAttachment-) | Вставляет элемент в System.Collections.ObjectModel.Collection1 по указанному индексу. |
...
| [removeAt(int index)](#removeAt-int-) | Удаляет элемент по указанному индексу из MapiAttachmentCollection. |
| [removeItem(T arg0)](#removeItem-T-) |  |
| [removeMapiAttachment(MapiAttachment item)](#removeMapiAttachment-com.aspose.email.MapiAttachment-) | Удаляет первое вхождение конкретного объекта из MapiAttachmentCollection. |
| [removeRange(int arg0, int arg1)](#removeRange-int-int-) |  |
| [replace(int index, String name, MapiMessage msg)](#replace-int-java.lang.String-com.aspose.email.MapiMessage-) | Заменяет элемент по указанному индексу. |
...
Инициализирует новый экземпляр класса [MapiAttachmentCollection](../../com.aspose.email/mapiattachmentcollection).
...
| --- | --- | --- |
| owner | [MapiMessageItemBase](../../com.aspose.email/mapimessageitembase) | Сообщение‑владелец. |
...
| --- | --- | --- |
| name | java.lang.String | Имя вложения. |
| msg | [MapiMessage](../../com.aspose.email/mapimessage) | Объект [MapiMessage](../../com.aspose.email/mapimessage), представляющий вложенное сообщение. |
...
| Parameter | Type | Описание |
| --- | --- | --- |
| item | [MapiAttachment](../../com.aspose.email/mapiattachment) | Объект, который будет добавлен в конец коллекции System.Collections.ObjectModel.Collection1. Значение может быть null для ссылочных типов. |
...
Вставляет сообщение в виде вложения в [MapiAttachmentCollection](../../com.aspose.email/mapiattachmentcollection) по указанному индексу.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| индекс | int | Нулевой индекс, по которому должно быть вставлено. |
| name | java.lang.String | Имя вложения. |
| msg | [MapiMessage](../../com.aspose.email/mapimessage) | Объект [MapiMessage](../../com.aspose.email/mapimessage), представляющий вложенное сообщение. |
...
| item | [MapiAttachment](../../com.aspose.email/mapiattachment) | Объект для вставки. Значение может быть null для ссылочных типов. |
...
Удаляет элемент по указанному индексу из MapiAttachmentCollection.
...
Удаляет первое вхождение конкретного объекта из MapiAttachmentCollection.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| item | [MapiAttachment](../../com.aspose.email/mapiattachment) | Объект, который нужно удалить из MapiAttachmentCollection. |
...
| Parameter | Type | Описание |
| --- | --- | --- |
| индекс | int | Нулевой индекс, по которому должно быть заменено. |
| name | java.lang.String | Имя вложения. |
| msg | [MapiMessage](../../com.aspose.email/mapimessage) | Объект [MapiMessage](../../com.aspose.email/mapimessage), представляющий вложенное сообщение. |
