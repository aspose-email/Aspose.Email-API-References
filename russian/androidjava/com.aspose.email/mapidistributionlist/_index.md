...
description: Представляет объект персонального списка рассылки.
type: docs
weight: 249
url: /ru/androidjava/com.aspose.email/mapidistributionlist/
---
...
Представляет объект персонального списка рассылки.
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiDistributionList()](#MapiDistributionList--) | Инициализирует новый экземпляр класса [MapiDistributionList](../../com.aspose.email/mapidistributionlist). |
| [MapiDistributionList(String displayName, MapiDistributionListMemberCollection members)](#MapiDistributionList-java.lang.String-com.aspose.email.MapiDistributionListMemberCollection-) | Инициализирует новый экземпляр класса [MapiDistributionList](../../com.aspose.email/mapidistributionlist). |
## Methods
...
| [getDisplayName()](#getDisplayName--) | Получает или задает имя списка рассылки, видимое пользователем. |
| [getItemId()](#getItemId--) | Идентификатор элемента, используется с сервером. |
| [getMembers()](#getMembers--) | Получает список участников личного списка рассылки. |
...
| [setDisplayName(String value)](#setDisplayName-java.lang.String-) | Получает или задает имя списка рассылки, видимое пользователем. |
...
Инициализирует новый экземпляр класса [MapiDistributionList](../../com.aspose.email/mapidistributionlist).
...
Получает или задает имя списка рассылки, видимое пользователем.
...
Получает список участников личного списка рассылки.
