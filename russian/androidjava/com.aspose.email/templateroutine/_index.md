...
description: Представляет процедуру, используемую в файле шаблона.
type: docs
weight: 400
url: /ru/androidjava/com.aspose.email/templateroutine/
---
...
Представляет процедуру, используемую в файле шаблона.
## Constructors
