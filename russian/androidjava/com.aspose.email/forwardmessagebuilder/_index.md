...
type: docs
weight: 151
url: /ru/androidjava/com.aspose.email/forwardmessagebuilder/
---
...
| Method | Описание |
| --- | --- |
| [buildResponse(MailMessage msg)](#buildResponse-com.aspose.email.MailMessage-) | Создает сообщения переадресации. |
| [buildResponse(MapiMessage msg)](#buildResponse-com.aspose.email.MapiMessage-) | Создает сообщения переадресации. |
