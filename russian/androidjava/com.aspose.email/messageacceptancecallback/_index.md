...
description: Функция обратного вызова, вызываемая в процессе конвертации.
type: docs
weight: 302
url: /ru/androidjava/com.aspose.email/messageacceptancecallback/
---
...
Функция обратного вызова, вызываемая в процессе конвертации.
## Constructors
