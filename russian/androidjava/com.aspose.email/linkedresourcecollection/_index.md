...
type: docs
weight: 178
url: /ru/androidjava/com.aspose.email/linkedresourcecollection/
---
...
| [clear()](#clear--) |  |
| [clear(boolean removeHtmlLinks)](#clear-boolean-) | Удаляет все элементы из этой коллекции. |
| [close()](#close--) |  |
...
| [insertItem(int index, LinkedResource item)](#insertItem-int-com.aspose.email.LinkedResource-) | Вставляет элемент в System.Collections.ObjectModel.Collection1 по указанному индексу. |
| [isReadOnly()](#isReadOnly--) |  |
| [iterator()](#iterator--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [removeAt(int arg0)](#removeAt-int-) |  |
| [removeAt(int index, boolean removeHtmlLink)](#removeAt-int-boolean-) | Удаляет элемент с указанным индексом из этой коллекции. |
...
| item | [LinkedResource](../../com.aspose.email/linkedresource) | Объект для вставки. Значение может быть null для ссылочных типов. |
