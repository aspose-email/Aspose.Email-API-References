...
description: Представляет еженедельный шаблон повторения календаря mapi
type: docs
weight: 231
url: /ru/androidjava/com.aspose.email/mapicalendarweeklyrecurrencepattern/
---
...
Представляет еженедельный шаблон повторения календаря mapi
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiCalendarWeeklyRecurrencePattern()](#MapiCalendarWeeklyRecurrencePattern--) | Инициализирует новый экземпляр класса [MapiCalendarWeeklyRecurrencePattern](../../com.aspose.email/mapicalendarweeklyrecurrencepattern) |
## Methods
...
Инициализирует новый экземпляр класса [MapiCalendarWeeklyRecurrencePattern](../../com.aspose.email/mapicalendarweeklyrecurrencepattern)
