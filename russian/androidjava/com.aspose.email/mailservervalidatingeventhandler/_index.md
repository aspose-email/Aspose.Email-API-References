...
description: Представляет обработчик события MailServerValidatingEvent.
type: docs
weight: 199
url: /ru/androidjava/com.aspose.email/mailservervalidatingeventhandler/
---
...
Представляет обработчик события MailServerValidatingEvent.
## Constructors
...
| e | [MailServerValidatingEventArgs](../../com.aspose.email/mailservervalidatingeventargs) | объект [MailServerValidatingEventArgs](../../com.aspose.email/mailservervalidatingeventargs). |
