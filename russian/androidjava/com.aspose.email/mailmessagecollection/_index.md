...
type: docs
weight: 193
url: /ru/androidjava/com.aspose.email/mailmessagecollection/
---
...
Представляет коллекцию объектов [MailMessage](../../com.aspose.email/mailmessage).

--------------------

Предоставляет простой объект коллекции, который может представлять набор объектов [MailMessage](../../com.aspose.email/mailmessage). Класс [MailMessageCollection](../../com.aspose.email/mailmessagecollection) предоставляет простой объект коллекции, который можно использовать для хранения набора объектов [MailMessage](../../com.aspose.email/mailmessage).
## Constructors

| Constructor | Описание |
| --- | --- |
| [MailMessageCollection()](#MailMessageCollection--) | Инициализирует новый экземпляр класса [MailMessageCollection](../../com.aspose.email/mailmessagecollection). |
## Methods
...
Инициализирует новый экземпляр класса [MailMessageCollection](../../com.aspose.email/mailmessagecollection).
