...
description: Представляет пользовательский объект, включенный в документы сообщений Outlook.
type: docs
weight: 269
url: /ru/androidjava/com.aspose.email/mapiobjectproperty/
---
...
Представляет пользовательский объект, включенный в документы сообщений Outlook.
## Methods
