...
description: Представляет ежемесячный шаблон повторения календаря mapi
type: docs
weight: 215
url: /ru/androidjava/com.aspose.email/mapicalendarmonthlyrecurrencepattern/
---
...
Представляет ежемесячный шаблон повторения календаря mapi
## Constructors
