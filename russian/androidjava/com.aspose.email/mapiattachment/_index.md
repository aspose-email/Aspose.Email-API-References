...
description: Представляет вложение в электронном письме.
type: docs
weight: 203
url: /ru/androidjava/com.aspose.email/mapiattachment/
---
...
Представляет вложение в электронном письме.
## Methods
...
| [getBinaryData()](#getBinaryData--) | Получает или задает двоичные данные вложения. |
| [getClass()](#getClass--) |  |
| [getCodePage()](#getCodePage--) | Получает кодовую страницу. |
| [getContent()](#getContent--) | Получает содержимое. |
| [getDisplayName()](#getDisplayName--) | Получает отображаемое имя OLE-объекта во вложении. |
| [getExtension()](#getExtension--) | Получает расширение имени файла, указывающее тип документа вложения. |
| [getFileName()](#getFileName--) | Получает базовое имя файла вложения и расширение, без пути. |
| [getItemId()](#getItemId--) | Идентификатор элемента, используется с сервером. |
| [getLongFileName()](#getLongFileName--) | Получает полное имя файла вложения и расширение, без пути. |
| [getMimeTag()](#getMimeTag--) | Получает информацию о форматировании вложения Multipurpose Internet Mail Extensions (MIME). |
| [getNamedProperties()](#getNamedProperties--) | Получает именованные свойства сообщения. |
| [getObjectData()](#getObjectData--) | Получает объект вложения, обычно доступный через интерфейс OLE IStorage. |
...
| [save(OutputStream stream)](#save-java.io.OutputStream-) | Сохранить содержимое вложения. |
| [save(String filename)](#save-java.lang.String-) | Сохранить содержимое вложения. |
| [setBinaryData(byte[] value)](#setBinaryData-byte---) | Получает или задает двоичные данные вложения. |
| [setDisplayName(String value)](#setDisplayName-java.lang.String-) | Получает отображаемое имя OLE-объекта во вложении. |
...
Получает отображаемое имя OLE-объекта во вложении.
...
Получает базовое имя файла вложения и расширение, без пути.
...
Получает полное имя файла вложения и расширение, без пути.
...
Получает информацию о форматировании вложения Multipurpose Internet Mail Extensions (MIME).
...
| Parameter | Type | Описание |
| --- | --- | --- |
| имя файла | java.lang.String | Имя файла для сохранения. |
