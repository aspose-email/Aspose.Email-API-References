...
description: Представляет тип данных свойства MapiProperty.
type: docs
weight: 277
url: /ru/androidjava/com.aspose.email/mapipropertytype/
---
...
Представляет тип данных свойства MapiProperty.
## Поля
...
| [PT_BINARY](#PT-BINARY) | Значение структуры SBinary, массив байтов с указанием количества. |
| [PT_BOOLEAN](#PT-BOOLEAN) | 16-битное логическое значение, где ноль соответствует FALSE, а ненулевое — TRUE. |
| [PT_CLSID](#PT-CLSID) | Значение структуры CLSID. |
| [PT_DOUBLE](#PT-DOUBLE) | 64-битное число с плавающей запятой. |
| [PT_ERROR](#PT-ERROR) | Значение SCODE; 32-битное беззнаковое целое. |
...
| [PT_UNSPECIFIED](#PT-UNSPECIFIED) | Указывает, что тип свойства неизвестен. |
## Methods
...
Значение структуры SBinary, массив байтов с указанием количества.
...
16‑битовое логическое значение, где ноль соответствует FALSE, а ненулевое — TRUE. Этот тип свойства такой же, как тип OLE VT\_BOOL.
...
Значение структуры CLSID. Этот тип свойства такой же, как тип OLE VT\_CLSID.
...
Значение SCODE; 32‑битное беззнаковое целое. Этот тип свойства такой же, как тип OLE VT\_ERROR.
...
Знаковое или беззнаковое 32‑битное целое. Этот тип свойства такой же, как PT\_I4 и тип OLE VT\_I4.
...
Знаковое или беззнаковое 64‑битное целое. Этот тип свойства такой же, как PT\_I8 и тип OLE VT\_I8.
...
Указатель на объект, реализующий интерфейс IUnknown. Этот тип свойства похож на несколько типов OLE, таких как VT\_UNKNOWN.
...
Знаковое 16‑битное целое. Этот тип свойства такой же, как PT\_SHORT и тип OLE VT\_I2.
...
Нуль‑терминированная 8‑битная строка символов. Этот тип свойства такой же, как тип OLE VT\_LPSTR.
...
64‑битное целочисленное значение даты и времени в виде структуры FILETIME. Этот тип свойства такой же, как тип OLE VT\_FILETIME.
...
Указывает, что тип свойства неизвестен.
