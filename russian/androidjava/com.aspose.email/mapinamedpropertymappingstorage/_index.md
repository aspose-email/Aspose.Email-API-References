...
description: Представляет сопоставление именованного свойства
type: docs
weight: 267
url: /ru/androidjava/com.aspose.email/mapinamedpropertymappingstorage/
---
...
Представляет сопоставление именованного свойства
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiNamedPropertyMappingStorage()](#MapiNamedPropertyMappingStorage--) | Инициализирует новый экземпляр класса [MapiNamedPropertyMappingStorage](../../com.aspose.email/mapinamedpropertymappingstorage). |
## Methods

| Method | Описание |
| --- | --- |
| [addNamedPropertyMapping(MapiProperty property, String nameId, UUID guid)](#addNamedPropertyMapping-com.aspose.email.MapiProperty-java.lang.String-java.util.UUID-) | Добавляет сопоставление именованного свойства для строкового именованного свойства. |
| [addNamedPropertyMapping(MapiProperty property, long nameId, UUID guid)](#addNamedPropertyMapping-com.aspose.email.MapiProperty-long-java.util.UUID-) | Добавляет сопоставление именованного свойства для числового именованного свойства. |
...
| [getNextAvailablePropertyId(int dataType)](#getNextAvailablePropertyId-int-) | Получает следующий доступный идентификатор свойства в потоке записей на основе типа данных свойства. |
...
Инициализирует новый экземпляр класса [MapiNamedPropertyMappingStorage](../../com.aspose.email/mapinamedpropertymappingstorage).
...
Добавляет сопоставление именованного свойства для строкового именованного свойства.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| property | [MapiProperty](../../com.aspose.email/mapiproperty) | Свойство, для которого добавляется сопоставление. |
| nameId | java.lang.String | Идентификатор имени. |
|  | guid | java.util.UUID | GUID, идентифицирующий набор свойств. |

--------------------

Свойство должно иметь действительный идентификатор для именованного свойства, \#getNextAvailablePropertyId(int).getNextAvailablePropertyId(int) можно использовать для его генерации. В противном случае будет выброшено исключение.

\{@link ArgumentNullException\} если nameId равно null. \{@link ArgumentNullException\} если \{@code property\} равно null. \{@link ArgumentException\} если \{@code MapiProperty.Tag\}(\{@link MapiProperty\#getTag\}) может быть использован для сопоставления именованного свойства. Диапазон идентификаторов именованных свойств находится между 0x8000 и 0xFFFE.   |
...
| --- | --- | --- |
| property | [MapiProperty](../../com.aspose.email/mapiproperty) | Свойство, для которого добавляется сопоставление. |
| nameId | long | Идентификатор имени. |
|  | guid | java.util.UUID | GUID, идентифицирующий набор свойств. |
...
\{@link ArgumentNullException\} если \{@code property\} равно null. \{@link ArgumentException\} если \{@code MapiProperty.Tag\}(\{@link MapiProperty\#getTag\}) может быть использован для сопоставления именованного свойства. Диапазон идентификаторов именованных свойств находится между 0x8000 и 0xFFFE.   |
...
Получает следующий доступный идентификатор свойства в потоке записей на основе типа данных свойства.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| dataType | int | Тип данных для свойства. |

**Returns:**
long — Идентификатор, который позже может быть использован для добавления сопоставления свойства.
