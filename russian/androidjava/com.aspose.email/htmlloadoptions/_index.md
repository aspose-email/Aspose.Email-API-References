...
type: docs
weight: 160
url: /ru/androidjava/com.aspose.email/htmlloadoptions/
---
...
| --- | --- |
| [HtmlLoadOptions()](#HtmlLoadOptions--) | Инициализирует новый экземпляр этого класса, который может использоваться для загрузки MailMessage из формата Html. |
## Methods
...
| [getPathToResources()](#getPathToResources--) | Путь к каталогу с файлами ресурсов. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [setPathToResources(String value)](#setPathToResources-java.lang.String-) | Путь к каталогу с файлами ресурсов. |
...
| [shouldAddPlainTextView()](#shouldAddPlainTextView--) | Указывает, добавлять текстовое представление тела сообщения или нет. |
| [shouldAddPlainTextView(boolean value)](#shouldAddPlainTextView-boolean-) | Указывает, добавлять текстовое представление тела сообщения или нет. |
| [toString()](#toString--) |  |
| [wait()](#wait--) |  |
...
Инициализирует новый экземпляр этого класса, который может использоваться для загрузки MailMessage из формата Html.
...
Указывает, следует ли добавлять текстовое представление тела или нет. Значение по умолчанию — false.
