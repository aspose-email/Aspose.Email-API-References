...
type: docs
weight: 404
url: /ru/androidjava/com.aspose.email/tnefloadoptions/
---
...
| --- | --- |
| [TnefLoadOptions()](#TnefLoadOptions--) | Инициализирует новый экземпляр этого класса, который может использоваться для загрузки MailMessage из формата Tnef. |
## Methods
...
Инициализирует новый экземпляр этого класса, который может использоваться для загрузки MailMessage из формата Tnef.
