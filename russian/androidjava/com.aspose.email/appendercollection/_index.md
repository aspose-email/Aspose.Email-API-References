...
description: Представляет коллекцию объектов Appender.
type: docs
weight: 25
url: /ru/androidjava/com.aspose.email/appendercollection/
---
...
Представляет коллекцию объектов Appender.
## Constructors
...
| Method | Описание |
| --- | --- |
| [addAppender(IAppender value)](#addAppender-com.aspose.email.IAppender-) | Добавляет объект IAppender в конец коллекции. |
| [addItem(T arg0)](#addItem-T-) |  |
| [addRange(Iterable<IAppender> value)](#addRange-java.lang.Iterable-com.aspose.email.IAppender--) | Добавляет перечисление IAppenders в конец коллекции. |
| [clear()](#clear--) |  |
...
| --- | --- | --- |
| value | [IAppender](../../com.aspose.email/iappender) | IAppender, который будет добавлен в конец коллекции. Значение может быть null. |

**Returns:**
int — индекс, по которому было добавлено значение.
### addItem(T arg0) {#addItem-T-}
```
...
| Parameter | Type | Описание |
| --- | --- | --- |
| value | java.lang.Iterable<com.aspose.email.IAppender> | Перечисление IAppenders, которое будет добавлено в конец коллекции. |
