...
description: Представляет обработчик события для SyntaxValidatingEvent.
type: docs
weight: 395
url: /ru/androidjava/com.aspose.email/syntaxvalidatingeventhandler/
---
...
Представляет обработчик события для SyntaxValidatingEvent.
## Constructors
