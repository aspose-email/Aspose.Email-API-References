...
type: docs
weight: 408
url: /ru/androidjava/com.aspose.email/traversalasposeexception/
---
...
| [getKind()](#getKind--) | Получает или задает тип сбоя. |
...
| [setKind(TraversalFailureKind value)](#setKind-com.aspose.email.TraversalFailureKind-) | Получает или задает тип сбоя. |
...
Получает или задает тип сбоя.

Значение: [TraversalFailureKind](../../com.aspose.email/traversalfailurekind), который может возникнуть при обходе хранилища.
