...
type: docs
weight: 418
url: /ru/androidjava/com.aspose.email/vcarddeliveryaddresstype/
---
...
| --- | --- |
| [VCardDeliveryAddressType()](#VCardDeliveryAddressType--) | Конструктор для VCardDeliveryAddressType. |
## Поля

| Поле | Описание |
| --- | --- |
| [DOM](#DOM) | Внутренний адрес |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HOME](#HOME) | Домашний адрес доставки |
| [INTL](#INTL) | Международный адрес |
| [None](#None) | Значения не заданы. |
| [PARCEL](#PARCEL) | Адрес доставки посылки |
| [POSTAL](#POSTAL) | Почтовый адрес доставки |
| [PREF](#PREF) | Предпочтительный адрес доставки |
| [WORK](#WORK) | Рабочий адрес доставки |
## Methods
...
Конструктор для VCardDeliveryAddressType.
...
Предпочтительный адрес доставки
