...
description: Указывает статус INTENDED (предполагаемый) встречи.
type: docs
weight: 187
url: /ru/androidjava/com.aspose.email/msintendedstatus/
---
...
| [Free](#Free) | Свободен |
| [NotDefined](#NotDefined) | Свойство не задано |
| [Oof](#Oof) | Вне офиса |
| [Tentative](#Tentative) | Предварительно |
| [WorkingElsewhere](#WorkingElsewhere) | Работает в месте, удалённом от офиса |
## Methods
...
Работает в месте, удалённом от офиса
