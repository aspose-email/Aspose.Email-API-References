...
type: docs
weight: 392
url: /ru/androidjava/com.aspose.email/storageprocessedeventhandler/
---
...
Представляет метод, который будет обрабатывать событие [PersonalStorage.StorageProcessedDelegate](../../com.aspose.email/personalstorage\#StorageProcessedDelegate).
## Constructors
