...
type: docs
weight: 21
url: /ru/androidjava/com.aspose.email/ampimage/
---
...
| --- | --- |
| [AmpImage(int width, int height)](#AmpImage-int-int-) | Создать экземпляр AmpImage. |
## Methods
...
| --- | --- | --- |
| ширина | int | ширина AmpImage |
| высота | int | высота AmpImage |
