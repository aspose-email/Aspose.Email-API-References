...
description: Перечисление определяет пол человека
type: docs
weight: 153
url: /ru/androidjava/com.aspose.email/gender/
---
...
Перечисление определяет пол человека
## Поля
...
| [Unspecified](#Unspecified) | Пол не определён |
## Methods
