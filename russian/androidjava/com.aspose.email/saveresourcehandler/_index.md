...
description: Представляет обработчик для HtmlSaveOptions.SaveResourceHandler
type: docs
weight: 379
url: /ru/androidjava/com.aspose.email/saveresourcehandler/
---
...
Представляет обработчик для HtmlSaveOptions.SaveResourceHandler
## Constructors
