...
type: docs
weight: 216
url: /ru/androidjava/com.aspose.email/mapicalendarmsgsaveoptions/
---
...
| --- | --- |
| [MapiCalendarMsgSaveOptions()](#MapiCalendarMsgSaveOptions--) | Инициализирует новый экземпляр класса [MapiCalendarMsgSaveOptions](../../com.aspose.email/mapicalendarmsgsaveoptions) |
## Methods

| Method | Описание |
| --- | --- |
| [equals(Object arg0)](#equals-java.lang.Object-) |  |
| [fromSaveFormat(int saveFormat)](#fromSaveFormat-int-) | Получает MapiCalendarSaveOptions из SaveFormat. |
| [getClass()](#getClass--) |  |
| [getDefaultIcs()](#getDefaultIcs--) | Получает параметры сохранения Ics по умолчанию. |
| [getDefaultMsg()](#getDefaultMsg--) | Получает параметры сохранения Msg по умолчанию. |
...
Инициализирует новый экземпляр класса [MapiCalendarMsgSaveOptions](../../com.aspose.email/mapicalendarmsgsaveoptions)
...
**Returns:**
boolean
### fromSaveFormat(int saveFormat) {#fromSaveFormat-int-}
```
...
Получает параметры сохранения Msg по умолчанию.
