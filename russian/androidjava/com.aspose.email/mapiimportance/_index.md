...
description: Содержит значение, указывающее важность сообщения.
type: docs
weight: 256
url: /ru/androidjava/com.aspose.email/mapiimportance/
---
...
Содержит значение, указывающее важность сообщения.
## Поля
...
| [Normal](#Normal) | Обычная важность. |
## Methods
