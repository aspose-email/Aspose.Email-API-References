...
description: Представляет поток свойств.
type: docs
weight: 264
url: /ru/androidjava/com.aspose.email/mapimessagepropertystream/
---
...
Представляет поток свойств.
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiMessagePropertyStream(MapiMessageItemBase parent)](#MapiMessagePropertyStream-com.aspose.email.MapiMessageItemBase-) | Инициализирует новый экземпляр класса [MapiMessagePropertyStream](../../com.aspose.email/mapimessagepropertystream). |
## Methods
...
Инициализирует новый экземпляр класса [MapiMessagePropertyStream](../../com.aspose.email/mapimessagepropertystream).

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| parent | [MapiMessageItemBase](../../com.aspose.email/mapimessageitembase) | Родитель. |
