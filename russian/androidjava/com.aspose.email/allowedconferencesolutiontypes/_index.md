...
description: Типы конференц-решений, поддерживаемых для этого календаря.
type: docs
weight: 10
url: /ru/androidjava/com.aspose.email/allowedconferencesolutiontypes/
---
...
Типы конференц-решений, поддерживаемых для этого календаря.
## Поля
