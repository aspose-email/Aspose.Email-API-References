...
description: Представляет базовые параметры сохранения встречи
type: docs
weight: 38
url: /ru/androidjava/com.aspose.email/appointmentsaveoptions/
---
...
Представляет базовые параметры сохранения встречи
## Methods
