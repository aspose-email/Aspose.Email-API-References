...
description: Представляет шаблон повторения типа «ежемесячно».
type: docs
weight: 325
url: /ru/androidjava/com.aspose.email/monthlyrecurrencepattern/
---
...
Представляет шаблон повторения типа «ежемесячно».
## Constructors

| Constructor | Описание |
| --- | --- |
| [MonthlyRecurrencePattern()](#MonthlyRecurrencePattern--) | Инициализирует новый экземпляр класса [MonthlyRecurrencePattern](../../com.aspose.email/monthlyrecurrencepattern). |
| [MonthlyRecurrencePattern(int startOffset, int interval)](#MonthlyRecurrencePattern-int-int-) | Инициализирует новый экземпляр класса [MonthlyRecurrencePattern](../../com.aspose.email/monthlyrecurrencepattern). |
| [MonthlyRecurrencePattern(int startPosition, int startDay, int interval)](#MonthlyRecurrencePattern-int-int-int-) | Инициализирует новый экземпляр класса [MonthlyRecurrencePattern](../../com.aspose.email/monthlyrecurrencepattern). |
## Methods
...
| [getStartDay()](#getStartDay--) | Получает или задает начальный день. |
| [getStartOffset()](#getStartOffset--) | Получает или задает начальное смещение. |
| [getStartPosition()](#getStartPosition--) | Получает или задает начальную позицию. |
...
| [setStartDay(int value)](#setStartDay-int-) | Получает или задает начальный день. |
| [setStartOffset(int value)](#setStartOffset-int-) | Получает или задает начальное смещение. |
| [setStartPosition(int value)](#setStartPosition-int-) | Получает или задает начальную позицию. |
...
Инициализирует новый экземпляр класса [MonthlyRecurrencePattern](../../com.aspose.email/monthlyrecurrencepattern).
...
| --- | --- | --- |
| startOffset | int | Начальное смещение. |
...
Получает или задает начальный день.

Значение: Начальный день.
