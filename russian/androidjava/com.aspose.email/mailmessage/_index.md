...
description: Представляет электронное письмо.
type: docs
weight: 192
url: /ru/androidjava/com.aspose.email/mailmessage/
---
...
Представляет электронное сообщение. Позволяет получать доступ к свойствам сообщения, например, теме, телу, адресу отправителя и получателей и т.д. Также его можно отправлять и доставлять с помощью поддерживаемых почтовых протоколов.
## Constructors

| Constructor | Описание |
| --- | --- |
| [MailMessage(String from, String to)](#MailMessage-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса [MailMessage](../../com.aspose.email/mailmessage) |
| [MailMessage()](#MailMessage--) | Инициализирует новый экземпляр класса [MailMessage](../../com.aspose.email/mailmessage) |
| [MailMessage(boolean increaseCredit)](#MailMessage-boolean-) | Инициализирует новый экземпляр класса [MailMessage](../../com.aspose.email/mailmessage) |
| [MailMessage(String from, String to, String subject, String body)](#MailMessage-java.lang.String-java.lang.String-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса [MailMessage](../../com.aspose.email/mailmessage) |
| [MailMessage(MailAddress from, MailAddress to)](#MailMessage-com.aspose.email.MailAddress-com.aspose.email.MailAddress-) | Инициализирует новый экземпляр класса [MailMessage](../../com.aspose.email/mailmessage) |
## Methods
...
| [save(OutputStream stream, SaveOptions options)](#save-java.io.OutputStream-com.aspose.email.SaveOptions-) | Сохранить сообщение как поток с дополнительными параметрами. |
...
| к | java.lang.String | Адрес получателя |
...
| Parameter | Type | Описание |
| --- | --- | --- |
| from | [MailAddress](../../com.aspose.email/mailaddress) | Адрес отправителя |
| to | [MailAddress](../../com.aspose.email/mailaddress) | Адрес получателя |
