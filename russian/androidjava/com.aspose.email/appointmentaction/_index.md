...
description: Перечисляет методы назначений
type: docs
weight: 27
url: /ru/androidjava/com.aspose.email/appointmentaction/
---
...
Перечисляет методы назначений
## Поля

| Поле | Описание |
| --- | --- |
| [Cancel](#Cancel) | Метод Cancel |
| [Create](#Create) | Метод Create |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Update](#Update) | Метод Update |
## Methods
