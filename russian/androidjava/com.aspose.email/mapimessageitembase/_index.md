...
description: Представляет базовый класс для всех классов MapiMessageItem и хранит общие коллекции свойств mapi, вложений и получателей.
type: docs
weight: 262
url: /ru/androidjava/com.aspose.email/mapimessageitembase/
---
...
Представляет базовый класс для всех классов MapiMessageItem и хранит общие коллекции свойств mapi, вложений и получателей.
## Methods
