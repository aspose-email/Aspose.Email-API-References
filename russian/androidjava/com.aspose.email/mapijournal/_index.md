...
type: docs
weight: 257
url: /ru/androidjava/com.aspose.email/mapijournal/
---
...
| --- | --- |
| [MapiJournal()](#MapiJournal--) | Инициализирует новый экземпляр класса [MapiJournal](../../com.aspose.email/mapijournal). |
| [MapiJournal(String subject, String body, String description, String briefDescription)](#MapiJournal-java.lang.String-java.lang.String-java.lang.String-java.lang.String-) | Инициализирует новый экземпляр класса [MapiJournal](../../com.aspose.email/mapijournal). |
## Methods
...
| [getBriefDescription()](#getBriefDescription--) | Получает или задает краткое описание действия, которое записывается. |
...
| [getDescription()](#getDescription--) | Получает или задает описание действия, которое записывается. |
| [getDocumentStatus()](#getDocumentStatus--) | Получает или задает статус документа. |
| [getDuration()](#getDuration--) | Получает продолжительность действия. |
| [getEndTime()](#getEndTime--) | Получает или задает время завершения действия. |
| [getFlags()](#getFlags--) | Получает или задает флаги, содержащие метаданные об объекте Journal. |
...
| [getStartTime()](#getStartTime--) | Получает или задает время начала действия. |
...
| [setBriefDescription(String value)](#setBriefDescription-java.lang.String-) | Получает или задает краткое описание действия, которое записывается. |
...
| [setDescription(String value)](#setDescription-java.lang.String-) | Получает или задает описание действия, которое записывается. |
| [setDocumentStatus(int value)](#setDocumentStatus-int-) | Получает или задает статус документа. |
| [setEndTime(Date value)](#setEndTime-java.util.Date-) | Получает или задает время завершения действия. |
| [setFlags(int value)](#setFlags-int-) | Получает или задает флаги, содержащие метаданные об объекте Journal. |
...
| [setStartTime(Date value)](#setStartTime-java.util.Date-) | Получает или задает время начала действия. |
...
Инициализирует новый экземпляр класса [MapiJournal](../../com.aspose.email/mapijournal).
...
| описание | java.lang.String | Описание. |
| briefDescription | java.lang.String | Краткое описание. |
...
Получает или задает краткое описание действия, которое записывается.

Значение: Строка, представляющая действие.
...
Получает или задает описание действия, которое записывается.
...
Получает или задает статус документа.

Значение: Статус документа.
...
Значение: Значение, представляющее продолжительность действия.
...
Получает или задает время завершения действия.
...
Получает или задает флаги, содержащие метаданные об объекте Journal.

Значение: Флаги журнала.
