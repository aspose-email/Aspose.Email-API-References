...
description: Представляет аппендер, не выполняющий никаких действий.
type: docs
weight: 333
url: /ru/androidjava/com.aspose.email/nullappender/
---
...
Представляет аппендер, не выполняющий никаких действий.
## Constructors
...
| Method | Описание |
| --- | --- |
| [append(LogEntry entry)](#append-com.aspose.email.LogEntry-) | Appends a log entry to NullAppender. |
...
| --- | --- | --- |
| entry | [LogEntry](../../com.aspose.email/logentry) | The entry need to log. |
