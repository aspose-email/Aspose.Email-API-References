...
description: Представляет реализацию по умолчанию интерфейса IFormatter.
type: docs
weight: 387
url: /ru/androidjava/com.aspose.email/simpleformatter/
---
...
Представляет реализацию по умолчанию интерфейса IFormatter.
## Constructors
