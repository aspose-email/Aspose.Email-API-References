...
description: Перечисляет типы звука cVard
type: docs
weight: 434
url: /ru/androidjava/com.aspose.email/vcardsoundtype/
---
...
Перечисляет типы звука cVard
## Constructors

| Constructor | Описание |
| --- | --- |
| [VCardSoundType()](#VCardSoundType--) | Конструктор для VCardSoundType. |
## Поля

| Поле | Описание |
| --- | --- |
| [AIFF](#AIFF) | Формат AIFF |
| [BASIC](#BASIC) | Базовый формат |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MP4](#MP4) | Аудио mp4 |
| [MPEG](#MPEG) | Аудио mpeg |
| [OGG](#OGG) | Аудио ogg |
| [PCM](#PCM) | Базовый аудио‑тип MIME |
| [WAVE](#WAVE) | Формат wave |
| [WMA](#WMA) | Аудио Windows Media |
## Methods
...
Конструктор для VCardSoundType.
