...
description: Представляет ежедневный шаблон повторения календаря mapi.
type: docs
weight: 209
url: /ru/androidjava/com.aspose.email/mapicalendardailyrecurrencepattern/
---
...
Представляет ежедневный шаблон повторения календаря mapi.
## Constructors

| Constructor | Описание |
| --- | --- |
| [MapiCalendarDailyRecurrencePattern()](#MapiCalendarDailyRecurrencePattern--) | Инициализирует новый экземпляр класса [MapiCalendarDailyRecurrencePattern](../../com.aspose.email/mapicalendardailyrecurrencepattern). |
## Methods
...
| [getPeriod()](#getPeriod--) | Получает или задает интервал (в днях), с которым повторяется шаблон встречи. |
...
| [setPeriod(long value)](#setPeriod-long-) | Получает или задает интервал (в днях), с которым повторяется шаблон встречи. |
...
Инициализирует новый экземпляр класса [MapiCalendarDailyRecurrencePattern](../../com.aspose.email/mapicalendardailyrecurrencepattern).
...
Получает или задает интервал (в днях), с которым повторяется шаблон встречи.
