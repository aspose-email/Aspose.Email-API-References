...
type: docs
weight: 64
url: /ru/androidjava/com.aspose.email/bynumbercollection/
---
...
Соответствует различным частям BYXXX, таким как BYDAY, BYMONTH, в правиле повторения.

 

Большинство свойств ByXXX класса \{@link RecurrenceRule\} реализованы как ByNumberCollection.
...
| [add(T arg0)](#add-T-) |  |
| [add(int value)](#add-int-) | Добавляет месяц, неделю, день, час, минуту или секунду в коллекцию. |
| [add(int arg0, T arg1)](#add-int-T-) |  |
| [add(int[] values)](#add-int---) | Добавляет массив месяцев, недель, дней, часов, минут или секунд в коллекцию. |
...
| [equals(ByNumberCollection other)](#equals-com.aspose.email.ByNumberCollection-) | Определяет, равен ли указанный [ByNumberCollection](../../com.aspose.email/bynumbercollection) этому экземпляру. |
...
Добавляет месяц, неделю, день, час, минуту или секунду в коллекцию.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
|  | value | int | Значение для добавления. |

--------------------



Выбрасывает исключение, если значение выходит за пределы допустимого диапазона для единицы времени этой коллекции.
...
Добавляет массив месяцев, недель, дней, часов, минут или секунд в коллекцию.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| значения | int[] | Значения. |
...
Определяет, равен ли указанный [ByNumberCollection](../../com.aspose.email/bynumbercollection) этому экземпляру.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| other | [ByNumberCollection](../../com.aspose.email/bynumbercollection) | Коллекцию [ByNumberCollection](../../com.aspose.email/bynumbercollection) для сравнения с этим экземпляром. |

**Returns:**
boolean -  true  если указанная [ByNumberCollection](../../com.aspose.email/bynumbercollection) равна этому экземпляру; иначе,  false .
