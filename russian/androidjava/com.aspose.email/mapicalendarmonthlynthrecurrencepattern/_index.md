...
description: Представляет ежемесячный n‑й шаблон повторения календаря mapi
type: docs
weight: 214
url: /ru/androidjava/com.aspose.email/mapicalendarmonthlynthrecurrencepattern/
---
...
Представляет ежемесячный n‑й шаблон повторения календаря mapi
## Constructors
...
| [getClass()](#getClass--) |  |
| [getDay()](#getDay--) | Получает или задает день месяца, на который выпадает повторение. |
| [getDayOfWeek()](#getDayOfWeek--) | Получает или задает дни недели, в которые происходит событие |
...
| [getPeriod()](#getPeriod--) | Получает или задает интервал (в месяцах), с которым повторяется шаблон встречи. |
| [getPosition()](#getPosition--) | Получает или задает количество дней повторения в каждом месяце, в котором происходит повторение. |
...
| [setDay(long value)](#setDay-long-) | Получает или задает день месяца, на который выпадает повторение. |
| [setDayOfWeek(int value)](#setDayOfWeek-int-) | Получает или задает дни недели, в которые происходит событие |
...
| [setPeriod(long value)](#setPeriod-long-) | Получает или задает интервал (в месяцах), с которым повторяется шаблон встречи. |
| [setPosition(int value)](#setPosition-int-) | Получает или задает количество дней повторения в каждом месяце, в котором происходит повторение. |
...
Получает или задает день месяца, на который выпадает повторение.
...
Получает или задает количество дней повторения в каждом месяце, в котором происходит повторение.
