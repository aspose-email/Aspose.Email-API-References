...
type: docs
weight: 117
url: /ru/androidjava/com.aspose.email/emlloadoptions/
---
...
| --- | --- |
| [EmlLoadOptions()](#EmlLoadOptions--) | Инициализирует новый экземпляр этого класса, который может использоваться для загрузки MailMessage из формата Eml. |
## Methods
