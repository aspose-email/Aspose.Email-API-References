...
description: Коллекция с именами заголовков, включённых в подпись DKIM.
type: docs
weight: 156
url: /ru/androidjava/com.aspose.email/headerlist/
---
...
Коллекция с именами заголовков, включённых в подпись DKIM.
## Constructors
