...
description: Перечисляет форматы изображений фотографии MapiContact.
type: docs
weight: 242
url: /ru/androidjava/com.aspose.email/mapicontactphotoimageformat/
---
...
Перечисляет форматы изображений фотографии MapiContact.
## Поля
...
| [Undefined](#Undefined) | Неопределённый формат. |
