...
description: Указывает, должна ли эта встреча быть видна в поиске доступности.
type: docs
weight: 40
url: /ru/androidjava/com.aspose.email/appointmenttransparency/
---
...
| [Opaque](#Opaque) | Встреча непрозрачна |
| [Transparent](#Transparent) | Встреча прозрачна |
## Methods
