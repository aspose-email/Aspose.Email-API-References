...
type: docs
weight: 350
url: /ru/androidjava/com.aspose.email/pidlidpropertydescriptor/
---
...
| --- | --- |
| [PidLidPropertyDescriptor(long longId, int type, UUID propertySet)](#PidLidPropertyDescriptor-long-int-java.util.UUID-) | Инициализирует новый экземпляр класса [PidLidPropertyDescriptor](../../com.aspose.email/pidlidpropertydescriptor) свойства, идентифицируемые беззнаковым 32‑битным числом вместе с набором свойств. |
| [PidLidPropertyDescriptor(String canonicalName, long longId, int type, UUID propertySet)](#PidLidPropertyDescriptor-java.lang.String-long-int-java.util.UUID-) | Инициализирует новый экземпляр класса [PidLidPropertyDescriptor](../../com.aspose.email/pidlidpropertydescriptor) свойства, идентифицируемые беззнаковым 32‑битным числом вместе с набором свойств. |
| [PidLidPropertyDescriptor(String canonicalName, String name, long longId, int type, UUID propertySet)](#PidLidPropertyDescriptor-java.lang.String-java.lang.String-long-int-java.util.UUID-) | Инициализирует новый экземпляр класса [PidLidPropertyDescriptor](../../com.aspose.email/pidlidpropertydescriptor) свойства, идентифицируемые беззнаковым 32‑битным числом вместе с набором свойств. |
## Methods
...
| [getLongId()](#getLongId--) | Получает беззнаковое 32‑битное значение, которое вместе с набором свойств идентифицирует именованное свойство. |
...
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
| [op_Equality(PidLidPropertyDescriptor pd1, PropertyDescriptor pd2)](#op-Equality-com.aspose.email.PidLidPropertyDescriptor-com.aspose.email.PropertyDescriptor-) | Определяет, равны ли указанные объекты друг другу. |
...
| [op_Inequality(PidLidPropertyDescriptor pd1, PropertyDescriptor pd2)](#op-Inequality-com.aspose.email.PidLidPropertyDescriptor-com.aspose.email.PropertyDescriptor-) | Определяет, не равны ли указанные объекты друг другу. |
...
Инициализирует новый экземпляр класса [PidLidPropertyDescriptor](../../com.aspose.email/pidlidpropertydescriptor) свойства, идентифицируемые беззнаковым 32‑битным числом вместе с набором свойств.

**Parameters:**
| Parameter | Type | Описание |
| --- | --- | --- |
| longId | long | long ID (LID): Беззнаковое 32‑битное значение, которое в сочетании с GUID определяет именованное свойство. |
...
Получает беззнаковое 32‑битное значение, которое вместе с набором свойств идентифицирует именованное свойство.
...
| Parameter | Type | Описание |
| --- | --- | --- |
| pd1 | [PidLidPropertyDescriptor](../../com.aspose.email/pidlidpropertydescriptor) | Объект для сравнения с другим объектом. |
