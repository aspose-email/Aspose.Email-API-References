...
type: docs
weight: 304
url: /ru/androidjava/com.aspose.email/messageaddedeventhandler/
---
...
Представляет метод, который будет обрабатывать событие [FolderInfo.MessageAddedDelegate](../../com.aspose.email/folderinfo\#MessageAddedDelegate).
## Constructors
