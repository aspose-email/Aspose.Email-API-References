...
IEnumerable, , представляющий перечислитель, который перебирает подпапки в папке.
...
IEnumerable , , представляющий перечислитель, выполняющий итерацию по подпапкам в папке.
