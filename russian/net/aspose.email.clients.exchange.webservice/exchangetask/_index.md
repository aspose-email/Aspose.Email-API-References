...
type: docs
weight: 3830
url: /ru/net/aspose.email.clients.exchange.webservice/exchangetask/
---
## ExchangeTask class
...
| Имя | Описание |
| --- | --- |
| [ActualWork](../../aspose.email.clients.exchange.webservice/exchangetask/actualwork) { get; set; } | Получает или задает фактическое время, затраченное на задачу (в минутах). |
...
| [BillingInformation](../../aspose.email.clients.exchange.webservice/exchangetask/billinginformation) { get; set; } | Получает или задает платежную информацию для задачи. |
| [Body](../../aspose.email.calendar/task/body) { get; set; } | Получает или задает тело задачи. |
| [Companies](../../aspose.email.clients.exchange.webservice/exchangetask/companies) { get; set; } | Получает или задает набор компаний, связанных с задачей. |
| [CompletionDate](../../aspose.email.clients.exchange.webservice/exchangetask/completiondate) { get; set; } | Получает или задает дату, когда пользователь завершил работу над задачей. |
...
| [IsBodyHtml](../../aspose.email.clients.exchange.webservice/exchangetask/isbodyhtml) { get; set; } | Получает или задает значение, указывающее, отформатировано ли тело задачи в формате html. |
| [Method](../../aspose.email.calendar/task/method) { get; set; } | Получает или задает методы iTIP, связанные с задачей. |
| [Mileage](../../aspose.email.clients.exchange.webservice/exchangetask/mileage) { get; set; } | Получает или задает пробег для задачи. |
