...
[`ExchangeMessageInfoCollection`](../../../aspose.email.clients.exchange/exchangemessageinfocollection), содержащей сообщения из указанной папки.
...
| options | ExchangeListMessagesOptions | Указывает настройки листинга |

### Возвращаемое значение

[`ExchangeMessageInfoCollection`](../../../aspose.email.clients.exchange/exchangemessageinfocollection), содержащего сообщения из указанной папки.
