...
| Имя | Описание |
| --- | --- |
| [LogEntry](logentry#constructor)() | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
| [LogEntry](logentry#constructor_1)(byte[]) | Создать новый экземпляр[`LogEntry`](../logentry) с полным набором параметров конструктора |
| [LogEntry](logentry#constructor_5)(string) | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
...
| [LogEntry](logentry#constructor_9)(string, DateTime) | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
| [LogEntry](logentry#constructor_10)(string, Exception) | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
...
| [LogEntry](logentry#constructor_6)(string, LogLevel) | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
...
| [LogEntry](logentry#constructor_11)(string, Exception, LogLevel) | Инициализировать новый экземпляр[`LogEntry`](../logentry) класс. |
...
| Имя | Описание |
| --- | --- |
| [AppDomainName](../../aspose.email.tools.logging/logentry/appdomainname) { get; set; } | Домен приложения, в котором мы работаем |
| [BinaryDataMessage](../../aspose.email.tools.logging/logentry/binarydatamessage) { get; set; } | Тело двоичного сообщения для регистрации. |
...
| [EventId](../../aspose.email.tools.logging/logentry/eventid) { get; set; } | Номер или идентификатор события. |
...
| [MessageEncoding](../../aspose.email.tools.logging/logentry/messageencoding) { get; set; } | Кодировка двоичного сообщения body |
...
| [Severity](../../aspose.email.tools.logging/logentry/severity) { get; set; } | Серьезность записи журнала как[`Severity`](./severity) перечисление. (Не указано, Информация, Предупреждение или Ошибка). |
...
| Имя | Описание |
| --- | --- |
| virtual [AddErrorMessage](../../aspose.email.tools.logging/logentry/adderrormessage)(string) | Добавить сообщение об ошибке или предупреждение в начало построителя строки сообщений. Используется дистрибьютором для записи проблем. |
| [Clone](../../aspose.email.tools.logging/logentry/clone)() | Создает новый[`LogEntry`](../logentry) это копия текущего экземпляра. |
