...
type: docs
weight: 12490
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/registerconsentresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RegisterConsentResponseMessageType](registerconsentresponsemessagetype)() | Конструктор по умолчанию. |
