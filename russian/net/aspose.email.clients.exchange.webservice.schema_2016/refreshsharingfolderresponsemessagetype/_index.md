...
type: docs
weight: 12460
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/refreshsharingfolderresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RefreshSharingFolderResponseMessageType](refreshsharingfolderresponsemessagetype)() | Конструктор по умолчанию. |
