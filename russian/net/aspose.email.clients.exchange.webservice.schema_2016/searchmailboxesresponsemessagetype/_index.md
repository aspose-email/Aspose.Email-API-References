...
type: docs
weight: 13340
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/searchmailboxesresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SearchMailboxesResponseMessageType](searchmailboxesresponsemessagetype)() | Конструктор по умолчанию. |
