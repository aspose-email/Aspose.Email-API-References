...
type: docs
weight: 8350
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getappmarketplaceurlresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetAppMarketplaceUrlResponseMessageType](getappmarketplaceurlresponsemessagetype)() | Конструктор по умолчанию. |
