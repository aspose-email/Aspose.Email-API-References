...
type: docs
weight: 8480
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getconversationitemsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetConversationItemsResponseMessageType](getconversationitemsresponsemessagetype)() | Конструктор по умолчанию. |
