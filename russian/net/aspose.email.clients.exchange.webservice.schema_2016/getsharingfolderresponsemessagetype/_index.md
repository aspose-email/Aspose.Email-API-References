...
type: docs
weight: 9650
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getsharingfolderresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetSharingFolderResponseMessageType](getsharingfolderresponsemessagetype)() | Конструктор по умолчанию. |
