...
type: docs
weight: 13880
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/setteammailboxresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SetTeamMailboxResponseMessageType](setteammailboxresponsemessagetype)() | Конструктор по умолчанию. |
