...
type: docs
weight: 15090
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/updatemeetinginstancerequesttype/
---
...
| Имя | Описание |
| --- | --- |
| [UpdateMeetingInstanceRequestType](updatemeetinginstancerequesttype)() | Конструктор по умолчанию. |
