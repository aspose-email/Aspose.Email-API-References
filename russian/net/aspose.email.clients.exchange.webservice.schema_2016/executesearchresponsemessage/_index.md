...
type: docs
weight: 7370
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/executesearchresponsemessage/
---
...
| Имя | Описание |
| --- | --- |
| [ExecuteSearchResponseMessage](executesearchresponsemessage)() | Конструктор по умолчанию. |
