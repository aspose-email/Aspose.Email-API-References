...
type: docs
weight: 7990
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/findmessagetrackingreportrequesttype/
---
...
| Имя | Описание |
| --- | --- |
| [FindMessageTrackingReportRequestType](findmessagetrackingreportrequesttype)() | Конструктор по умолчанию. |
