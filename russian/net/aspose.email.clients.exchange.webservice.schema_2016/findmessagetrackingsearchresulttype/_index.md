...
type: docs
weight: 8010
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/findmessagetrackingsearchresulttype/
---
...
| Имя | Описание |
| --- | --- |
| [FindMessageTrackingSearchResultType](findmessagetrackingsearchresulttype)() | Конструктор по умолчанию. |
