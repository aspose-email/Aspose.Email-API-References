...
type: docs
weight: 9960
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getuserphotoresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetUserPhotoResponseMessageType](getuserphotoresponsemessagetype)() | Конструктор по умолчанию. |
