...
type: docs
weight: 6580
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/deletemeetinginstanceresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [DeleteMeetingInstanceResponseMessageType](deletemeetinginstanceresponsemessagetype)() | Конструктор по умолчанию. |
