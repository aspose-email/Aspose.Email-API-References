...
type: docs
weight: 12640
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/removedelegateresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RemoveDelegateResponseMessageType](removedelegateresponsemessagetype)() | Конструктор по умолчанию. |
