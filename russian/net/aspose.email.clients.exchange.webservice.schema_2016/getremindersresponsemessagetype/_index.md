...
type: docs
weight: 9350
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getremindersresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetRemindersResponseMessageType](getremindersresponsemessagetype)() | Конструктор по умолчанию. |
