...
type: docs
weight: 12600
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/removecontactfromimlistresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RemoveContactFromImListResponseMessageType](removecontactfromimlistresponsemessagetype)() | Конструктор по умолчанию. |
