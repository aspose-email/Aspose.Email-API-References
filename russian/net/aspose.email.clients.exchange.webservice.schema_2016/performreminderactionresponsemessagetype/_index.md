...
type: docs
weight: 11750
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/performreminderactionresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [PerformReminderActionResponseMessageType](performreminderactionresponsemessagetype)() | Конструктор по умолчанию. |
