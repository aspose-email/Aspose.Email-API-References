...
type: docs
weight: 6130
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/createmeetinginstanceresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [CreateMeetingInstanceResponseMessageType](createmeetinginstanceresponsemessagetype)() | Конструктор по умолчанию. |
