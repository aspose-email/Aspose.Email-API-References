...
type: docs
weight: 4730
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/applyconversationactionresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [ApplyConversationActionResponseMessageType](applyconversationactionresponsemessagetype)() | Конструктор по умолчанию. |
