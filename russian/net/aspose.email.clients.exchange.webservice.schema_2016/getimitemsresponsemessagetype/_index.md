...
type: docs
weight: 8800
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getimitemsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetImItemsResponseMessageType](getimitemsresponsemessagetype)() | Конструктор по умолчанию. |
