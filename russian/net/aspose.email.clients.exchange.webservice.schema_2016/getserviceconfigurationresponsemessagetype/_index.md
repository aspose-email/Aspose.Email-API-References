...
type: docs
weight: 9610
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getserviceconfigurationresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetServiceConfigurationResponseMessageType](getserviceconfigurationresponsemessagetype)() | Конструктор по умолчанию. |
