...
type: docs
weight: 10730
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/mailtipsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [MailTipsResponseMessageType](mailtipsresponsemessagetype)() | Конструктор по умолчанию. |
