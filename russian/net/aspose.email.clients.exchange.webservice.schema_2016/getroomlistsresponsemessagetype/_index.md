...
type: docs
weight: 9400
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getroomlistsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetRoomListsResponseMessageType](getroomlistsresponsemessagetype)() | Конструктор по умолчанию. |
