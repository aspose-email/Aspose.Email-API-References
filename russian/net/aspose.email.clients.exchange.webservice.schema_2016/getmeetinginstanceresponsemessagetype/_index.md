...
type: docs
weight: 9010
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getmeetinginstanceresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetMeetingInstanceResponseMessageType](getmeetinginstanceresponsemessagetype)() | Конструктор по умолчанию. |
