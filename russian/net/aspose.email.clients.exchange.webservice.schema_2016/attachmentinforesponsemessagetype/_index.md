...
type: docs
weight: 4930
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/attachmentinforesponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [AttachmentInfoResponseMessageType](attachmentinforesponsemessagetype)() | Конструктор по умолчанию. |
