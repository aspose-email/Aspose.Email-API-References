...
type: docs
weight: 12720
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/removeimcontactfromgroupresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RemoveImContactFromGroupResponseMessageType](removeimcontactfromgroupresponsemessagetype)() | Конструктор по умолчанию. |
