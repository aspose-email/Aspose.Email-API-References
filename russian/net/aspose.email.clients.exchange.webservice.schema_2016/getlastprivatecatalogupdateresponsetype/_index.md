...
type: docs
weight: 8920
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getlastprivatecatalogupdateresponsetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetLastPrivateCatalogUpdateResponseType](getlastprivatecatalogupdateresponsetype)() | Конструктор по умолчанию. |
