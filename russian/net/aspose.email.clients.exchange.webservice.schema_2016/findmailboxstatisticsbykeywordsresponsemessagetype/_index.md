...
type: docs
weight: 7820
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/findmailboxstatisticsbykeywordsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [FindMailboxStatisticsByKeywordsResponseMessageType](findmailboxstatisticsbykeywordsresponsemessagetype)() | Конструктор по умолчанию. |
