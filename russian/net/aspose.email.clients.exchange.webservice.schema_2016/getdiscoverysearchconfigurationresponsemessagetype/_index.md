...
type: docs
weight: 8570
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getdiscoverysearchconfigurationresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetDiscoverySearchConfigurationResponseMessageType](getdiscoverysearchconfigurationresponsemessagetype)() | Конструктор по умолчанию. |
