...
type: docs
weight: 9690
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getsharingmetadataresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetSharingMetadataResponseMessageType](getsharingmetadataresponsemessagetype)() | Конструктор по умолчанию. |
