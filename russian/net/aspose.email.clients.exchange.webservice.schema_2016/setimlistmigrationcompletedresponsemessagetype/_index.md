...
type: docs
weight: 13790
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/setimlistmigrationcompletedresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SetImListMigrationCompletedResponseMessageType](setimlistmigrationcompletedresponsemessagetype)() | Конструктор по умолчанию. |
