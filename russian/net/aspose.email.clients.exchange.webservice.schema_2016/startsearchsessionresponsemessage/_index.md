...
type: docs
weight: 14150
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/startsearchsessionresponsemessage/
---
...
| Имя | Описание |
| --- | --- |
| [StartSearchSessionResponseMessage](startsearchsessionresponsemessage)() | Конструктор по умолчанию. |
