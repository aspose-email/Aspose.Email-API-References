...
type: docs
weight: 7790
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/finditemresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [FindItemResponseMessageType](finditemresponsemessagetype)() | Конструктор по умолчанию. |
