...
type: docs
weight: 12760
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/removeimgroupresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [RemoveImGroupResponseMessageType](removeimgroupresponsemessagetype)() | Конструктор по умолчанию. |
