...
type: docs
weight: 14800
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/unpinteammailboxresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [UnpinTeamMailboxResponseMessageType](unpinteammailboxresponsemessagetype)() | Конструктор по умолчанию. |
