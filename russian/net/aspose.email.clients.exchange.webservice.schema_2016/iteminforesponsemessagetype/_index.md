...
type: docs
weight: 10530
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/iteminforesponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [ItemInfoResponseMessageType](iteminforesponsemessagetype)() | Конструктор по умолчанию. |
