...
type: docs
weight: 9120
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getnonindexableitemdetailsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetNonIndexableItemDetailsResponseMessageType](getnonindexableitemdetailsresponsemessagetype)() | Конструктор по умолчанию. |
