...
type: docs
weight: 4300
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/adddistributiongrouptoimlistresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [AddDistributionGroupToImListResponseMessageType](adddistributiongrouptoimlistresponsemessagetype)() | Конструктор по умолчанию. |
