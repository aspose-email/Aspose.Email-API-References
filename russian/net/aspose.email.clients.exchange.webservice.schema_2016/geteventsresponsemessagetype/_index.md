...
type: docs
weight: 8610
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/geteventsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetEventsResponseMessageType](geteventsresponsemessagetype)() | Конструктор по умолчанию. |
