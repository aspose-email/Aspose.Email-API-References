...
type: docs
weight: 6670
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/deletesearchsuggestionresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [DeleteSearchSuggestionResponseMessageType](deletesearchsuggestionresponsemessagetype)() | Конструктор по умолчанию. |
