...
type: docs
weight: 7240
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/endsearchsessionresponsemessage/
---
...
| Имя | Описание |
| --- | --- |
| [EndSearchSessionResponseMessage](endsearchsessionresponsemessage)() | Конструктор по умолчанию. |
