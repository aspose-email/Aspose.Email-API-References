...
type: docs
weight: 14460
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/syncfolderitemsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SyncFolderItemsResponseMessageType](syncfolderitemsresponsemessagetype)() | Конструктор по умолчанию. |
