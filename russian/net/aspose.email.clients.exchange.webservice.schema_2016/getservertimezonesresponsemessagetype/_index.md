...
type: docs
weight: 9560
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getservertimezonesresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetServerTimeZonesResponseMessageType](getservertimezonesresponsemessagetype)() | Конструктор по умолчанию. |
