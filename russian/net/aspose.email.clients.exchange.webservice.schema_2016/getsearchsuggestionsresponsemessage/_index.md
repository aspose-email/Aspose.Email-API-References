...
type: docs
weight: 9490
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getsearchsuggestionsresponsemessage/
---
...
| Имя | Описание |
| --- | --- |
| [GetSearchSuggestionsResponseMessage](getsearchsuggestionsresponsemessage)() | Конструктор по умолчанию. |
