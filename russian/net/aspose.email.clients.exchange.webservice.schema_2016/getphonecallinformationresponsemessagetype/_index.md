...
type: docs
weight: 9290
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getphonecallinformationresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetPhoneCallInformationResponseMessageType](getphonecallinformationresponsemessagetype)() | Конструктор по умолчанию. |
