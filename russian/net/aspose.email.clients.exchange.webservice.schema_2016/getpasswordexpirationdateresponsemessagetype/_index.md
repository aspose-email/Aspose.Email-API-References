...
type: docs
weight: 9210
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getpasswordexpirationdateresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetPasswordExpirationDateResponseMessageType](getpasswordexpirationdateresponsemessagetype)() | Конструктор по умолчанию. |
