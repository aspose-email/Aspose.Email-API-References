...
type: docs
weight: 13750
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/setimgroupresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SetImGroupResponseMessageType](setimgroupresponsemessagetype)() | Конструктор по умолчанию. |
