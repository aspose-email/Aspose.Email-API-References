...
type: docs
weight: 15100
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/updatemeetinginstanceresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [UpdateMeetingInstanceResponseMessageType](updatemeetinginstanceresponsemessagetype)() | Конструктор по умолчанию. |
