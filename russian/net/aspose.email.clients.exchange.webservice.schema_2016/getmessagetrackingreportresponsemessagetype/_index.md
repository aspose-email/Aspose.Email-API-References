...
type: docs
weight: 9090
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getmessagetrackingreportresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetMessageTrackingReportResponseMessageType](getmessagetrackingreportresponsemessagetype)() | Конструктор по умолчанию. |
