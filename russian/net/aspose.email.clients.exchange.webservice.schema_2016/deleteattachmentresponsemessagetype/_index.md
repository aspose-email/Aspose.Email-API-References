...
type: docs
weight: 6390
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/deleteattachmentresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [DeleteAttachmentResponseMessageType](deleteattachmentresponsemessagetype)() | Конструктор по умолчанию. |
