...
type: docs
weight: 14870
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/updatedelegateresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [UpdateDelegateResponseMessageType](updatedelegateresponsemessagetype)() | Конструктор по умолчанию. |
