...
type: docs
weight: 9160
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getnonindexableitemstatisticsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetNonIndexableItemStatisticsResponseMessageType](getnonindexableitemstatisticsresponsemessagetype)() | Конструктор по умолчанию. |
