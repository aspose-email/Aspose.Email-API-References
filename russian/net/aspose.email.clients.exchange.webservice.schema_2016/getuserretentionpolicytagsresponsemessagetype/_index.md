...
type: docs
weight: 10010
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getuserretentionpolicytagsresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetUserRetentionPolicyTagsResponseMessageType](getuserretentionpolicytagsresponsemessagetype)() | Конструктор по умолчанию. |
