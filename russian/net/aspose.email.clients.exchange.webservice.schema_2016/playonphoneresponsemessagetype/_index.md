...
type: docs
weight: 12010
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/playonphoneresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [PlayOnPhoneResponseMessageType](playonphoneresponsemessagetype)() | Конструктор по умолчанию. |
