...
type: docs
weight: 13710
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/setholdonmailboxesresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [SetHoldOnMailboxesResponseMessageType](setholdonmailboxesresponsemessagetype)() | Конструктор по умолчанию. |
