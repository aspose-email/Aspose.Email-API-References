...
type: docs
weight: 4380
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/addimgroupresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [AddImGroupResponseMessageType](addimgroupresponsemessagetype)() | Конструктор по умолчанию. |
