...
type: docs
weight: 11450
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/nonindexableitemstatistictype/
---
...
| Имя | Описание |
| --- | --- |
| [NonIndexableItemStatisticType](nonindexableitemstatistictype)() | Конструктор по умолчанию. |
