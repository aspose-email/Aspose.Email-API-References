...
type: docs
weight: 8760
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getimitemlistresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [GetImItemListResponseMessageType](getimitemlistresponsemessagetype)() | Конструктор по умолчанию. |
