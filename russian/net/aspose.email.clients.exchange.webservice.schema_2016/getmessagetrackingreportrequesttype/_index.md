...
type: docs
weight: 9080
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/getmessagetrackingreportrequesttype/
---
...
| Имя | Описание |
| --- | --- |
| [GetMessageTrackingReportRequestType](getmessagetrackingreportrequesttype)() | Конструктор по умолчанию. |
