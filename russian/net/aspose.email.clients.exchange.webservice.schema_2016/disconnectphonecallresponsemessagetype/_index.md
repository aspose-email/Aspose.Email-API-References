...
type: docs
weight: 6870
url: /ru/net/aspose.email.clients.exchange.webservice.schema_2016/disconnectphonecallresponsemessagetype/
---
...
| Имя | Описание |
| --- | --- |
| [DisconnectPhoneCallResponseMessageType](disconnectphonecallresponsemessagetype)() | Конструктор по умолчанию. |
