...
type: docs
weight: 3420
url: /ru/net/aspose.email.clients.exchange/exchangemessagepageinfo/
---
...
| [Items](../../aspose.email.clients.exchange/exchangemessagepageinfo/items) { get; } | Получает коллекцию объектов ExchangeMessageInfo |
...
| override [NextPage](../../aspose.email.clients.exchange/exchangemessagepageinfo/nextpage) { get; } | Информация о следующей странице или null, если текущая страница последняя |
