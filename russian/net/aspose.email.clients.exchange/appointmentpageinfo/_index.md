...
type: docs
weight: 3030
url: /ru/net/aspose.email.clients.exchange/appointmentpageinfo/
---
...
| [Items](../../aspose.email.clients.exchange/appointmentpageinfo/items) { get; } | Получает коллекцию объектов ExchangeMessageInfo |
...
| override [NextPage](../../aspose.email.clients.exchange/appointmentpageinfo/nextpage) { get; } | Информация о следующей странице или null, если текущая страница последняя |
