...
description: ExchangeMessageInfo представляет информацию сообщения электронной почты полученную из хранилища Exchange.
type: docs
weight: 3400
...
ExchangeMessageInfo представляет информацию сообщения электронной почты, полученную из хранилища Exchange.
...
| virtual [IsRead](../../aspose.email.clients.exchange/exchangemessageinfo/isread) { get; } | Получает значение, указывающее, было ли сообщение прочитано |
