...
description: Получает список папок в почтовом ящике
type: docs
weight: 830
url: /ru/net/aspose.email.clients.imap/imapclient/listfolders/
---
## ListFolders(IConnection) {#listfolders_1}

Получает список папок в почтовом ящике
...
Коллекция объектов ImapFolderInfo
