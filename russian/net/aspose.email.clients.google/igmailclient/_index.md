...
| [CreateContact](../../aspose.email.clients.google/igmailclient/createcontact#createcontact)(Contact) | Создает контакт для указанной электронной почты |
| [CreateContact](../../aspose.email.clients.google/igmailclient/createcontact#createcontact_1)(Contact, string) | Создает контакт для указанной электронной почты |
...
| [DeleteAppointment](../../aspose.email.clients.google/igmailclient/deleteappointment)(string, string) | Удаление встречи. |
...
| [FetchAccessRule](../../aspose.email.clients.google/igmailclient/fetchaccessrule)(string, string) | Выбирает правило доступа |
...
| [GetAllContacts](../../aspose.email.clients.google/igmailclient/getallcontacts)() | Выбирает все контакты. |
| [GetAllGroups](../../aspose.email.clients.google/igmailclient/getallgroups)() | Выбирает все группы контактов. |
| [GetColors](../../aspose.email.clients.google/igmailclient/getcolors)() | Получает информацию о цвете |
| [GetContact](../../aspose.email.clients.google/igmailclient/getcontact#getcontact)(Contact) | Контакт для обновления[`Contact`](../../aspose.email.personalinfo/contact)объект, представляющий контакт gmail при сбое операции |
| [GetContact](../../aspose.email.clients.google/igmailclient/getcontact#getcontact_1)(string) | Выбирает контакт |
...
| [GetSettings](../../aspose.email.clients.google/igmailclient/getsettings)() | Получает словарь настроек |
...
| [UpdateContactPhoto](../../aspose.email.clients.google/igmailclient/updatecontactphoto)(ContactPhoto) | Создает или обновляет фото контакта |
