...
| Имя | Описание |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream)(MapiMessageItemBase) | Инициализирует новый экземпляр класса[`MapiMessagePropertyStream`](../mapimessagepropertystream). |
...
| override [Properties](../../aspose.email.mapi/mapipropertystream/properties) { get; } | Получает коллекцию свойств. |
