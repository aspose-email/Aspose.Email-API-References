...
type: docs
weight: 18490
url: /ru/net/aspose.email.mapi/mapimessagepropertystream/
---
...
| Имя | Описание |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream)(MapiMessageItemBase) | Инициализирует новый экземпляр[`MapiMessagePropertyStream`](../mapimessagepropertystream) класс. |
