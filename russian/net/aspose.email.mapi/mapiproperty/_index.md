...
| [MapiProperty](mapiproperty#constructor_5)(long, IList&lt;object&gt;) | Инициализирует новый экземпляр класса[`MapiProperty`](../mapiproperty). Эта перегрузка используется для создания свойства с несколькими значениями, PT_MV_*. |
...
| [MapiProperty](mapiproperty#constructor_4)(long, long, byte[]) | Инициализирует новый экземпляр класса[`MapiProperty`](../mapiproperty). |
