...
| [DisplayName](../../aspose.email.mapi/mapirecipient/displayname) { get; set; } | Получает или задает отображаемое имя получателя или отправителя сообщения . |
...
| [RecipientTrackStatus](../../aspose.email.mapi/mapirecipient/recipienttrackstatus) { get; set; } | Статус ответа получателя на приглашение на встречу. |
