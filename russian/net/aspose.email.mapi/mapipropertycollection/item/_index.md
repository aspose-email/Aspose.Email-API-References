...
| Параметр | Описание |
| --- | --- |
| tag | Ключ тега, значение которого нужно получить или установить. |
...
| Параметр | Описание |
| --- | --- |
| pd | [`PropertyDescriptor`](../../propertydescriptor) ключ, значение которого нужно получить или установить. |
