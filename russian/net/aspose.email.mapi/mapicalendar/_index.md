...
| Имя | Описание |
| --- | --- |
| [MapiCalendar](mapicalendar#constructor)() | Инициализирует новый экземпляр[`MapiCalendar`](../mapicalendar) класс |
| [MapiCalendar](mapicalendar#constructor_1)(string, string, string, DateTime, DateTime) | Инициализирует новый экземпляр[`MapiCalendar`](../mapicalendar) класс. |
| [MapiCalendar](mapicalendar#constructor_2)(string, string, string, DateTime, DateTime, MapiElectronicAddress, MapiRecipientCollection) | Инициализирует новый экземпляр[`MapiCalendar`](../mapicalendar) класс. |
| [MapiCalendar](mapicalendar#constructor_3)(string, string, string, DateTime, DateTime, string, MapiRecipientCollection) | Инициализирует новый экземпляр[`MapiCalendar`](../mapicalendar) класс. |
...
| [EndDate](../../aspose.email.mapi/mapicalendar/enddate) { get; set; } | Получает или задает дату и время окончания события. Если дата не установлена, значение по умолчанию дляDateTime возвращается. |
| [EndDateTimeZone](../../aspose.email.mapi/mapicalendar/enddatetimezone) { get; set; } | Получает или задает информацию о часовом поясе, указывающую часовой пояс EndDate property |
...
| [KeyWords](../../aspose.email.mapi/mapicalendar/keywords) { get; set; } | Получает или задает категории календаря object |
...
| [ReminderDelta](../../aspose.email.mapi/mapicalendar/reminderdelta) { get; set; } | Получает или задает интервал в минутах между временем, когда напоминание впервые становится просроченным, и временем начала календаря object |
| [ReminderFileParameter](../../aspose.email.mapi/mapicalendar/reminderfileparameter) { get; set; } | Указывает полный путь к звуку, который клиент ДОЛЖЕН воспроизводить, когда напоминание просрочено. |
| [ReminderSet](../../aspose.email.mapi/mapicalendar/reminderset) { get; set; } | Получает или задает значение, указывающее, установлено ли напоминание для object |
...
| [StartDate](../../aspose.email.mapi/mapicalendar/startdate) { get; set; } | Получает или задает дату и время начала события. Если дата не задана, значение по умолчанию дляDateTime возвращается. |
...
| [Save](../../aspose.email.mapi/mapicalendar/save#save_3)(string) | Сохраняет объект календаря в файл формата iCalendar, используя параметры сохранения по умолчанию |
...
| [Save](../../aspose.email.mapi/mapicalendar/save#save_2)(Stream, MapiCalendarSaveOptions) | Сохраняет календарь в поток с указанными параметрами сохранения |
| [Save](../../aspose.email.mapi/mapicalendar/save#save_4)(string, AppointmentSaveFormat) | Сохраняет объект календаря в файл указанного формата, используя параметры сохранения по умолчанию |
| [Save](../../aspose.email.mapi/mapicalendar/save#save_5)(string, MapiCalendarSaveOptions) | Сохраняет объект календаря в файл указанного формата, используя параметры сохранения по умолчанию |
