...
| Имя | Описание |
| --- | --- |
| [MapiNote](mapinote#constructor)() | Инициализирует новый экземпляр[`MapiNote`](../mapinote) класс. |
| [MapiNote](mapinote#constructor_1)(string, string) | Инициализирует новый экземпляр[`MapiNote`](../mapinote) класс. |
...
| [Color](../../aspose.email.mapi/mapinote/color) { get; set; } | Получает или задает предлагаемый цвет фона примечания object |
| [Companies](../../aspose.email.mapi/mapimessageitembase/companies) { get; set; } | Содержит названия компаний, связанных с элементом. |
| [CreationDate](../../aspose.email.mapi/mapinote/creationdate) { get; set; } | Получает или задает дату создания note |
| [Height](../../aspose.email.mapi/mapinote/height) { get; set; } | Получает или задает высоту видимого окна сообщения в пикселях |
...
| [XPosition](../../aspose.email.mapi/mapinote/xposition) { get; set; } | Получает или задает расстояние в пикселях от левого края экрана , на котором пользовательский интерфейс отображает объект Note |
| [YPosition](../../aspose.email.mapi/mapinote/yposition) { get; set; } | Получает или задает расстояние в пикселях от верхнего края экрана , на котором пользовательский интерфейс отображает объект Note |
...
| [Save](../../aspose.email.mapi/mapinote/save#save)(Stream, NoteSaveFormat) | Сохраняет это[`MapiNote`](../mapinote) в данный поток, используя указанный формат. |
| [Save](../../aspose.email.mapi/mapinote/save#save_1)(string, NoteSaveFormat) | Сохраняет это[`MapiNote`](../mapinote) в файл, используя указанный формат. |
