...
| Имя | Описание |
| --- | --- |
| [MapiTask](mapitask#constructor)() | Инициализирует новый экземпляр класса[`MapiTask`](../mapitask). |
| [MapiTask](mapitask#constructor_1)(string, string, DateTime, DateTime) | Инициализирует новый экземпляр класса[`MapiTask`](../mapitask). |
...
| [ActualEffort](../../aspose.email.mapi/mapitask/actualeffort) { get; set; } | Получает или задает количество минут, которые пользователь фактически потратил на работу над задачей. |
...
| [EstimatedEffort](../../aspose.email.mapi/mapitask/estimatedeffort) { get; set; } | Получает или задает количество минут , которое пользователь ожидает для работы над задачей. |
| [Flags](../../aspose.email.mapi/mapitask/flags) { get; } | Получает флаги индикации объекта Task. |
| [History](../../aspose.email.mapi/mapitask/history) { get; set; } | Получает или задает тип изменения , последнего внесенного в объект Task. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | Идентификатор элемента, используется с сервером |
| [LastUpdate](../../aspose.email.mapi/mapitask/lastupdate) { get; set; } | Получает или задает дату и время наиболее последних изменений, внесенных в объект Task. |
...
| [ReminderFileParameter](../../aspose.email.mapi/mapitask/reminderfileparameter) { get; set; } | Указывает полный путь звука, который ДОЛЖЕН воспроизводить клиент, когда напоминание просрочено. |
| [ReminderSet](../../aspose.email.mapi/mapitask/reminderset) { get; set; } | Получает или задает значение, указывающее, установлено ли напоминание для объекта |
| [ReminderTime](../../aspose.email.mapi/mapitask/remindertime) { get; set; } | Получает или устанавливает время начального сигнала для напоминания |
...
| [State](../../aspose.email.mapi/mapitask/state) { get; set; } | Получает или устанавливает текущее назначение состояние объекта Task. |
| [Status](../../aspose.email.mapi/mapitask/status) { get; set; } | Получает или задает статус выполнения пользователем задачи. |
...
| [Save](../../aspose.email.mapi/mapitask/save#save)(Stream, TaskSaveFormat) | Сохраняет это[`MapiTask`](../mapitask)в указанный поток, используя указанный формат. |
| [Save](../../aspose.email.mapi/mapitask/save#save_1)(string, TaskSaveFormat) | Сохраняет это[`MapiTask`](../mapitask)в файл с использованием указанного формата. |
