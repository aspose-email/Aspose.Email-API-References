...
| Имя | Описание |
| --- | --- |
| [MapiJournal](mapijournal#constructor)() | Инициализирует новый экземпляр[`MapiJournal`](../mapijournal) класс. |
| [MapiJournal](mapijournal#constructor_1)(string, string, string, string) | Инициализирует новый экземпляр[`MapiJournal`](../mapijournal) класс. |
