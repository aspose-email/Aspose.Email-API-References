...
description: Представляет поток свойств объекта-получателя.
type: docs
weight: 18640
url: /ru/net/aspose.email.mapi/mapirecipientpropertystream/
---
## MapiRecipientPropertyStream class

Представляет поток свойств объекта-получателя.
