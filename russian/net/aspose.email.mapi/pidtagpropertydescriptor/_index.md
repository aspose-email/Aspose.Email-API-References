...
| Имя | Описание |
| --- | --- |
| [PidTagPropertyDescriptor](pidtagpropertydescriptor#constructor_1)(long) | Инициализирует новый экземпляр[`PidTagPropertyDescriptor`](../pidtagpropertydescriptor)class Свойство, которое определяется 16-битным идентификатором свойства и 16-битным типом свойства. Идентификатор свойства для помеченного свойства находится в диапазоне 0x001 � 0x7FFF. Идентификаторы свойств в диапазоне 0x8000 � 0x8FFF зарезервированы для присвоения именованным свойствам |
...
| override [GetHashCode](../../aspose.email.mapi/pidtagpropertydescriptor/gethashcode)() | Служит хэш-функцией для типа. |
...
| [explicit operator](../../aspose.email.mapi/pidtagpropertydescriptor/op_explicit) | Преобразует значение тега в тегированное свойство |
