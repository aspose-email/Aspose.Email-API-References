...
| Имя | Описание |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Инициализирует новый экземпляр[`MapiDistributionList`](../mapidistributionlist) класс. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Инициализирует новый экземпляр[`MapiDistributionList`](../mapidistributionlist) класс. |
