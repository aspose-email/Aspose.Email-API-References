...
description: Представляет объект личного списка рассылки.
type: docs
weight: 18330
url: /ru/net/aspose.email.mapi/mapidistributionlist/
---
## MapiDistributionList class

Представляет объект личного списка рассылки.
...
| Имя | Описание |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Инициализирует новый экземпляр класса[`MapiDistributionList`](../mapidistributionlist). |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Инициализирует новый экземпляр класса[`MapiDistributionList`](../mapidistributionlist). |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | Получает или задает видимое пользователю имя личного списка рассылки. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | Идентификатор элемента, используется с сервером |
| [Members](../../aspose.email.mapi/mapidistributionlist/members) { get; } | Получает список членов личного списка рассылки. |
...
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save)(Stream) | Сохраняет указанный поток. |
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save_1)(string) | Сохраняет указанное имя файла. |
