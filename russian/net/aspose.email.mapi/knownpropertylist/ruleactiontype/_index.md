...
description: Содержит поле ActionType MS-OXORULE раздел 2.2.5.1 правила которое не удалось выполнить.
type: docs
weight: 16450
...
Содержит поле ActionType ([MS-OXORULE], раздел 2.2.5.1) правила, которое не удалось выполнить.
