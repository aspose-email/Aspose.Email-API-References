...
description: MessageInfo представляет информацию сообщения электронной почты полученную с почтового сервера.
type: docs
weight: 16760
url: /ru/net/aspose.email.clients/messageinfobase/
---
## MessageInfoBase class

MessageInfo представляет информацию сообщения электронной почты, полученную с почтового сервера.
...
| Имя | Описание |
| --- | --- |
| [MessageInfoBase](messageinfobase)() | Инициализирует новый экземпляр класса[`MessageInfoBase`](../messageinfobase). |
