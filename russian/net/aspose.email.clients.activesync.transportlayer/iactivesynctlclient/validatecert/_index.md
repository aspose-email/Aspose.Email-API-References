...
| --- | --- | --- |
| certificate | X509Certificate | Сертификат, который необходимо подтвердить. |
...
| --- | --- | --- |
| certificate | X509Certificate | Сертификат, который необходимо подтвердить. |
| checkCrl | Boolean | Указывает, ДОЛЖЕН ли сервер игнорировать неподдающийся проверке статус отзыва. Статус отзыва сертификата не может быть проверен, если невозможно получить списки отзыва сертификатов (CRL). неподдающийся проверке статус отзыва. Когда для CheckCRL установлено значение FALSE, серверу СЛЕДУЕТ игнорировать неподдающийся проверке статус отзыва. Значение по умолчанию — FALSE. |
