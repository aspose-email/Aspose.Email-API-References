...
description: Принимает предварительно принимает или отклоняет приглашение на собрание в папке Входящие пользователя или в папке Календарь.
type: docs
weight: 110
...
Принимает, предварительно принимает или отклоняет приглашение на собрание в папке "Входящие" пользователя или в папке "Календарь".
...
| requestId | String | Указывает идентификатор сервера элемента сообщения запроса на собрание. Необязательно, если включен LongId. Значение RequestId может иметь длину до 64 символов. |
