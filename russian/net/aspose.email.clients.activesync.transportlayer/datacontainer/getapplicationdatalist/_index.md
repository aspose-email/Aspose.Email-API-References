...
| --- | --- | --- |
| elementName | AirSync | Имя элемента |

### Возвращаемое значение

Возвращает список контейнеров данных для выбранного элемента

### Смотрите также

* enum [AirSync](../../airsync)
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | AirSyncBase | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Email | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Email2 | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Calendar | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | DocumentLibrary | Имя элемента |
...
* enum [DocumentLibrary](../../documentlibrary)
* class [DataContainer](../../datacontainer)
* пространство имен [Aspose.Email.Clients.ActiveSync.TransportLayer](../../datacontainer)
* сборка [Aspose.Email](../../../)
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Contacts | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Contacts2 | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Tasks | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Notes | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | RightsManagement | Имя элемента |
...
* enum [RightsManagement](../../rightsmanagement)
* class [DataContainer](../../datacontainer)
* пространство имен [Aspose.Email.Clients.ActiveSync.TransportLayer](../../datacontainer)
* сборка [Aspose.Email](../../../)
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Settings | Имя элемента |
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | ItemOperations | Имя элемента |
...
* enum [ItemOperations](../../itemoperations)
* class [DataContainer](../../datacontainer)
* пространство имен [Aspose.Email.Clients.ActiveSync.TransportLayer](../../datacontainer)
* сборка [Aspose.Email](../../../)
...
| Параметр | Тип | Описание |
| --- | --- | --- |
| elementName | Search | Имя элемента |
