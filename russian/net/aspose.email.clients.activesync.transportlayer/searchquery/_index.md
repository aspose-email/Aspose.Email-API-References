...
| Имя | Описание |
| --- | --- |
| [And](../../aspose.email.clients.activesync.transportlayer/searchquery/and) { get; set; } | Указывает ключевые слова, используемые для сопоставления записей в искомом хранилище. |
