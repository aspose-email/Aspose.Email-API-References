...
type: docs
weight: 12490
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/registerconsentresponsemessagetype/
---
## RegisterConsentResponseMessageType class

```csharp
public class RegisterConsentResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [RegisterConsentResponseMessageType](registerconsentresponsemessagetype)() | Constructor predeterminado |
