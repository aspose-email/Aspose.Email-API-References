...
type: docs
weight: 12720
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/removeimcontactfromgroupresponsemessagetype/
---
## RemoveImContactFromGroupResponseMessageType class

```csharp
public class RemoveImContactFromGroupResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [RemoveImContactFromGroupResponseMessageType](removeimcontactfromgroupresponsemessagetype)() | Constructor predeterminado |
