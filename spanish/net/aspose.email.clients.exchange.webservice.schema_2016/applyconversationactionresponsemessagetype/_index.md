...
type: docs
weight: 4730
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/applyconversationactionresponsemessagetype/
---
## ApplyConversationActionResponseMessageType class

```csharp
public class ApplyConversationActionResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [ApplyConversationActionResponseMessageType](applyconversationactionresponsemessagetype)() | Constructor predeterminado |
