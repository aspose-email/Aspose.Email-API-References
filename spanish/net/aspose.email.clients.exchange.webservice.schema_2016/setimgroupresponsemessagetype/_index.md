...
type: docs
weight: 13750
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/setimgroupresponsemessagetype/
---
## SetImGroupResponseMessageType class

```csharp
public class SetImGroupResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [SetImGroupResponseMessageType](setimgroupresponsemessagetype)() | Constructor predeterminado |
