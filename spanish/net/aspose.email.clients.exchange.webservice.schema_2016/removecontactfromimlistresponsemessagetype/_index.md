...
type: docs
weight: 12600
url: /es/net/aspose.email.clients.exchange.webservice.schema_2016/removecontactfromimlistresponsemessagetype/
---
## RemoveContactFromImListResponseMessageType class

```csharp
public class RemoveContactFromImListResponseMessageType : ResponseMessageType
```
...
| Nombre | Descripción |
| --- | --- |
| [RemoveContactFromImListResponseMessageType](removecontactfromimlistresponsemessagetype)() | Constructor predeterminado |
