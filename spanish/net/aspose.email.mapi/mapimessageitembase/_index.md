...
description: Representa la clase base para todas las clases MapiMessageItem y mantiene colecciones comunes de propiedades mapi adjuntos destinatarios.
type: docs
weight: 18470
url: /es/net/aspose.email.mapi/mapimessageitembase/
---
## MapiMessageItemBase class

Representa la clase base para todas las clases MapiMessageItem y mantiene colecciones comunes de propiedades mapi, adjuntos, destinatarios.
...
| [BodyHtml](../../aspose.email.mapi/mapimessageitembase/bodyhtml) { get; } | Obtiene el[`BodyRtf`](./bodyrtf) del mensaje convertido a HTML, si está presente, de lo contrario, una cadena vacía. |
...
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent)(string, BodyContentType) | Establece el contenido del cuerpo. |
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent_1)(string, BodyContentType, bool) | Establece el contenido del cuerpo. |
...
| override [SetProperty](../../aspose.email.mapi/mapimessageitembase/setproperty#setproperty_1)(PropertyDescriptor, object) | Establece la propiedad MAPI. |
