...
description: Representa el objeto Lista de distribución personal.
type: docs
weight: 18360
url: /es/net/aspose.email.mapi/mapidistributionlist/
---
## MapiDistributionList class

Representa el objeto Lista de distribución personal.
...
| Nombre | Descripción |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Inicializa una nueva instancia del[`MapiDistributionList`](../mapidistributionlist) clase. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Inicializa una nueva instancia del[`MapiDistributionList`](../mapidistributionlist) clase. |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | Obtiene o establece el nombre visible para el usuario de la lista de distribución personal. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | El id del artículo, se usa con un servidor |
| [Members](../../aspose.email.mapi/mapidistributionlist/members) { get; } | Obtiene la lista de los miembros de la lista de distribución personal. |
...
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save)(Stream) | Guarda el flujo especificado. |
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save_1)(string) | Guarda el nombre de archivo especificado. |
