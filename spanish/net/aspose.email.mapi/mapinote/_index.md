...
description: Representa el objeto Nota de Outlook nota adhesiva
type: docs
weight: 18530
url: /es/net/aspose.email.mapi/mapinote/
---
## MapiNote class

Representa el objeto Nota de Outlook ("nota adhesiva")
...
| Nombre | Descripción |
| --- | --- |
| [MapiNote](mapinote#constructor)() | Inicializa una nueva instancia del[`MapiNote`](../mapinote) clase. |
| [MapiNote](mapinote#constructor_1)(string, string) | Inicializa una nueva instancia del[`MapiNote`](../mapinote) clase. |
...
| [Color](../../aspose.email.mapi/mapinote/color) { get; set; } | Obtiene o establece el color de fondo sugerido del objeto Nota |
...
| [CreationDate](../../aspose.email.mapi/mapinote/creationdate) { get; set; } | Obtiene o establece la fecha de creación de note |
| [Height](../../aspose.email.mapi/mapinote/height) { get; set; } | Obtiene o establece la altura de la ventana del mensaje visible en píxeles |
...
| [Width](../../aspose.email.mapi/mapinote/width) { get; set; } | Obtiene o establece el ancho de la ventana del mensaje visible en píxeles |
| [XPosition](../../aspose.email.mapi/mapinote/xposition) { get; set; } | Obtiene o establece la distancia, en píxeles, desde el borde izquierdo de la pantalla a la que una interfaz de usuario muestra un objeto Nota |
| [YPosition](../../aspose.email.mapi/mapinote/yposition) { get; set; } | Obtiene o establece la distancia, en píxeles, desde el borde superior de la pantalla a la que una interfaz de usuario muestra un objeto Nota |
...
| [Save](../../aspose.email.mapi/mapinote/save#save)(Stream, NoteSaveFormat) | Guarda esto[`MapiNote`](../mapinote) al flujo dado usando el formato especificado. |
| [Save](../../aspose.email.mapi/mapinote/save#save_1)(string, NoteSaveFormat) | Guarda esto[`MapiNote`](../mapinote) en el archivo usando el formato especificado. |
