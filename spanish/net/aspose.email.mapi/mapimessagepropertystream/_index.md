...
description: Representa el flujo de propiedad.
type: docs
weight: 18490
url: /es/net/aspose.email.mapi/mapimessagepropertystream/
---
## MapiMessagePropertyStream class

Representa el flujo de propiedad.
...
| Nombre | Descripción |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream)(MapiMessageItemBase) | Inicializa una nueva instancia del[`MapiMessagePropertyStream`](../mapimessagepropertystream) clase. |
