...
| [Range(Date start, Date end)](#Range-java.util.Date-java.util.Date-) | Initializes a new instance of the Range class. |
## Methods
...
### Range(Date start, Date end) {#Range-java.util.Date-java.util.Date-}
```
