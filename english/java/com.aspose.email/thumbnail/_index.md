...
description:  https//docs.microsoft.com/en-us/graph/api/resources/thumbnailviewgraph-rest-1.0
...
| Method | Description |
| --- | --- |
| [getHeight()](#getHeight--) | The height of the thumbnail, in pixels. |
...
| [getSourceItemId()](#getSourceItemId--) | The unique identifier of the item that provided the thumbnail.This is only available when a folder thumbnail is requested. |
...
| [getContent()](#getContent--) | The content stream for the thumbnail. |
