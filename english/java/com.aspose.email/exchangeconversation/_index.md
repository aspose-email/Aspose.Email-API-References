...
| [getUniqueRecipients()](#getUniqueRecipients--) | Gets the list of all the people who have received messages in this conversation for messages in the current folder. |
