...
description: Component allows displaying multiple similar pieces of content along a horizontal axis.
type: docs
weight: 17
url: /androidjava/com.aspose.email/ampcarousel/
---
...
| --- | --- |
| [AmpCarousel(int width, int height)](#AmpCarousel-int-int-) | Create instance of form AmpCarousel. |
## Methods
...
| [getImages()](#getImages--) | Set of images for displaying. |
...
| [getType()](#getType--) | Specifies the display type for the carousel items. |
| [hashCode()](#hashCode--) |  |
| [notify()](#notify--) |  |
| [notifyAll()](#notifyAll--) |  |
...
| [setType(int value)](#setType-int-) | Specifies the display type for the carousel items. |
...
| --- | --- | --- |
| width | int | width of AmpCarousel |
| height | int | height of AmpCarousel |
