...
description: Compares two LogLevelaspose.email.tools.logging/loglevel objects and returns a value indicating whether the first one is less than the second one.
type: docs
weight: 110
...
Compares two [`LogLevel`](../../loglevel) objects and returns a value indicating whether the first one is less than the second one.
