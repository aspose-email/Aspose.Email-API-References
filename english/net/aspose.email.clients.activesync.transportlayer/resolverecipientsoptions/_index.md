...
| [CertificateRetrieval](../../aspose.email.clients.activesync.transportlayer/resolverecipientsoptions/certificateretrieval) { get; set; } | Specifies whether S/MIME certificates SHOULD be returned by the server for each resolved recipient. |
...
| [Picture](../../aspose.email.clients.activesync.transportlayer/resolverecipientsoptions/picture) { get; set; } | Indicates that the client is requesting that contact photos be returned in the server response. The Picture is not supported when the protocol version is 12.1 or 14.0. Contains the data related to the contact photos. |
