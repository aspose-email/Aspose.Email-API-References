...
| Class | Description |
| --- | --- |
| class [OlmFolder](./olmfolder) | Represents folder information in OLM storage. |
| class [OlmMessageInfo](./olmmessageinfo) | Represents an information about message in the OLM storage. |
| class [OlmStorage](./olmstorage) | Represents Outlook for Mac storage (.OLM) file. |
