...
description: Name of the moderator of the mailing list to which this message is sent necessary on a posting sent to a moderated mailing list to allow its distribution to the list members. Example ApprovedBy someonesomedomain.com Nonstandard for use in email. Defined in RFC1036.
type: docs
weight: 20
