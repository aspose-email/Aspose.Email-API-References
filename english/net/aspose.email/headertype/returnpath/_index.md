...
description: Used to convey the information from the MAIL FROM envelope attribute in final delivery when the message leaves the SMTP environment in which MAIL FROM is used. ///
type: docs
weight: 200
