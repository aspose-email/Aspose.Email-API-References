---
title: Class EnumComparisonField
second_title: Aspose.Email for .NET API Reference
description: Aspose.Email.Tools.Search.EnumComparisonField class. Represents the enum search field
type: docs
weight: 20530
...
| Name | Description |
| --- | --- |
| [Equals](../../aspose.email.tools.search/enumcomparisonfield/equals/#equals)(Enum) | Indicates that field in message must be equal to the specified value. |
