...
description: Gets or sets a boolean value that controls whether the messages are sent in TNEF format. Note that now message is sent in TNEF format when being loaded a message contains tnef.
type: docs
weight: 100
