---
title: IGraphClient.CreateRule
second_title: Aspose.Email for .NET API Reference
description: IGraphClient method. Create a message rule by specifying a set of conditions and actions. Outlook carries out those actions if an incoming message in the users Inbox meets the specified conditions. Permissions One of the following permissions is required to call this API.To learn more including how to choose permissions see Permissions. Delegated work or school account MailboxSettings.ReadWrite Delegated personal Microsoft account MailboxSettings.ReadWrite Application MailboxSettings.ReadWrite
type: docs
weight: 200
url: /net/aspose.email.clients.graph/igraphclient/createrule/
---
