...
description: Class which allows applications to detect spam emails with selflearning Bayesian filter.
type: docs
weight: 250
...
| Name | Description |
| --- | --- |
| [SpamAnalyzer](spamanalyzer#constructor)() | Initialize a new instance of the [`SpamAnalyzer`](../spamanalyzer) class. |
| [SpamAnalyzer](spamanalyzer#constructor_1)(Stream) | Initialize a new instance of the [`SpamAnalyzer`](../spamanalyzer) class. |
| [SpamAnalyzer](spamanalyzer#constructor_2)(string) | Initialize a new instance of the [`SpamAnalyzer`](../spamanalyzer) class. |
