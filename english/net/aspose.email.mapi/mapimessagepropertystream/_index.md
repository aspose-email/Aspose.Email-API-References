---
title: Class MapiMessagePropertyStream
...
| Name | Description |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream/)(MapiMessageItemBase) | Initializes a new instance of the `MapiMessagePropertyStream` class. |
