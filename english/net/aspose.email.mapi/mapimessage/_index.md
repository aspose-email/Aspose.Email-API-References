...
| Name | Description |
| --- | --- |
| [MapiMessage](mapimessage/#constructor)() | Initializes a new instance of the `MapiMessage` class. |
| [MapiMessage](mapimessage/#constructor_1)(OutlookMessageFormat) | Initializes a new instance of the `MapiMessage` class. |
| [MapiMessage](mapimessage/#constructor_2)(string, string, string, string) | Initializes a new instance of the `MapiMessage` class. |
| [MapiMessage](mapimessage/#constructor_3)(string, string, string, string, OutlookMessageFormat) | Initializes a new instance of the `MapiMessage` class. |
...
| [IsTemplate](../../aspose.email.mapi/mapimessage/istemplate/) { get; } | Determines whether the message is Outlook template (.oft). |
