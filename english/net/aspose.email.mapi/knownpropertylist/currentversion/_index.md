...
description: Specifies the build number of the client application that sent the message. Area General Message Properties Canonical name PidLidCurrentVersion Alternate names dispidCurrentVersion
type: docs
weight: 3590
