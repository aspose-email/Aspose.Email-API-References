...
description: Indicates whether email recipients are to be added to the safe senders list. Area Spam Canonical name PidTagJunkAddRecipientsToSafeSendersList Alternate names PR_JUNK_ADD_RECIPS_TO_SSL
type: docs
weight: 11870
