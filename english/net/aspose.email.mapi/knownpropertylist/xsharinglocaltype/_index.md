...
description: Contains the same value as the PidLidSharingLocalType property section 2.259. Area Sharing Canonical name PidNameXSharingLocalType Alternate names
type: docs
weight: 19770
