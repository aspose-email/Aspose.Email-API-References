---
title: KnownPropertyList.FlagString
second_title: Aspose.Email for .NET API Reference
description: KnownPropertyList field. Contains an index identifying one of a set of predefined text strings to be associated with the flag. Area Tasks Canonical name PidLidFlagString Alternate names dispidFlagStringEnum
type: docs
weight: 10370
