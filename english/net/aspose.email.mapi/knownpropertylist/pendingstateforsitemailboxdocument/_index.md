...
description: Specifies the synchronization state of the Document object that is in the Document Libraries folder of the site mailbox. Area Site Mailbox Canonical name PidLidPendingStateForSiteMailboxDocument Alternate names dispidPendingStateforTMDocument
type: docs
weight: 14230
