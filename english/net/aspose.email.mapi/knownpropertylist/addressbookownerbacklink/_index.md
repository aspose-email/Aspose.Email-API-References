...
description: Contains a list of the distribution lists owned by a mail user. Area Address Book Canonical name PidTagAddressBookOwnerBackLink Alternate names PR_EMS_AB_OWNER_BL_O
type: docs
weight: 810
