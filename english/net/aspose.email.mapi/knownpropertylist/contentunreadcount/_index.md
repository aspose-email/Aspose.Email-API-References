...
description: Specifies the number of rows under the header row that have the PidTagRead property section 2.869 set to FALSE. Area Folder Properties Canonical name PidTagContentUnreadCount Alternate names PR_CONTENT_UNREAD ptagContentUnread urnschemashttpmailunreadcount
type: docs
weight: 3290
