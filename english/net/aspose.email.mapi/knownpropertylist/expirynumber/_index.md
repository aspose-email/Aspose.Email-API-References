...
description: Contains an integer value that is used along with the PidTagExpiryUnits property section 2.681 to define the expiry send time. Area MapiStatus Canonical name PidTagExpiryNumber Alternate names PR_EXPIRY_NUMBER
type: docs
weight: 9940
