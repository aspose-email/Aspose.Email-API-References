...
description: Contains an opaque property that the client sets for the exclusive use of the client. Set on the FAI message. Area ExchangeNonTransmittableReserved Canonical name PidTagRuleMessageUserFlags Alternate names PR_RULE_MSG_USER_FLAGS ptagRuleMsgUserFlags
type: docs
weight: 16580
