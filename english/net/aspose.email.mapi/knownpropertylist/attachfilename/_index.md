...
description: Contains the 8.3 name of the PidTagAttachLongFilename property section 2.586. Area Message Attachment Properties Canonical name PidTagAttachFilename Alternate names PR_ATTACH_FILENAME PR_ATTACH_FILENAME_A ptagAttachFilename PR_ATTACH_FILENAME_W
type: docs
weight: 1590
