...
description: Contains the same value as the PidLidSharingRemoteName property section 2.277. Area Sharing Canonical name PidNameXSharingRemoteName Alternate names
type: docs
weight: 19810
