...
description: Specifies the maximum size in bytes of a message that a recipient can receive. Area Address Book Canonical name PidTagAddressBookDeliveryContentLength Alternate names PR_EMS_AB_DELIV_CONT_LENGTH
type: docs
weight: 350
