...
description: Contains the same value as the PidLidSharingRemoteUid property section 2.282. Area Sharing Canonical name PidNameXSharingRemoteUid Alternate names
type: docs
weight: 19850
