...
description: Contains a string indicating whether the original message was displayed to the user or deleted report messages only. Area Email Canonical name PidTagReportDisposition Alternate names PR_REPORT_DISPOSITION_W
type: docs
weight: 16000
