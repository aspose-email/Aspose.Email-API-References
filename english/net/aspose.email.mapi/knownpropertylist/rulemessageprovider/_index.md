...
description: Identifies the client application that owns the rule. Set on the FAI message. Area ExchangeNonTransmittableReserved Canonical name PidTagRuleMessageProvider Alternate names ptagRuleMsgProvider
type: docs
weight: 16540
