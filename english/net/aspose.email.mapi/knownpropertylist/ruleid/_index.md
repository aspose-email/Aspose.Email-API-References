...
description: Specifies a unique identifier that is generated by the messaging server for each rule when the rule is first created. Area ServerSide Rules Properties Canonical name PidTagRuleId Alternate names PR_RULE_ID ptagRuleId
type: docs
weight: 16490
