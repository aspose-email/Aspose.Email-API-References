---
title: KnownPropertyList.MessageEditorFormat
second_title: Aspose.Email for .NET API Reference
description: KnownPropertyList field. Specifies the format that an email editor can use for editing the message body. Area Miscellaneous Properties Canonical name PidTagMessageEditorFormat Alternate names PR_MSG_EDITOR_FORMAT ptagMsgEditorFormat
type: docs
weight: 12600
