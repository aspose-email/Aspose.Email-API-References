---
title: KnownPropertyList.ContainerContents
second_title: Aspose.Email for .NET API Reference
description: KnownPropertyList field. Always empty. An NSPI server defines this value for distribution lists and it is not present for other objects. Area Container Properties Canonical name PidTagContainerContents Alternate names PR_CONTAINER_CONTENTS ptagContainerContents
type: docs
weight: 3110
