...
description: Not used. The client can set this property but it has no impact on the TaskRelated Objects Protocol and is ignored by the server. Area Tasks Canonical name PidLidTaskNoCompute Alternate names dispidTaskNoCompute
type: docs
weight: 18740
