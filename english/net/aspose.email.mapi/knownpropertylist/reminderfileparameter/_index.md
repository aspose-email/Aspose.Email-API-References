...
description: Specifies the filename of the sound that a client is to play when the reminder for that object becomes overdue. Area Reminders Canonical name PidLidReminderFileParameter Alternate names dispidReminderFileParam
type: docs
weight: 15680
