...
| Name | Description |
| --- | --- |
| [MapiTask](mapitask/#constructor)() | Initializes a new instance of the `MapiTask` class. |
| [MapiTask](mapitask/#constructor_1)(string, string, DateTime, DateTime) | Initializes a new instance of the `MapiTask` class. |
...
| [Save](../../aspose.email.mapi/mapitask/save/#save_1)(string, TaskSaveFormat) | Saves this `MapiTask` into file using specified format. |
