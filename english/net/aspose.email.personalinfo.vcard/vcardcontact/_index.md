...
| static [Load](../../aspose.email.personalinfo.vcard/vcardcontact/load/#load_2)(string) | Reads `VCardContact` from the specified vCard file The supported vCard versions are 2.1 and 3.0 |
...
| static [Load](../../aspose.email.personalinfo.vcard/vcardcontact/load/#load_3)(string, VCardLoadOptions) | Reads `VCardContact` from the specified vCard file The supported vCard versions are 2.1 and 3.0 |
...
| static [LoadAsMultiple](../../aspose.email.personalinfo.vcard/vcardcontact/loadasmultiple/#loadasmultiple_2)(string) | Loads list of contacts from multi contact file. |
...
| static [LoadAsMultiple](../../aspose.email.personalinfo.vcard/vcardcontact/loadasmultiple/#loadasmultiple_3)(string, VCardLoadOptions) |  |
