---
title: ExchangeClient.SaveMessage
second_title: Aspose.Email for .NET API Reference
description: ExchangeClient method. Saves mail message specified by the uri to local file system. The mail message file is RFC 822 compliant format EML. if you want to parse the mail message files use MailMessage
type: docs
weight: 360
