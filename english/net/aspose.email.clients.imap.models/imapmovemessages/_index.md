---
title: Class ImapMoveMessages
second_title: Aspose.Email for .NET API Reference
description: Aspose.Email.Clients.Imap.Models.ImapMoveMessages class. MoveMessagesAsync method parameter set
type: docs
weight: 16650
url: /net/aspose.email.clients.imap.models/imapmovemessages/
---
## ImapMoveMessages class

[`MoveMessagesAsync`](../../aspose.email.clients.imap/iasyncimapclient/movemessagesasync/) method parameter set.
...
| Name | Description |
| --- | --- |
| static [Create](../../aspose.email.clients.imap.models/imapmovemessages/create/)() | Create new `ImapMoveMessages` instance. |
...
| [SetCommitDeletions](../../aspose.email.clients.imap.models/imapmovemessages/setcommitdeletions/)(bool) | Specifies whether deletions should be committed. |
| [SetConnection](../../aspose.email.clients.imap.models/imapmethodparametersgeneral-1/setconnection/)(IConnection) |  |
| [SetFolder](../../aspose.email.clients.imap.models/imapmovemessages/setfolder/)(string) | Folder name where a message is to be moved. |
