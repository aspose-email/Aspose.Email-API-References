...
description: This class uses specified template to construct EMail messages.
type: docs
weight: 20620
...
| Name | Description |
| --- | --- |
| [TemplateEngine](templateengine#constructor)(MailMessage) | Initializes a new instance of the [`TemplateEngine`](../templateengine) class. |
| [TemplateEngine](templateengine#constructor_1)(string) | Initializes a new instance of the [`TemplateEngine`](../templateengine) class. |
