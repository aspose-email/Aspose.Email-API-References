...
| Name | Description |
| :- | :- |
|BackupSettings()|Initializes a new instance of the [BackupSettings](/python-net/aspose.email.clients.imap/backupsettings/) class|
...
| Name | Description |
| :- | :- |
|default|Gets [BackupSettings](/python-net/aspose.email.clients.imap/backupsettings/) class with settings by default|
