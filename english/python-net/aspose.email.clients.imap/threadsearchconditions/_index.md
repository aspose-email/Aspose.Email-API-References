...
type: docs
weight: 380
url: /email/python-net/aspose.email.clients.imap/threadsearchconditions/
---

## ThreadSearchConditions class

Provides the search conditions to retrieve email thread.<br/>            Compatibles with THREAD IMAP extension described at<br/>            https://tools.ietf.org/html/rfc5256
