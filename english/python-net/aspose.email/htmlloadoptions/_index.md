...
|path_to_resources|Path to directory with resources files.|
|should_add_plain_text_view|Specifies whether to add a text representation of the body or not.<br/>            Default value is false.|
