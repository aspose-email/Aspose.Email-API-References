...
The AmpCarousel type exposes the following members:
## Constructors
| Name | Description |
| :- | :- |
|AmpCarousel(width, height)|Initializes a new instance of the AmpCarousel class|
## Properties
| Name | Description |
| :- | :- |
...
|type|Specifies the display type for the carousel items.|
|images|Set of images for displaying.|
## Methods
| Name | Description |
| :- | :- |
|to_amp_html()|  |
