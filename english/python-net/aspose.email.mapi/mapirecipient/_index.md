...
type: docs
weight: 660
url: /email/python-net/aspose.email.mapi/mapirecipient/
---
...
|display_name|Gets or sets the display name of the message <br/>            recipient or sender.|
|address_type|Gets the type of the address of <br/>            the message recipient or sender.|
|email_address|Gets or sets the email address of the <br/>            message recipient or sender.|
