...
description: Initialisiert eine neue Instanz vonImapClientaspose.email.clients.imap/imapclient Klasse
type: docs
weight: 10
url: /de/net/aspose.email.clients.imap/imapclient/imapclient/
---
## ImapClient() {#constructor}

Initialisiert eine neue Instanz von[`ImapClient`](../../imapclient) Klasse
...
| host | String | Der Hostname |
| username | String | Der Nutzername |
| authInfo | String | Das Benutzerkennwort oder das XOAUTH2-Zugriffstoken |
| useOAuth | Boolean | Definiert, ob der SASL XOAUTH2-Mechanismus verwendet wird, um sich beim Server anzumelden |
...
| host | String | Der Hostname |
| username | String | Der Nutzername |
| tokenProvider | ITokenProvider | TokenProvider, der das Abrufen des Zugriffstokens ermöglicht. |
