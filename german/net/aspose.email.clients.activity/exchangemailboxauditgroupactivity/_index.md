...
type: docs
weight: 2530
url: /de/net/aspose.email.clients.activity/exchangemailboxauditgroupactivity/
---
...
| Name | Beschreibung |
| --- | --- |
| [AffectedItems](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/affecteditems) { get; set; } | Informationen zu jedem Element in der Gruppe. |
...
| [CrossMailboxOperations](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/crossmailboxoperations) { get; set; } | Gibt an, ob der Vorgang mehr als ein Postfach umfasste. |
| [DestFolder](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destfolder) { get; set; } | Der Zielordner für Operationen wie Move. |
| [DestMailboxId](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxid) { get; set; } | Wird nur festgelegt, wenn der CrossMailboxOperations-Parameter True ist. Gibt die GUID des Zielpostfachs an. |
| [DestMailboxOwnerMasterAccountSid](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownermasteraccountsid) { get; set; } | Wird nur festgelegt, wenn der CrossMailboxOperations-Parameter True ist. Gibt die SID für die Hauptkonto-SID des Besitzers des Zielpostfachs an. |
| [DestMailboxOwnerSid](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownersid) { get; set; } | Wird nur festgelegt, wenn der CrossMailboxOperations-Parameter True ist. Gibt die SID des Zielpostfachs an. |
| [DestMailboxOwnerUPN](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownerupn) { get; set; } | Wird nur festgelegt, wenn der CrossMailboxOperations-Parameter True ist. Gibt den UPN des Besitzers des Zielpostfachs an. |
| [Folder](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/folder) { get; set; } | Der Ordner, in dem sich eine Gruppe von Elementen befindet. |
| [Folders](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/folders) { get; set; } | Informationen über die an einer Operation beteiligten Quellordner; B. wenn Ordner ausgewählt und dann gelöscht werden. |
