...
description: Repräsentiert die benannte Eigenschaft mapping
type: docs
weight: 18520
url: /de/net/aspose.email.mapi/mapinamedpropertymappingstorage/
---
## MapiNamedPropertyMappingStorage class

Repräsentiert die benannte Eigenschaft mapping
...
| Name | Beschreibung |
| --- | --- |
| [MapiNamedPropertyMappingStorage](mapinamedpropertymappingstorage)() | Initialisiert eine neue Instanz von[`MapiNamedPropertyMappingStorage`](../mapinamedpropertymappingstorage) Klasse. |
...
| [Content](../../aspose.email.mapi/mapinamedpropertymappingstorage/content) { get; } | Ruft den Inhalt ab |
| [Name](../../aspose.email.mapi/mapinamedpropertymappingstorage/name) { get; } | erhält den Namen |
...
| Name | Beschreibung |
| --- | --- |
| [AddNamedPropertyMapping](../../aspose.email.mapi/mapinamedpropertymappingstorage/addnamedpropertymapping#addnamedpropertymapping)(MapiProperty, long, Guid) | Fügt die benannte Eigenschaftszuordnung für die numerische benannte Eigenschaft hinzu. |
| [AddNamedPropertyMapping](../../aspose.email.mapi/mapinamedpropertymappingstorage/addnamedpropertymapping#addnamedpropertymapping_1)(MapiProperty, string, Guid) | Fügt die benannte Eigenschaftszuordnung für die Zeichenfolge namens Eigenschaft hinzu. |
| [GetNextAvailablePropertyId](../../aspose.email.mapi/mapinamedpropertymappingstorage/getnextavailablepropertyid)(MapiPropertyType) | Ruft die nächste verfügbare Eigenschafts-ID im Eintragsstrom basierend auf dem Eigenschaftsdatentyp ab. |
