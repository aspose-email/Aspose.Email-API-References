...
description: Repräsentiert das Objekt Persönliche Verteilerliste.
type: docs
weight: 18360
url: /de/net/aspose.email.mapi/mapidistributionlist/
---
## MapiDistributionList class

Repräsentiert das Objekt Persönliche Verteilerliste.
...
| Name | Beschreibung |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Initialisiert eine neue Instanz von[`MapiDistributionList`](../mapidistributionlist) Klasse. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Initialisiert eine neue Instanz von[`MapiDistributionList`](../mapidistributionlist) Klasse. |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | Ruft den für den Benutzer sichtbaren Namen der persönlichen Verteilerliste ab oder legt ihn fest. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | Die Artikel-ID, verwendet mit einem Server |
| [Members](../../aspose.email.mapi/mapidistributionlist/members) { get; } | Ruft die Liste der Mitglieder der persönlichen Verteilerliste ab. |
...
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save)(Stream) | Speichert den angegebenen Stream. |
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save_1)(string) | Speichert den angegebenen Dateinamen. |
