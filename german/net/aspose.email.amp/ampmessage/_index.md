...
description: Nachricht die es Absendern ermöglicht AMP-Komponenten in E-Mails einzufügen.
type: docs
weight: 140
url: /de/net/aspose.email.amp/ampmessage/
---
## AmpMessage class

Nachricht, die es Absendern ermöglicht, AMP-Komponenten in E-Mails einzufügen.
...
| Name | Beschreibung |
| --- | --- |
| [AmpMessage](ampmessage)() | Initialisiert eine neue Instanz von[`MailMessage`](../../aspose.email/mailmessage) Klasse |
...
| virtual [AmpHtmlBody](../../aspose.email.amp/ampmessage/amphtmlbody) { get; set; } | Ruft die AmpHtml-Darstellung des Nachrichtentexts ab. |
...
| [AddAmpComponent](../../aspose.email.amp/ampmessage/addampcomponent)(AmpComponent) | Amp-Komponente zu dieser Nachricht hinzufügen. |
| virtual [AddAttachment](../../aspose.email/mailmessage/addattachment)(Attachment) | Anhang zu Nachricht hinzufügen |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner) | Erstellt eine signierte Nachricht. Erstellt eine schreibgeschützte Kopie der angegebenen MailMessage und fügt ihr eine digitale Signatur hinzu. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2) | Erstellt eine signierte Nachricht. Erstellt eine schreibgeschützte Kopie der angegebenen MailMessage und fügt ihr eine digitale Signatur hinzu. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner, bool) | Erstellt eine signierte Nachricht. Erstellt eine schreibgeschützte Kopie der angegebenen MailMessage und fügt ihr eine digitale Signatur hinzu. |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2, bool) | Erstellt eine signierte Nachricht. Erstellt eine schreibgeschützte Kopie der angegebenen MailMessage und fügt ihr eine digitale Signatur hinzu. |
...
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt)() | entschlüsselt diese Nachricht |
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt)(X509Certificate2) | entschlüsselt diese Nachricht |
...
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt)(X509Certificate2) | verschlüsselt diese Nachricht |
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt)(X509Certificate2[]) | verschlüsselt diese Nachricht |
...
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext)(bool) | Ruft den HTML-Text der Nachricht als einfachen Text ab. Diese Methode analysiert die HtmlBody-Eigenschaft und gibt Nur-Text-Inhalt zurück, wobei das HTML-Markup ignoriert wird. |
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext)(HyperlinkRenderingCallback) | Ruft den HTML-Text der Nachricht als einfachen Text ab. |
...
| virtual [Save](../../aspose.email/mailmessage/save)(Stream) | Nachricht als Stream speichern |
| virtual [Save](../../aspose.email/mailmessage/save)(string) | Nachricht als Datei speichern |
| override [Save](../../aspose.email.amp/ampmessage/save#save_1)(Stream, SaveOptions) | Nachricht als Stream speichern |
| virtual [Save](../../aspose.email/mailmessage/save)(string, SaveOptions) | Nachricht als Datei mit zusätzlichen Optionen speichern. |
