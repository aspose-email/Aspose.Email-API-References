...
description: MessageInfo Graph hizmetinden alınan sunucu öğesi bilgilerini temsil eder.
type: docs
weight: 15990
url: /tr/net/aspose.email.clients.graph/messageinfo/
---
## MessageInfo class

MessageInfo, Graph hizmetinden alınan sunucu öğesi bilgilerini temsil eder.
...
| virtual [ItemId](../../aspose.email.clients.graph/messageinfo/itemid) { get; } | İleti URI'sini alır. |
