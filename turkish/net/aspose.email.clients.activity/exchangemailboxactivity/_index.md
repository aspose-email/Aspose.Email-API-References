...
description: Ortak şemayı tüm Exchange posta kutusu denetim verilerine özgü özelliklerle genişletir.
type: docs
weight: 2510
url: /tr/net/aspose.email.clients.activity/exchangemailboxactivity/
---
## ExchangeMailboxActivity class

Ortak şemayı, tüm Exchange posta kutusu denetim verilerine özgü özelliklerle genişletir.
...
| İsim | Tanım |
| --- | --- |
| [ClientInfoString](../../aspose.email.clients.activity/exchangemailboxactivity/clientinfostring) { get; set; } | Tarayıcı sürümü, Outlook sürümü ve mobil cihaz bilgileri gibi işlemi gerçekleştirmek için kullanılan e-posta istemcisiyle ilgili bilgiler. |
...
| [ClientIPAddress](../../aspose.email.clients.activity/exchangemailboxactivity/clientipaddress) { get; set; } | İşlem günlüğe kaydedilirken kullanılan aygıtın IP adresi. IP adresi, bir IPv4 veya IPv6 adres biçiminde görüntülenir. |
| [ClientMachineName](../../aspose.email.clients.activity/exchangemailboxactivity/clientmachinename) { get; set; } | Outlook istemcisini barındıran makine adı. |
| [ClientProcessName](../../aspose.email.clients.activity/exchangemailboxactivity/clientprocessname) { get; set; } | Posta kutusuna erişmek için kullanılan e-posta istemcisi. |
| [ClientVersion](../../aspose.email.clients.activity/exchangemailboxactivity/clientversion) { get; set; } | E-posta istemcisinin sürümü. |
...
| [ExternalAccess](../../aspose.email.clients.activity/exchangemailboxactivity/externalaccess) { get; set; } | Oturum açan kullanıcının etki alanı posta kutusu sahibinin etki alanından farklıysa bu doğrudur. |
| [Id](../../aspose.email.clients.activity/content/id) { get; set; } | Bir denetim kaydının benzersiz tanımlayıcısı. Zorunlu: Yes |
| [InternalLogonType](../../aspose.email.clients.activity/exchangemailboxactivity/internallogontype) { get; set; } | Dahili kullanım için ayrılmıştır. |
| [LogonType](../../aspose.email.clients.activity/exchangemailboxactivity/logontype) { get; set; } | Posta kutusuna erişen ve günlüğe kaydedilen işlemi gerçekleştiren kullanıcının türünü belirtir. |
| [LogonUserDisplayName](../../aspose.email.clients.activity/exchangemailboxactivity/logonuserdisplayname) { get; set; } | İşlemi gerçekleştiren kullanıcının kullanıcı dostu adı. |
| [LogonUserSid](../../aspose.email.clients.activity/exchangemailboxactivity/logonusersid) { get; set; } | İşlemi gerçekleştiren kullanıcının SID'si. |
| [MailboxGuid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxguid) { get; set; } | Erişilen posta kutusunun Exchange GUID'si. |
| [MailboxOwnerMasterAccountSid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownermasteraccountsid) { get; set; } | Posta kutusu sahibi hesabının ana hesabının SID'si. |
| [MailboxOwnerSid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownersid) { get; set; } | Posta kutusu sahibinin SID'si. |
| [MailboxOwnerUPN](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownerupn) { get; set; } | Erişilen posta kutusunun sahibi olan kişinin e-posta adresi. |
...
| [OrganizationName](../../aspose.email.clients.activity/exchangemailboxactivity/organizationname) { get; set; } | Kiracının adı. |
| [OriginatingServer](../../aspose.email.clients.activity/exchangemailboxactivity/originatingserver) { get; set; } | Bu, işlemin başladığı yerdir. |
