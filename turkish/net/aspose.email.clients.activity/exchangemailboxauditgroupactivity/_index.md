...
type: docs
weight: 2530
url: /tr/net/aspose.email.clients.activity/exchangemailboxauditgroupactivity/
---
...
| İsim | Tanım |
| --- | --- |
| [AffectedItems](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/affecteditems) { get; set; } | Gruptaki her öğe hakkında bilgi. |
...
| [CrossMailboxOperations](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/crossmailboxoperations) { get; set; } | İşlemin birden fazla posta kutusu içerdiğini gösterir. |
| [DestFolder](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destfolder) { get; set; } | Move. gibi işlemler için hedef klasör |
| [DestMailboxId](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxid) { get; set; } | Yalnızca CrossMailboxOperations parametresi True ise ayarlayın. GUID. hedef posta kutusunu belirtir |
| [DestMailboxOwnerMasterAccountSid](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownermasteraccountsid) { get; set; } | Yalnızca CrossMailboxOperations parametresi True ise ayarlayın. Hedef posta kutusu sahibinin ana hesap SID'si için SID'yi belirtir. |
| [DestMailboxOwnerSid](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownersid) { get; set; } | Yalnızca CrossMailboxOperations parametresi True ise ayarlayın. Hedef posta kutusunun SID'sini belirtir. |
| [DestMailboxOwnerUPN](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/destmailboxownerupn) { get; set; } | Yalnızca CrossMailboxOperations parametresi True ise ayarlayın. Hedef posta kutusunun sahibinin UPN'sini belirtir. |
| [Folder](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/folder) { get; set; } | Bir grup öğenin bulunduğu klasör. |
| [Folders](../../aspose.email.clients.activity/exchangemailboxauditgroupactivity/folders) { get; set; } | Bir işlemde yer alan kaynak klasörler hakkında bilgi; örneğin, klasörler seçiliyse ve ardından silinirse. |
