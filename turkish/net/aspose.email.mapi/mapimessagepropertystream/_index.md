...
type: docs
weight: 18490
url: /tr/net/aspose.email.mapi/mapimessagepropertystream/
---
...
| İsim | Tanım |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream)(MapiMessageItemBase) | Yeni bir örneğini başlatır[`MapiMessagePropertyStream`](../mapimessagepropertystream) sınıf. |
