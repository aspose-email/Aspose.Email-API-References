...
description: Adlandırılmış özellik eşlemesini temsil eder
type: docs
weight: 18520
url: /tr/net/aspose.email.mapi/mapinamedpropertymappingstorage/
---
## MapiNamedPropertyMappingStorage class

Adlandırılmış özellik eşlemesini temsil eder
...
| İsim | Tanım |
| --- | --- |
| [MapiNamedPropertyMappingStorage](mapinamedpropertymappingstorage)() | Yeni bir örneğini başlatır[`MapiNamedPropertyMappingStorage`](../mapinamedpropertymappingstorage) sınıf. |
...
| [Content](../../aspose.email.mapi/mapinamedpropertymappingstorage/content) { get; } | İçeriği alır |
| [Name](../../aspose.email.mapi/mapinamedpropertymappingstorage/name) { get; } | adını alır |
...
| İsim | Tanım |
| --- | --- |
| [AddNamedPropertyMapping](../../aspose.email.mapi/mapinamedpropertymappingstorage/addnamedpropertymapping#addnamedpropertymapping)(MapiProperty, long, Guid) | Sayısal olarak adlandırılan özellik için adlandırılmış özellik eşlemesini ekler. |
| [AddNamedPropertyMapping](../../aspose.email.mapi/mapinamedpropertymappingstorage/addnamedpropertymapping#addnamedpropertymapping_1)(MapiProperty, string, Guid) | property adlı dize için adlandırılmış özellik eşlemesini ekler. |
| [GetNextAvailablePropertyId](../../aspose.email.mapi/mapinamedpropertymappingstorage/getnextavailablepropertyid)(MapiPropertyType) | Özellik veri türüne dayalı olarak giriş akışındaki bir sonraki kullanılabilir özellik kimliğini alır. |
