...
description: Tüm MapiMessageItem sınıfları için temel sınıfı temsil eder ve ortak mapi özellikleri ekleri alıcılar koleksiyonlarını tutar.
type: docs
weight: 18470
url: /tr/net/aspose.email.mapi/mapimessageitembase/
---
## MapiMessageItemBase class

Tüm MapiMessageItem sınıfları için temel sınıfı temsil eder ve ortak mapi özellikleri, ekleri, alıcılar koleksiyonlarını tutar.
...
| [BodyHtml](../../aspose.email.mapi/mapimessageitembase/bodyhtml) { get; } | [`BodyRtf`](./bodyrtf) varsa, HTML'ye dönüştürülen iletinin, aksi takdirde boş bir dize. |
...
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent)(string, BodyContentType) | Gövdenin içeriğini ayarlar. |
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent_1)(string, BodyContentType, bool) | Gövdenin içeriğini ayarlar. |
...
| override [SetProperty](../../aspose.email.mapi/mapimessageitembase/setproperty#setproperty_1)(PropertyDescriptor, object) | MAPI özelliğini ayarlar. |
