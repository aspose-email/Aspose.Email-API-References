...
type: docs
weight: 1960
url: /tr/net/aspose.email.clients.activesync.transportlayer/searchquery/
---
## SearchQuery class
...
| İsim | Tanım |
| --- | --- |
| [And](../../aspose.email.clients.activesync.transportlayer/searchquery/and) { get; set; } | Aranan mağazadaki girişleri eşleştirmek için kullanılacak anahtar sözcükleri belirtir. |
| [EqualTo](../../aspose.email.clients.activesync.transportlayer/searchquery/equalto) { get; set; } | Bir arama sırasında "Eşit" koşulu için karşılaştırılan bir özelliği ve değeri belirtir. |
