...
description: Si verifica quando si verifica il tipo di evento specificato per la cartella Contatti.
type: docs
weight: 240
url: /it/net/aspose.email.clients.exchange.webservice/iewsclient/contactsfolderservernotifications/
---
## IEWSClient.ContactsFolderServerNotifications event

Si verifica quando si verifica il tipo di evento specificato per la cartella Contatti.
