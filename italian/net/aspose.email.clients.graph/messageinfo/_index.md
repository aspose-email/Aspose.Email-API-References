...
description: Il MessageInfo rappresenta le informazioni sullelemento del server recuperate dal servizio Graph.
type: docs
weight: 15990
url: /it/net/aspose.email.clients.graph/messageinfo/
---
## MessageInfo class

Il MessageInfo rappresenta le informazioni sull'elemento del server recuperate dal servizio Graph.
...
| virtual [ItemId](../../aspose.email.clients.graph/messageinfo/itemid) { get; } | Ottiene l'URI del messaggio. |
