...
type: docs
weight: 20
url: /it/net/aspose.email/license/setlicense/
---
...
* spazio dei nomi [Aspose.Email](../../license)
...
| Parametro | Tipo | Descrizione |
| --- | --- | --- |
| licenseFile | FileInfo | Fascicolo di licenzaFileInfo. |

### Eccezioni

| eccezione | condizione |
| --- | --- |
| ArgumentNullException | *licenseFile* è zero. |
| FileNotFoundException | Il file non è stato trovato. |
| UnauthorizedAccessException | Il file è di sola lettura o è una directory. |
