...
description: Rappresenta loggetto diario di Outlook.
type: docs
weight: 18420
url: /it/net/aspose.email.mapi/mapijournal/
---
## MapiJournal class

Rappresenta l'oggetto diario di Outlook.
...
| Nome | Descrizione |
| --- | --- |
| [MapiJournal](mapijournal#constructor)() | Inizializza una nuova istanza di[`MapiJournal`](../mapijournal) classe. |
| [MapiJournal](mapijournal#constructor_1)(string, string, string, string) | Inizializza una nuova istanza di[`MapiJournal`](../mapijournal) classe. |
...
| [BriefDescription](../../aspose.email.mapi/mapijournal/briefdescription) { get; set; } | Ottiene o imposta la breve descrizione dell'attività che viene registrata. |
...
| [Description](../../aspose.email.mapi/mapijournal/description) { get; set; } | Ottiene o imposta la descrizione dell'attività che viene registrata. |
| [DocumentStatus](../../aspose.email.mapi/mapijournal/documentstatus) { get; set; } | Ottiene o imposta lo stato del documento. |
| [Duration](../../aspose.email.mapi/mapijournal/duration) { get; } | Ottiene la durata dell'attività. |
| [EndTime](../../aspose.email.mapi/mapijournal/endtime) { get; set; } | Ottiene o imposta l'ora in cui l'attività è terminata. |
| [Flags](../../aspose.email.mapi/mapijournal/flags) { get; set; } | Ottiene o imposta un flag che contiene metadati sull'oggetto Journal. |
...
| [StartTime](../../aspose.email.mapi/mapijournal/starttime) { get; set; } | Ottiene o imposta l'ora di inizio dell'attività. |
...
| [Save](../../aspose.email.mapi/mapijournal/save#save)(Stream) | Salva il flusso specificato. |
| [Save](../../aspose.email.mapi/mapijournal/save#save_1)(string) | Salva il nome file specificato. |
