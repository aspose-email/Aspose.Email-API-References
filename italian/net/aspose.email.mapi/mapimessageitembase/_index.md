...
description: Rappresenta la classe base per tutte le classi MapiMessageItem e mantiene raccolte comuni di proprietà mapi allegati destinatari.
type: docs
weight: 18470
url: /it/net/aspose.email.mapi/mapimessageitembase/
---
## MapiMessageItemBase class

Rappresenta la classe base per tutte le classi MapiMessageItem e mantiene raccolte comuni di proprietà mapi, allegati, destinatari.
...
| [BodyHtml](../../aspose.email.mapi/mapimessageitembase/bodyhtml) { get; } | Ottiene il[`BodyRtf`](./bodyrtf) del messaggio convertito in HTML, se presente, altrimenti una stringa vuota. |
...
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent)(string, BodyContentType) | Imposta il contenuto del corpo. |
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent_1)(string, BodyContentType, bool) | Imposta il contenuto del corpo. |
...
| override [SetProperty](../../aspose.email.mapi/mapimessageitembase/setproperty#setproperty_1)(PropertyDescriptor, object) | Imposta la proprietà MAPI. |
