...
description: Rappresenta il flusso di proprietà.
type: docs
weight: 18490
url: /it/net/aspose.email.mapi/mapimessagepropertystream/
---
## MapiMessagePropertyStream class

Rappresenta il flusso di proprietà.
...
| Nome | Descrizione |
| --- | --- |
| [MapiMessagePropertyStream](mapimessagepropertystream)(MapiMessageItemBase) | Inizializza una nuova istanza di[`MapiMessagePropertyStream`](../mapimessagepropertystream) classe. |
