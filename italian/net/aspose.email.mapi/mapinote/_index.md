...
description: Rappresenta loggetto della nota di Outlook note adesive
type: docs
weight: 18530
url: /it/net/aspose.email.mapi/mapinote/
---
## MapiNote class

Rappresenta l'oggetto della nota di Outlook ("note adesive")
...
| Nome | Descrizione |
| --- | --- |
| [MapiNote](mapinote#constructor)() | Inizializza una nuova istanza di[`MapiNote`](../mapinote) classe. |
| [MapiNote](mapinote#constructor_1)(string, string) | Inizializza una nuova istanza di[`MapiNote`](../mapinote) classe. |
...
| [Color](../../aspose.email.mapi/mapinote/color) { get; set; } | Ottiene o imposta il colore di sfondo suggerito dell'oggetto Nota |
| [Companies](../../aspose.email.mapi/mapimessageitembase/companies) { get; set; } | Contiene i nomi delle aziende associate a un articolo. |
| [CreationDate](../../aspose.email.mapi/mapinote/creationdate) { get; set; } | Ottiene o imposta la data di creazione di note |
| [Height](../../aspose.email.mapi/mapinote/height) { get; set; } | Ottiene o imposta l'altezza della finestra del messaggio visibile in pixel |
...
| [Width](../../aspose.email.mapi/mapinote/width) { get; set; } | Ottiene o imposta la larghezza della finestra del messaggio visibile in pixel |
| [XPosition](../../aspose.email.mapi/mapinote/xposition) { get; set; } | Ottiene o imposta la distanza, in pixel, dal bordo sinistro dello schermo a cui un'interfaccia utente visualizza un oggetto Nota |
| [YPosition](../../aspose.email.mapi/mapinote/yposition) { get; set; } | Ottiene o imposta la distanza, in pixel, dal bordo superiore dello schermo a cui un'interfaccia utente visualizza un oggetto Nota |
...
| [Save](../../aspose.email.mapi/mapinote/save#save)(Stream, NoteSaveFormat) | Salva questo[`MapiNote`](../mapinote) al flusso specificato utilizzando il formato specificato. |
| [Save](../../aspose.email.mapi/mapinote/save#save_1)(string, NoteSaveFormat) | Salva questo[`MapiNote`](../mapinote) nel file utilizzando il formato specificato. |
