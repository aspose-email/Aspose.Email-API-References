...
description: يمثل MessageInfo معلومات رسالة البريد الإلكتروني التي تم جلبها من خادم البريد.
type: docs
weight: 16760
url: /ar/net/aspose.email.clients/messageinfobase/
---
## MessageInfoBase class

يمثل MessageInfo معلومات رسالة البريد الإلكتروني التي تم جلبها من خادم البريد.
...
| اسم | وصف |
| --- | --- |
| [MessageInfoBase](messageinfobase)() | يقوم بتهيئة مثيل جديد لملف[`MessageInfoBase`](../messageinfobase) فئة . |
