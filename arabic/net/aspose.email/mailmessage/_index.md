...
description: يمثل رسالة بريد إلكتروني. يسمح بالوصول إلى خصائص الرسالة  على سبيل المثال . إضافات الموضوع والجسم والمرسل والمستلمين  وما إلى ذلك. كما يمكن إرسالها وتسليمها عن طريق بروتوكولات البريد المدعومة.
type: docs
weight: 17710
url: /ar/net/aspose.email/mailmessage/
---
## MailMessage class

يمثل رسالة بريد إلكتروني. يسمح بالوصول إلى خصائص الرسالة ، على سبيل المثال . إضافات الموضوع والجسم والمرسل والمستلمين ، وما إلى ذلك. كما يمكن إرسالها وتسليمها عن طريق بروتوكولات البريد المدعومة.
...
| اسم | وصف |
| --- | --- |
| [MailMessage](mailmessage#constructor)() | يقوم بتهيئة مثيل جديد لملف[`MailMessage`](../mailmessage) فئة |
| [MailMessage](mailmessage#constructor_2)(bool) | يقوم بتهيئة مثيل جديد لملف[`MailMessage`](../mailmessage) فئة |
| [MailMessage](mailmessage#constructor_1)(MailAddress, MailAddress) | يقوم بتهيئة مثيل جديد لملف[`MailMessage`](../mailmessage) فئة |
| [MailMessage](mailmessage#constructor_3)(string, string) | يقوم بتهيئة مثيل جديد لملف[`MailMessage`](../mailmessage) فئة |
| [MailMessage](mailmessage#constructor_4)(string, string, string, string) | يقوم بتهيئة مثيل جديد لملف[`MailMessage`](../mailmessage) فئة |
...
| اسم | وصف |
| --- | --- |
| static [Load](../../aspose.email/mailmessage/load#load)(Stream) | تحميل الرسالة من stream |
| static [Load](../../aspose.email/mailmessage/load#load_2)(string) | تحميل الرسالة من file |
| static [Load](../../aspose.email/mailmessage/load#load_1)(Stream, LoadOptions) | تحميل الرسالة من الدفق بخيارات إضافية . |
| static [Load](../../aspose.email/mailmessage/load#load_3)(string, LoadOptions) | تحميل رسالة من ملف بخيارات إضافية . |
...
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature#attachsignature)(CmsSigner) | إنشاء رسالة موقعة. إنشاء نسخة للقراءة فقط من MailMessage المحدد وإضافة توقيع رقمي إليها . |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature#attachsignature_2)(X509Certificate2) | إنشاء رسالة موقعة. إنشاء نسخة للقراءة فقط من MailMessage المحدد وإضافة توقيع رقمي إليها . |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature#attachsignature_1)(CmsSigner, bool) | إنشاء رسالة موقعة. إنشاء نسخة للقراءة فقط من MailMessage المحدد وإضافة توقيع رقمي إليها . |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature#attachsignature_3)(X509Certificate2, bool) | إنشاء رسالة موقعة. إنشاء نسخة للقراءة فقط من MailMessage المحدد وإضافة توقيع رقمي إليها . |
...
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt#decrypt)() | يفك تشفير هذه الرسالة |
| virtual [Decrypt](../../aspose.email/mailmessage/decrypt#decrypt_1)(X509Certificate2) | يفك تشفير هذه الرسالة |
...
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt#encrypt)(X509Certificate2) | تشفير هذه الرسالة |
| virtual [Encrypt](../../aspose.email/mailmessage/encrypt#encrypt_1)(X509Certificate2[]) | تشفير هذه الرسالة |
...
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext#gethtmlbodytext_1)(bool) | يحصل على نص html للرسالة كنص عادي. تقوم هذه الطريقة بتوزيع خاصية HtmlBody وإرجاع محتوى نص عادي متجاهلًا علامة html. |
| virtual [GetHtmlBodyText](../../aspose.email/mailmessage/gethtmlbodytext#gethtmlbodytext)(HyperlinkRenderingCallback) | يحصل على الرسالة htmlbody كنص عادي. |
...
| virtual [Save](../../aspose.email/mailmessage/save#save)(Stream) | حفظ الرسالة كتدفق |
| virtual [Save](../../aspose.email/mailmessage/save#save_2)(string) | حفظ الرسالة كملف |
| virtual [Save](../../aspose.email/mailmessage/save#save_1)(Stream, SaveOptions) | حفظ الرسالة كتدفق مع خيارات إضافية . |
| virtual [Save](../../aspose.email/mailmessage/save#save_3)(string, SaveOptions) | حفظ الرسالة كملف مع خيارات إضافية . |
...
| static [CheckSignature](../../aspose.email/mailmessage/checksignature#checksignature)(Stream) | للتحقق من توقيع رسالة eml المحددة. |
| static [CheckSignature](../../aspose.email/mailmessage/checksignature#checksignature_1)(string) | يتحقق من توقيع ملف eml المحدد. |
| static [ValidateMessage](../../aspose.email/mailmessage/validatemessage#validatemessage)(Stream) | تحقق من صحة رسالة eml للتوافق مع مواصفات mime . |
| static [ValidateMessage](../../aspose.email/mailmessage/validatemessage#validatemessage_1)(string) | تحقق من صحة رسالة eml للتوافق مع مواصفات mime . |
