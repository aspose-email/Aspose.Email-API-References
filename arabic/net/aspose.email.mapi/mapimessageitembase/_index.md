...
description: يمثل الفئة الأساسية لجميع فئات MapiMessageItem ويحتفظ بالمجموعات المشتركة لخصائص mapi والمرفقات والمستلمين.
type: docs
weight: 18470
url: /ar/net/aspose.email.mapi/mapimessageitembase/
---
## MapiMessageItemBase class

يمثل الفئة الأساسية لجميع فئات MapiMessageItem ويحتفظ بالمجموعات المشتركة لخصائص mapi والمرفقات والمستلمين.
...
| [BodyHtml](../../aspose.email.mapi/mapimessageitembase/bodyhtml) { get; } | يحصل على ملف[`BodyRtf`](./bodyrtf) من الرسالة محولة إلى HTML ، إن وجدت ، وإلا فسيتم تحويلها إلى سلسلة فارغة. |
...
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent)(string, BodyContentType) | يحدد محتوى الجسم. |
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent_1)(string, BodyContentType, bool) | يحدد محتوى الجسم. |
...
| override [SetProperty](../../aspose.email.mapi/mapimessageitembase/setproperty#setproperty_1)(PropertyDescriptor, object) | تعيين خاصية MAPI . |
