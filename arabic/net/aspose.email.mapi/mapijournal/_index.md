...
description: يمثل كائن دفتر يومية Outlook .
type: docs
weight: 18420
url: /ar/net/aspose.email.mapi/mapijournal/
---
## MapiJournal class

يمثل كائن دفتر يومية Outlook .
...
| اسم | وصف |
| --- | --- |
| [MapiJournal](mapijournal#constructor)() | يقوم بتهيئة مثيل جديد لملف[`MapiJournal`](../mapijournal) فئة . |
| [MapiJournal](mapijournal#constructor_1)(string, string, string, string) | يقوم بتهيئة مثيل جديد لملف[`MapiJournal`](../mapijournal) فئة . |
...
| [BriefDescription](../../aspose.email.mapi/mapijournal/briefdescription) { get; set; } | الحصول على أو تعيين الوصف المختصر للنشاط الجاري تسجيله. |
...
| [Description](../../aspose.email.mapi/mapijournal/description) { get; set; } | الحصول على أو تعيين وصف للنشاط الجاري تسجيله. |
| [DocumentStatus](../../aspose.email.mapi/mapijournal/documentstatus) { get; set; } | الحصول على أو تحديد حالة المستند. |
| [Duration](../../aspose.email.mapi/mapijournal/duration) { get; } | تحصل على مدة النشاط. |
| [EndTime](../../aspose.email.mapi/mapijournal/endtime) { get; set; } | الحصول على أو تحديد الوقت الذي انتهى فيه النشاط. |
| [Flags](../../aspose.email.mapi/mapijournal/flags) { get; set; } | الحصول على أو تعيين العلامات التي تحتوي على بيانات وصفية حول كائن دفتر اليومية. |
...
| [StartTime](../../aspose.email.mapi/mapijournal/starttime) { get; set; } | الحصول على أو تحديد الوقت الذي بدأ فيه النشاط. |
...
| [Save](../../aspose.email.mapi/mapijournal/save#save)(Stream) | يحفظ الدفق المحدد. |
| [Save](../../aspose.email.mapi/mapijournal/save#save_1)(string) | يحفظ اسم الملف المحدد. |
