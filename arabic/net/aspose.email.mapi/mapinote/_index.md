...
description: يمثل كائن ملاحظة outlook sticky note
type: docs
weight: 18530
url: /ar/net/aspose.email.mapi/mapinote/
---
## MapiNote class

يمثل كائن ملاحظة outlook ("sticky note")
...
| اسم | وصف |
| --- | --- |
| [MapiNote](mapinote#constructor)() | يقوم بتهيئة مثيل جديد لملف[`MapiNote`](../mapinote) فئة . |
| [MapiNote](mapinote#constructor_1)(string, string) | يقوم بتهيئة مثيل جديد لملف[`MapiNote`](../mapinote) فئة . |
...
| [Color](../../aspose.email.mapi/mapinote/color) { get; set; } | الحصول على أو تعيين لون الخلفية المقترح لعنصر الملاحظة |
| [Companies](../../aspose.email.mapi/mapimessageitembase/companies) { get; set; } | يحتوي على أسماء الشركات المرتبطة بأحد العناصر . |
| [CreationDate](../../aspose.email.mapi/mapinote/creationdate) { get; set; } | الحصول على أو تحديد تاريخ إنشاء note |
| [Height](../../aspose.email.mapi/mapinote/height) { get; set; } | الحصول على أو تحديد ارتفاع نافذة الرسالة المرئية بالبكسل |
...
| [Width](../../aspose.email.mapi/mapinote/width) { get; set; } | الحصول على أو تحديد عرض نافذة الرسالة المرئية بالبكسل |
| [XPosition](../../aspose.email.mapi/mapinote/xposition) { get; set; } | الحصول على أو تحديد المسافة ، بالبكسل ، من الحافة اليسرى للشاشة التي تعرض واجهة المستخدم كائن ملاحظة |
| [YPosition](../../aspose.email.mapi/mapinote/yposition) { get; set; } | الحصول على أو تحديد المسافة ، بالبكسل ، من الحافة العلوية للشاشة التي تعرض واجهة المستخدم كائن ملاحظة |
...
| [Save](../../aspose.email.mapi/mapinote/save#save)(Stream, NoteSaveFormat) | يحفظ هذا[`MapiNote`](../mapinote) إلى التدفق المحدد باستخدام التنسيق المحدد. |
| [Save](../../aspose.email.mapi/mapinote/save#save_1)(string, NoteSaveFormat) | يحفظ هذا[`MapiNote`](../mapinote) في ملف باستخدام التنسيق المحدد. |
