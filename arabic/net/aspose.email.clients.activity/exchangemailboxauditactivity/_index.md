...
type: docs
weight: 2520
url: /ar/net/aspose.email.clients.activity/exchangemailboxauditactivity/
---
...
| [Item](../../aspose.email.clients.activity/exchangemailboxauditactivity/item) { get; set; } | يمثل العنصر الذي أجريت عليه العملية |
...
| [SendAsUserMailboxGuid](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendasusermailboxguid) { get; set; } | Exchange GUID الخاص بصندوق البريد الذي تم الوصول إليه لإرسال بريد إلكتروني كـ. |
| [SendAsUserSmtp](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendasusersmtp) { get; set; } | عنوان SMTP للمستخدم الذي يتم انتحال هويته. |
| [SendonBehalfOfUserMailboxGuid](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendonbehalfofusermailboxguid) { get; set; } | Exchange GUID الخاص بصندوق البريد الذي تم الوصول إليه لإرسال بريد نيابة عن. |
| [SendOnBehalfOfUserSmtp](../../aspose.email.clients.activity/exchangemailboxauditactivity/sendonbehalfofusersmtp) { get; set; } | عنوان SMTP للمستخدم الذي يتم إرسال البريد الإلكتروني نيابة عنه. |
