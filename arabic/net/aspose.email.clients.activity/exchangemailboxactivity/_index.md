...
description: لتوسيع المخطط الشائع بالخصائص الخاصة بكافة بيانات تدقيق علبة بريد Exchange.
type: docs
weight: 2510
url: /ar/net/aspose.email.clients.activity/exchangemailboxactivity/
---
## ExchangeMailboxActivity class

لتوسيع المخطط الشائع بالخصائص الخاصة بكافة بيانات تدقيق علبة بريد Exchange.
...
| اسم | وصف |
| --- | --- |
| [ClientInfoString](../../aspose.email.clients.activity/exchangemailboxactivity/clientinfostring) { get; set; } | معلومات حول عميل البريد الإلكتروني الذي تم استخدامه لإجراء العملية ، مثل إصدار المستعرض وإصدار Outlook ومعلومات الجهاز المحمول. |
...
| [ClientIPAddress](../../aspose.email.clients.activity/exchangemailboxactivity/clientipaddress) { get; set; } | عنوان IP للجهاز الذي تم استخدامه عند تسجيل العملية. يتم عرض عنوان IP بتنسيق عنوان IPv4 أو IPv6. |
| [ClientMachineName](../../aspose.email.clients.activity/exchangemailboxactivity/clientmachinename) { get; set; } | اسم الجهاز الذي يستضيف عميل Outlook . |
| [ClientProcessName](../../aspose.email.clients.activity/exchangemailboxactivity/clientprocessname) { get; set; } | عميل البريد الإلكتروني الذي تم استخدامه للوصول إلى صندوق البريد. |
| [ClientVersion](../../aspose.email.clients.activity/exchangemailboxactivity/clientversion) { get; set; } | إصدار عميل البريد الإلكتروني. |
...
| [ExternalAccess](../../aspose.email.clients.activity/exchangemailboxactivity/externalaccess) { get; set; } | يكون هذا صحيحًا إذا كان مجال مستخدم تسجيل الدخول مختلفًا عن مجال مالك صندوق البريد. |
| [Id](../../aspose.email.clients.activity/content/id) { get; set; } | معرّف فريد لسجل التدقيق . إلزامي: نعم |
| [InternalLogonType](../../aspose.email.clients.activity/exchangemailboxactivity/internallogontype) { get; set; } | محجوزة للاستخدام الداخلي . |
| [LogonType](../../aspose.email.clients.activity/exchangemailboxactivity/logontype) { get; set; } | يشير إلى نوع المستخدم الذي قام بالوصول إلى صندوق البريد وأجرى العملية التي تم تسجيلها. |
| [LogonUserDisplayName](../../aspose.email.clients.activity/exchangemailboxactivity/logonuserdisplayname) { get; set; } | الاسم سهل الاستخدام للمستخدم الذي أجرى العملية. |
| [LogonUserSid](../../aspose.email.clients.activity/exchangemailboxactivity/logonusersid) { get; set; } | معرّف الأمان (SID) للمستخدم الذي أجرى العملية. |
| [MailboxGuid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxguid) { get; set; } | Exchange GUID الخاص بصندوق البريد الذي تم الوصول إليه. |
| [MailboxOwnerMasterAccountSid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownermasteraccountsid) { get; set; } | الحساب الرئيسي لحساب مالك صندوق البريد SID. |
| [MailboxOwnerSid](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownersid) { get; set; } | معرّف الأمان (SID) الخاص بمالك علبة البريد. |
| [MailboxOwnerUPN](../../aspose.email.clients.activity/exchangemailboxactivity/mailboxownerupn) { get; set; } | عنوان البريد الإلكتروني للشخص الذي يملك صندوق البريد الذي تم الوصول إليه. |
...
| [OrganizationName](../../aspose.email.clients.activity/exchangemailboxactivity/organizationname) { get; set; } | اسم المستأجر . |
| [OriginatingServer](../../aspose.email.clients.activity/exchangemailboxactivity/originatingserver) { get; set; } | هذا هو المكان الذي بدأت منه العملية. |
