...
description: يمثل ارتباطًا بخدمة Exchange Autodiscover Service.
type: docs
weight: 3090
url: /ar/net/aspose.email.clients.exchange/autodiscoverservice/
---
## AutodiscoverService class

يمثل ارتباطًا بخدمة Exchange Autodiscover Service.
...
| اسم | وصف |
| --- | --- |
| [AutodiscoverService](autodiscoverservice#constructor)() | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
| [AutodiscoverService](autodiscoverservice#constructor_1)(ExchangeVersion) | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
| [AutodiscoverService](autodiscoverservice#constructor_2)(string) | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
| [AutodiscoverService](autodiscoverservice#constructor_4)(Uri) | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
| [AutodiscoverService](autodiscoverservice#constructor_3)(string, ExchangeVersion) | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
| [AutodiscoverService](autodiscoverservice#constructor_5)(Uri, ExchangeVersion) | يقوم بتهيئة مثيل جديد لملف[`AutodiscoverService`](../autodiscoverservice) فئة . |
...
| [Domain](../../aspose.email.clients.exchange/autodiscoverservice/domain) { get; set; } | الحصول على أو تعيين المجال الذي ترتبط به هذه الخدمة. عند تعيين هذه الخاصية ، يتم استخدام domain name لتحديد عنوان URL لخدمة الاكتشاف التلقائي تلقائيًا. |
| [EnableScpLookup](../../aspose.email.clients.exchange/autodiscoverservice/enablescplookup) { get; set; } | الحصول على أو تعيين قيمة تشير إلى ما إذا كان يجب على AutodiscoverService إجراء بحث عن سجل SCP (ServiceConnectionPoint) عند تحديد عنوان URL لخدمة الاكتشاف التلقائي. |
...
| [IsExternal](../../aspose.email.clients.exchange/autodiscoverservice/isexternal) { get; } | يحصل على قيمة تشير إلى ما إذا كانت خدمة الاكتشاف التلقائي التي يشير إليها URL داخلية (داخل شبكة الشركة) أو خارجية (خارج شبكة الشركة) . |
...
| [RedirectionUrlValidationCallback](../../aspose.email.clients.exchange/autodiscoverservice/redirectionurlvalidationcallback) { get; set; } | الحصول على أو تعيين رد الاتصال للتحقق من عنوان URL لإعادة التوجيه. |
...
| [Url](../../aspose.email.clients.exchange/autodiscoverservice/url) { get; set; } | الحصول على أو تعيين عنوان URL الذي تلتزم به هذه الخدمة. |
...
| اسم | وصف |
| --- | --- |
| [GetUserSettings](../../aspose.email.clients.exchange/autodiscoverservice/getusersettings)(string, params UserSettingName[]) | استرداد الإعدادات المحددة لعنوان SMTP الفردي. |
| [GetUsersSettings](../../aspose.email.clients.exchange/autodiscoverservice/getuserssettings)(IEnumerable&lt;string&gt;, params UserSettingName[]) | استرداد الإعدادات المحددة لمجموعة من المستخدمين. |
