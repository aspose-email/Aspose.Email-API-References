...
description: Representerar objektet Personal Distribution List.
type: docs
weight: 18360
url: /sv/net/aspose.email.mapi/mapidistributionlist/
---
## MapiDistributionList class

Representerar objektet Personal Distribution List.
...
| namn | Beskrivning |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | Initierar en ny instans av[`MapiDistributionList`](../mapidistributionlist) class. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | Initierar en ny instans av[`MapiDistributionList`](../mapidistributionlist) class. |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | Hämtar eller ställer in det användarsynliga namnet på den personliga distributionslistan. |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | Artikel-id, används med en server |
| [Members](../../aspose.email.mapi/mapidistributionlist/members) { get; } | Hämtar listan över medlemmarna i den personliga distributionslistan. |
...
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save)(Stream) | Sparar den angivna strömmen. |
| [Save](../../aspose.email.mapi/mapidistributionlist/save#save_1)(string) | Sparar det angivna filnamnet. |
