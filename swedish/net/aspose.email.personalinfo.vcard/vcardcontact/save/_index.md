...
type: docs
weight: 150
url: /sv/net/aspose.email.personalinfo.vcard/vcardcontact/save/
---
## Save(string) {#save_3}
...
Sparar detta[`MapiContact`](../../../aspose.email.mapi/mapicontact) till fil med angivna sparaalternativ. De sparade alternativen som stöds är[`VCardSaveOptions`](../../vcardsaveoptions)
...
Sparar detta[`MapiContact`](../../../aspose.email.mapi/mapicontact) till den givna strömmen med ett format som använder standardalternativen. Det sparade formatet som stöds är vCard
...
Sparar detta[`MapiContact`](../../../aspose.email.mapi/mapicontact) till den givna strömmen med angivna sparalternativ. De sparade alternativen som stöds är[`VCardSaveOptions`](../../vcardsaveoptions)
