...
description: MessageInfo representerar serverobjektinformationen som hämtas från Graph-tjänsten.
type: docs
weight: 15990
url: /sv/net/aspose.email.clients.graph/messageinfo/
---
## MessageInfo class

MessageInfo representerar serverobjektinformationen som hämtas från Graph-tjänsten.
...
| virtual [ItemId](../../aspose.email.clients.graph/messageinfo/itemid) { get; } | Hämtar meddelandet URI. |
