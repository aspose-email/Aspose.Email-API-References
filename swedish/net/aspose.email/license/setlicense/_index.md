...
type: docs
weight: 20
url: /sv/net/aspose.email/license/setlicense/
---
...
* namnutrymme [Aspose.Email](../../license)
...
| Parameter | Typ | Beskrivning |
| --- | --- | --- |
| licenseFile | FileInfo | Fil med licensFileInfo. |

### Undantag

| undantag | skick |
| --- | --- |
| ArgumentNullException | *licenseFile* är inget. |
| FileNotFoundException | Filen hittades inte. |
| UnauthorizedAccessException | Filen är skrivskyddad eller är en katalog. |
