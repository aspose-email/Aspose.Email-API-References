...
type: docs
weight: 264
url: /zh/androidjava/com.aspose.email/mapimessagepropertystream/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MapiMessagePropertyStream(MapiMessageItemBase parent)](#MapiMessagePropertyStream-com.aspose.email.MapiMessageItemBase-) | 初始化一个新的 [MapiMessagePropertyStream](../../com.aspose.email/mapimessagepropertystream) 类实例。 |
## 方法
...
初始化一个新的 [MapiMessagePropertyStream](../../com.aspose.email/mapimessagepropertystream) 类实例。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| parent | [MapiMessageItemBase](../../com.aspose.email/mapimessageitembase) | 父对象。 |
