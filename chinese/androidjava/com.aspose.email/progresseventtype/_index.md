...
type: docs
weight: 357
url: /zh/androidjava/com.aspose.email/progresseventtype/
---
...
| [MimePartSaved](#MimePartSaved) | 表示发生的事件通知已完成对单个 MIME 部分的保存。 |
| [MimeStructureCreated](#MimeStructureCreated) | 表示发生的事件通知 MIME 结构已创建。 |
| [SavedToStream](#SavedToStream) | 表示发生的事件通知所有 MIME 部分已保存到流中。 |
## 方法
