...
description: 表示对象的键控集合。
type: docs
weight: 313
url: /zh/androidjava/com.aspose.email/messageobjectpropertiescollection/
---
...
表示用于 [MessageObjectProperty](../../com.aspose.email/messageobjectproperty) 对象的键控集合。
## 构造函数
...
| 方法 | 描述 |
| --- | --- |
| [add(MessageObjectProperty item)](#add-com.aspose.email.MessageObjectProperty-) | 添加。 |
...
| [size()](#size--) |  |
| [toString()](#toString--) |  |
| [tryGetValue(long propertyTag)](#tryGetValue-long-) | 尝试通过指定的键获取值。 |
| [wait()](#wait--) |  |
...
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| item | [MessageObjectProperty](../../com.aspose.email/messageobjectproperty) | 一个 [MessageObjectProperty](../../com.aspose.email/messageobjectproperty) 对象。 |
