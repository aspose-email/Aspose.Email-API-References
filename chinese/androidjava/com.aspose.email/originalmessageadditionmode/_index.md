...
description: 在回复邮件中包含原始消息的方式。
type: docs
weight: 340
url: /zh/androidjava/com.aspose.email/originalmessageadditionmode/
---
...
| 字段 | 描述 |
| --- | --- |
| [Attachment](#Attachment) | 原始消息作为附件包含在响应消息中。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 原始消息未包含在响应消息中。 |
| [Textpart](#Textpart) | 原始消息作为文本包含在响应消息的正文中。 |
## 方法
