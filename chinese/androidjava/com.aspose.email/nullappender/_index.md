...
description: 表示一个不执行任何操作的 appender。
type: docs
weight: 333
url: /zh/androidjava/com.aspose.email/nullappender/
---
...
表示一个不执行任何操作的 appender。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NullAppender()](#NullAppender--) | 创建 NullAppender 的新实例。 |
## 方法

| 方法 | 描述 |
| --- | --- |
| [append(LogEntry entry)](#append-com.aspose.email.LogEntry-) | 向 NullAppender 追加日志条目。 |
...
向 NullAppender 追加日志条目。

**Parameters:**
| 参数 | 类型 | 描述 |
| --- | --- | --- |
| entry | [LogEntry](../../com.aspose.email/logentry) | 需要记录的条目。 |
