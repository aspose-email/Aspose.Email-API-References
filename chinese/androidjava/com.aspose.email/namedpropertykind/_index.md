...
type: docs
weight: 328
url: /zh/androidjava/com.aspose.email/namedpropertykind/
---
...
标识 [MessageObjectProperty](../../com.aspose.email/messageobjectproperty) 类型。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [NamedPropertyKind()](#NamedPropertyKind--) | NamedPropertyKind 的构造函数。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Numerical](#Numerical) | 属性具有名称 ID。 |
| [String](#String) | 属性具有字符串名称。 |
## 方法
