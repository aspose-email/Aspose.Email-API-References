...
description: 指示当前用户相对于 Task 对象的角色。
type: docs
weight: 289
url: /zh/androidjava/com.aspose.email/mapitaskownership/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MapiTaskOwnership()](#MapiTaskOwnership--) | MapiTaskOwnership 的构造函数。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [AssigneesCopy](#AssigneesCopy) | Task 对象是任务受让人对 Task 对象的副本。 |
| [AssignersCopy](#AssignersCopy) | Task 对象是任务指派人对 Task 对象的副本。 |
