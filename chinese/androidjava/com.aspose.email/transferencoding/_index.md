...
type: docs
weight: 407
url: /zh/androidjava/com.aspose.email/transferencoding/
---
...
| 字段 | 描述 |
| --- | --- |
| [Base64](#Base64) | Base64 编码，用于编码基于流的数据。 |
| [BinHex](#BinHex) | 二进制到十六进制的编码。 |
| [Binary](#Binary) | 二进制编码。 |
| [EightBit](#EightBit) | 数据采用 8 位字符。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [QuotedPrintable](#QuotedPrintable) | Quoted-printable 是一种使用可打印 ASCII 字符的编码。 |
| [SevenBit](#SevenBit) | 数据采用 7 位 US-ASCII 字符。 |
| [UUEncode](#UUEncode) | UUEncoding 将二进制数据编码以通过 uucp 邮件系统传输。 |
| [Unknown](#Unknown) | 传输编码未知。 |
## 方法
...
Quoted-printable 是一种使用可打印 ASCII 字符的编码。
...
UUEncoding 将二进制数据编码以通过 uucp 邮件系统传输。
