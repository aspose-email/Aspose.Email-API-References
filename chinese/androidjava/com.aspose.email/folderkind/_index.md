...
description: 表示 pst 文件夹的不同类型。
type: docs
weight: 143
url: /zh/androidjava/com.aspose.email/folderkind/
---
...
| [Normal](#Normal) | 表示普通的 pst 文件夹。 |
| [Search](#Search) | 表示搜索文件夹。 |
## 方法
...
表示搜索文件夹。它是一个虚拟文件夹，提供所有符合特定搜索条件的电子邮件项的视图。
