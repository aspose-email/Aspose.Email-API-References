...
type: docs
weight: 225
url: /zh/androidjava/com.aspose.email/mapicalendarstate/
---
...
| 字段 | 描述 |
| --- | --- |
| [Canceled](#Canceled) | 指示 Meeting 对象已被取消。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Meeting](#Meeting) | 指示所表示的日历对象是 Meeting 对象。 |
| [Received](#Received) | 指示所表示的日历对象是从其他人收到的。 |
## 方法
