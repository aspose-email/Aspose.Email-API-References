...
type: docs
weight: 12
url: /zh/androidjava/com.aspose.email/alternateviewcollection/
---
...
| [insertItem(int index, AlternateView item)](#insertItem-int-com.aspose.email.AlternateView-) | 在指定索引处将元素插入到 System.Collections.ObjectModel.Collection1 中。 |
...
| item | [AlternateView](../../com.aspose.email/alternateview) | 要插入的对象。对于引用类型，该值可以为 null。 |
