...
description: 与网页引用附件关联的权限类型数据。
type: docs
weight: 55
url: /zh/androidjava/com.aspose.email/attachmentpermissiontype/
---
...
| 字段 | 描述 |
| --- | --- |
| [AnyoneCanEdit](#AnyoneCanEdit) | 任何人都可以编辑网页引用附件。 |
| [AnyoneCanView](#AnyoneCanView) | 任何人只能读取网页引用附件。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [None](#None) | 用户没有共享权限。 |
| [OrganizationCanEdit](#OrganizationCanEdit) | 仅属于同一组织的用户可以编辑 Web 引用附件。 |
| [OrganizationCanView](#OrganizationCanView) | 仅属于同一组织的用户只能读取 Web 引用附件。 |
| [RecipientsCanEdit](#RecipientsCanEdit) | 用户可以编辑 Web 引用附件。 |
| [RecipientsCanView](#RecipientsCanView) | 用户只能读取 Web 引用附件。 |
## 方法
