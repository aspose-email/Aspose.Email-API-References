...
description: 表示 mboxrd 格式的存储读取器，此格式被 Thunderbird 和其他邮件客户端使用。
type: docs
weight: 299
url: /zh/androidjava/com.aspose.email/mboxrdstoragereader/
---
...
表示 mboxrd 格式的存储读取器，该格式被 Thunderbird 和其他邮件客户端使用。
## 构造函数

| 构造函数 | 描述 |
| --- | --- |
| [MboxrdStorageReader(InputStream stream, boolean leaveOpen)](#MboxrdStorageReader-java.io.InputStream-boolean-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
| [MboxrdStorageReader(System.IO.Stream stream, boolean leaveOpen)](#MboxrdStorageReader-com.aspose.ms.System.IO.Stream-boolean-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
| [MboxrdStorageReader(String fileName, boolean leaveOpen)](#MboxrdStorageReader-java.lang.String-boolean-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
| [MboxrdStorageReader(InputStream stream, MboxLoadOptions options)](#MboxrdStorageReader-java.io.InputStream-com.aspose.email.MboxLoadOptions-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
| [MboxrdStorageReader(System.IO.Stream stream, MboxLoadOptions options)](#MboxrdStorageReader-com.aspose.ms.System.IO.Stream-com.aspose.email.MboxLoadOptions-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
| [MboxrdStorageReader(String fileName, MboxLoadOptions options)](#MboxrdStorageReader-java.lang.String-com.aspose.email.MboxLoadOptions-) | 初始化 [MboxrdStorageReader](../../com.aspose.email/mboxrdstoragereader) 类的新实例。 |
## 方法
