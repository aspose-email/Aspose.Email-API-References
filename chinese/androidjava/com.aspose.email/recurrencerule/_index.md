...
description: 表示循环模式中的一个循环或例外规则。
type: docs
weight: 362
url: /zh/androidjava/com.aspose.email/recurrencerule/
---
...
注意，如果发现 ByXXX 规则部分的值超出可用范围
范围（例如，二月中的 BYMONTHDAY=30），它们将被简单地忽略。

信息未包含在规则中，但对于确定各种重复实例是必要的
开始时间和日期来源于 ```
