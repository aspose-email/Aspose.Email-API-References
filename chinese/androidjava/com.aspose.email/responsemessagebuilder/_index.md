...
description: 提供创建和格式化转发及回复消息的功能。
type: docs
weight: 377
url: /zh/androidjava/com.aspose.email/responsemessagebuilder/
---
...
| 方法 | 描述 |
| --- | --- |
| [buildResponse(MailMessage msg)](#buildResponse-com.aspose.email.MailMessage-) | 构建转发和回复消息。 |
| [buildResponse(MapiMessage msg)](#buildResponse-com.aspose.email.MapiMessage-) | 构建转发和回复消息。 |
