...
description: 表示仅在调试时才启用的追加器。
type: docs
weight: 108
url: /zh/androidjava/com.aspose.email/debugappender/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [DebugAppender()](#DebugAppender--) | 初始化 [DebugAppender](../../com.aspose.email/debugappender) 类的新实例。 |
## 方法
...
初始化 [DebugAppender](../../com.aspose.email/debugappender) 类的新实例。
