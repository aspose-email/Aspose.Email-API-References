...
type: docs
weight: 231
url: /zh/androidjava/com.aspose.email/mapicalendarweeklyrecurrencepattern/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MapiCalendarWeeklyRecurrencePattern()](#MapiCalendarWeeklyRecurrencePattern--) | 初始化 [MapiCalendarWeeklyRecurrencePattern](../../com.aspose.email/mapicalendarweeklyrecurrencepattern) 类的新实例。 |
## 方法
...
| [getPeriod()](#getPeriod--) | 获取或设置会议模式重复的间隔（以周为单位） |
...
| [setPeriod(long value)](#setPeriod-long-) | 获取或设置会议模式重复的间隔（以周为单位） |
...
初始化 [MapiCalendarWeeklyRecurrencePattern](../../com.aspose.email/mapicalendarweeklyrecurrencepattern) 类的新实例。
