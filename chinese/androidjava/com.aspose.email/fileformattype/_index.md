...
type: docs
weight: 138
url: /zh/androidjava/com.aspose.email/fileformattype/
---
...
| --- | --- |
| [Eml](#Eml) | MIME 标准中的文件。 |
| [Emlx](#Emlx) | Apple 的 Mail.app 程序文件格式。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [Ics](#Ics) | iCalendar 文件格式。 |
| [Mbox](#Mbox) | 用于保存电子邮件消息集合的文件格式。 |
| [Mht](#Mht) | 文件是单文件网页，也称为 Web 存档文件。 |
| [Msg](#Msg) | Outlook MSG 文件格式。 |
| [Oft](#Oft) | 用于消息模板的 Outlook MSG 文件格式。 |
| [Olm](#Olm) | Outlook for Mac 文件格式。 |
| [Ost](#Ost) | 用于离线模式的 Outlook Data Files 格式。 |
| [Pst](#Pst) | Outlook Data Files 格式。 |
| [Tgz](#Tgz) | TAR 存档文件格式。 |
| [Tnef](#Tnef) | 传输中立封装格式。 |
...
TAR 存档文件格式。Zimbra 邮件客户端使用 TGZ 导出邮箱数据。
