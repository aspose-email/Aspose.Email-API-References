...
type: docs
weight: 121
url: /zh/androidjava/com.aspose.email/emlvalidationerrortype/
---
...
| 字段 | 描述 |
| --- | --- |
| [EmailAddressError](#EmailAddressError) | 指示电子邮件地址无效。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [MessageStructureError](#MessageStructureError) | 指示消息结构不正确。 |
| [TransferEncodingError](#TransferEncodingError) | 指示消息包含意外的未编码非 ASCII 数据。 |
## 方法
