...
description: 提供创建和格式化转发消息的功能。
type: docs
weight: 151
url: /zh/androidjava/com.aspose.email/forwardmessagebuilder/
---
...
| 方法 | 描述 |
| --- | --- |
| [buildResponse(MailMessage msg)](#buildResponse-com.aspose.email.MailMessage-) | 构建转发消息。 |
| [buildResponse(MapiMessage msg)](#buildResponse-com.aspose.email.MapiMessage-) | 构建转发消息。 |
