...
description: 这是一个抽象基类，供允许用户在从特定格式加载 MailMessage 时指定其他选项的类使用。
type: docs
weight: 180
url: /zh/androidjava/com.aspose.email/loadoptions/
---
...
这是一个抽象基类，供允许用户在从特定格式加载 MailMessage 时指定其他选项的类使用。
## 构造函数
