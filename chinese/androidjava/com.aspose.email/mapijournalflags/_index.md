...
description: 包含关于日志对象的元数据。
type: docs
weight: 259
url: /zh/androidjava/com.aspose.email/mapijournalflags/
---
...
包含关于 Journal 对象的元数据。必须为零或以下值之一。
## 字段

| 字段 | 描述 |
| --- | --- |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [HasAttachment](#HasAttachment) | Journal 对象具有与日志关联的附件。 |
| [None](#None) | Journal 对象没有与日志关联的附件。 |
## 方法
