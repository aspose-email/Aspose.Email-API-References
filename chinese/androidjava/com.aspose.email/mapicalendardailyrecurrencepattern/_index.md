...
description: 表示 MAPI 日历的每日重复模式
type: docs
weight: 209
url: /zh/androidjava/com.aspose.email/mapicalendardailyrecurrencepattern/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MapiCalendarDailyRecurrencePattern()](#MapiCalendarDailyRecurrencePattern--) | 初始化 [MapiCalendarDailyRecurrencePattern](../../com.aspose.email/mapicalendardailyrecurrencepattern) 类的新实例。 |
## 方法
...
| [getPeriod()](#getPeriod--) | 获取或设置会议模式重复的间隔（以天为单位） |
...
| [setPeriod(long value)](#setPeriod-long-) | 获取或设置会议模式重复的间隔（以天为单位） |
...
初始化 [MapiCalendarDailyRecurrencePattern](../../com.aspose.email/mapicalendardailyrecurrencepattern) 类的新实例。
