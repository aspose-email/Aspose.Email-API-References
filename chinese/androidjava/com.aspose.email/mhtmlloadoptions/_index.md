...
type: docs
weight: 323
url: /zh/androidjava/com.aspose.email/mhtmlloadoptions/
---
...
如果消息包含 TNEF 附件（winmail.dat）且其 MIME 类型为 application/ms-tnef，则此属性定义是否对 TNEF 中的文件进行解码和提取。如果属性值为 true，winmail.dat 附件将保持原样。
