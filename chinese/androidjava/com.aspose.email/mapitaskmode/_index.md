...
description: 表示任务对象的分配状态。
type: docs
weight: 288
url: /zh/androidjava/com.aspose.email/mapitaskmode/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [MapiTaskMode()](#MapiTaskMode--) | MapiTaskMode 的构造函数。 |
## 字段

| 字段 | 描述 |
| --- | --- |
| [Accepted](#Accepted) | 任务对象已被任务受让人接受。 |
| [Assigned](#Assigned) | 任务对象已分配给任务指派者（自我委派）。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [NotAssigned](#NotAssigned) | 任务对象未分配。 |
| [Rejected](#Rejected) | 任务对象被任务受让人拒绝。 |
| [RequestEmbedded](#RequestEmbedded) | 任务对象嵌入在任务请求中。 |
| [UpdateEmbedded](#UpdateEmbedded) | 任务对象嵌入在任务更新中。 |
## 方法
