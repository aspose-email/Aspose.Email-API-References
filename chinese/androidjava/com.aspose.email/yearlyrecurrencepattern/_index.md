...
description: 表示年度重复类型的重复模式。
type: docs
weight: 448
url: /zh/androidjava/com.aspose.email/yearlyrecurrencepattern/
---
...
| 构造函数 | 描述 |
| --- | --- |
| [YearlyRecurrencePattern()](#YearlyRecurrencePattern--) | 初始化一个新的 [YearlyRecurrencePattern](../../com.aspose.email/yearlyrecurrencepattern) 类的实例。 |
| [YearlyRecurrencePattern(int startOffset, int startMonth)](#YearlyRecurrencePattern-int-int-) | 初始化一个新的 [YearlyRecurrencePattern](../../com.aspose.email/yearlyrecurrencepattern) 类的实例。 |
| [YearlyRecurrencePattern(int startDay, int startMonth, int startPosition)](#YearlyRecurrencePattern-int-int-int-) | 初始化一个新的 [YearlyRecurrencePattern](../../com.aspose.email/yearlyrecurrencepattern) 类的实例。 |
## 方法
...
| [getStartMonth()](#getStartMonth--) | 获取或设置开始月份。 |
...
| [setStartMonth(int value)](#setStartMonth-int-) | 获取或设置开始月份。 |
...
初始化一个新的 [YearlyRecurrencePattern](../../com.aspose.email/yearlyrecurrencepattern) 类的实例。
