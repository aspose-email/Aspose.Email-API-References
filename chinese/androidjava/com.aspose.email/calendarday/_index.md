...
type: docs
weight: 66
url: /zh/androidjava/com.aspose.email/calendarday/
---
...
| 字段 | 描述 |
| --- | --- |
| [Day](#Day) | 表示一周的所有天：SU、MO、TU、WE、TH、FR、SA。 |
...
| [WeekDay](#WeekDay) | 表示一周的工作日：MO,TU,WE,TH,FR。 |
| [WeekendDay](#WeekendDay) | 表示一周的周末日：SU,SA。 |
## 方法
