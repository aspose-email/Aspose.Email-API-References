...
description: 表示 HtmlSaveOptions.SaveResourceHandler 的处理程序。
type: docs
weight: 379
url: /zh/androidjava/com.aspose.email/saveresourcehandler/
---
...
表示 HtmlSaveOptions.SaveResourceHandler 的处理程序。
## 构造函数
