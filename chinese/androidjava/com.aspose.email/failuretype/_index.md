...
type: docs
weight: 131
url: /zh/androidjava/com.aspose.email/failuretype/
---
...
| 字段 | 描述 |
| --- | --- |
| [DataCorrupted](#DataCorrupted) | 项目数据已损坏，无法检索。 |
| [EnumSeparatorCharArray](#EnumSeparatorCharArray) |  |
| [FileCorrupted](#FileCorrupted) | pst 文件已损坏，无法读取项目。 |
| [FileHeaderCorrupted](#FileHeaderCorrupted) | 文件头已损坏，但可能仍能读取文件。 |
| [ReferenceLost](#ReferenceLost) | 项目引用已丢失，但数据可能仍然存在。 |
| [Unknown](#Unknown) | 发生了未知类型的错误。 |
## 方法
