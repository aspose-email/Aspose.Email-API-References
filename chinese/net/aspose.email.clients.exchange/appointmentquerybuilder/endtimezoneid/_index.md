...
description: 获取允许查找具有指定 EndTimeZoneId 的项目的字段
type: docs
weight: 20
url: /zh/net/aspose.email.clients.exchange/appointmentquerybuilder/endtimezoneid/
---
## AppointmentQueryBuilder.EndTimeZoneId property

获取允许查找具有指定 EndTimeZoneId 的项目的字段。
