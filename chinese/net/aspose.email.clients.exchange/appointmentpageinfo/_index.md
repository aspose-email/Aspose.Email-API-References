...
type: docs
weight: 3030
url: /zh/net/aspose.email.clients.exchange/appointmentpageinfo/
---
...
| [Items](../../aspose.email.clients.exchange/appointmentpageinfo/items) { get; } | 获取 ExchangeMessageInfo 对象的集合 |
...
| override [NextPage](../../aspose.email.clients.exchange/appointmentpageinfo/nextpage) { get; } | 下一页的信息，如果当前页是最后一页，则为 null |
