...
type: docs
weight: 16450
url: /zh/net/aspose.email.clients.imap/imappageinfo/
---
## ImapPageInfo class
...
| [Items](../../aspose.email.clients.imap/imappageinfo/items) { get; } | 获取 ImapMessageInfo 对象的集合 |
...
| override [NextPage](../../aspose.email.clients.imap/imappageinfo/nextpage) { get; } | 下一页的信息，如果当前页是最后一页，则为 null |
