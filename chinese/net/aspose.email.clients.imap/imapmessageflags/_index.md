...
| 姓名 | 描述 |
| --- | --- |
| static [Answered](../../aspose.email.clients.imap/imapmessageflags/answered) { get; } | 消息已回复。 |
...
| static [IsRead](../../aspose.email.clients.imap/imapmessageflags/isread) { get; } | 消息已读。 |
...
| override [Equals](../../aspose.email.clients.imap/imapmessageflags/equals#equals_1)(object) | 判断是否指定Object等于这个实例。 |
...
| [IsEmpty](../../aspose.email.clients.imap/imapmessageflags/isempty)() | 判断此实例是否为空。 |
| [Split](../../aspose.email.clients.imap/imapmessageflags/split)() | 拆分为数组。 |
| override [ToString](../../aspose.email.clients.imap/imapmessageflags/tostring)() | 返回一个String代表这个实例。 |
...
| [implicit operator](../../aspose.email.clients.imap/imapmessageflags/op_implicit) | 从Int64至[`ImapMessageFlags`](../imapmessageflags). |
