...
description: GetItemEstimate ActiveSync 协议的命名空间
type: docs
weight: 1300
...
GetItemEstimate ActiveSync 协议的命名空间
...
| 姓名 | 价值 | 描述 |
| --- | --- | --- |
| GetItemEstimate | `5` | GetItemEstimate 元素是 GetItemEstimate 命令请求和 GetItemEstimate 命令响应中的必需元素，它将 HTTP POST 的主体标识为包含 GetItemEstimate 命令（第 2.2.2.7 节）。 |
| Version | `6` | 只有当 MS-ASProtocolVersion 标头设置为 12.1 时，才支持版本标记。 |
