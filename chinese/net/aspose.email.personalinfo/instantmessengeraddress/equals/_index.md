...
type: docs
weight: 60
url: /zh/net/aspose.email.personalinfo/instantmessengeraddress/equals/
---
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| obj | InstantMessengerAddress | 要与当前对象比较的对象。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| x | InstantMessengerAddress | 要比较的第一个对象。 |
| y | InstantMessengerAddress | 要比较的第二个对象。 |
