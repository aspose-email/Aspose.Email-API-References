...
| 姓名 | 描述 |
| --- | --- |
| [Add](../../aspose.email.personalinfo/eventlist/add)(CustomerEvent) | 将项目添加到列表中。 |
| [Clear](../../aspose.email.personalinfo/eventlist/clear)() | 从列表中删除所有项目。 |
| [Contains](../../aspose.email.personalinfo/eventlist/contains)(CustomerEvent) | 确定列表是否包含特定值。 |
