...
description: MessageInfo 表示从邮件服务器获取的 E-Mail 消息信息
type: docs
weight: 16760
url: /zh/net/aspose.email.clients/messageinfobase/
---
## MessageInfoBase class

MessageInfo 表示从邮件服务器获取的 E-Mail 消息信息。
...
| 姓名 | 描述 |
| --- | --- |
| [MessageInfoBase](messageinfobase)() | 初始化[`MessageInfoBase`](../messageinfobase)类的新实例。 |
