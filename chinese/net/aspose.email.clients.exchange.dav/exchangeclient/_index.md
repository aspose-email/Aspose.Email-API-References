...
description: ExchangeClient 类允许应用程序通过使用 WebDav Exchange 存储协议来管理 Microsoft Exchange Server 中的电子邮件箱
type: docs
weight: 3150
...
| 姓名 | 描述 |
| --- | --- |
| [ExchangeClient](exchangeclient#constructor)(string, ICredentials) | 初始化类的新实例[`交易所客户端`](../exchangeclient) |
| [ExchangeClient](exchangeclient#constructor_1)(string, string, string) | 初始化类的新实例[`交易所客户端`](../exchangeclient) |
| [ExchangeClient](exchangeclient#constructor_2)(string, string, string, string) | 初始化类的新实例[`交易所客户端`](../exchangeclient) |
...
| [DeleteMessage](../../aspose.email.clients.exchange.dav/exchangeclient/deletemessage#deletemessage)(string) | 删除邮件消息。 |
| [DeleteMessage](../../aspose.email.clients.exchange.dav/exchangeclient/deletemessage#deletemessage_1)(string, bool) | 删除邮件消息。 |
...
| [FetchMapiMessage](../../aspose.email.clients.exchange.dav/exchangeclient/fetchmapimessage)(string) | 使用指定的 uri 获取 mapi 消息。 |
...
| [GetMailboxSize](../../aspose.email.clients.exchange.dav/exchangeclient/getmailboxsize#getmailboxsize)() | 获取邮箱的大小 |
| [GetMailboxSize](../../aspose.email.clients.exchange.dav/exchangeclient/getmailboxsize#getmailboxsize_1)(string) | 获取邮箱的大小 |
...
| [ListMessages](../../aspose.email.clients.exchange.dav/exchangeclient/listmessages#listmessages_3)(string, bool) | 列出指定文件夹中的邮件 |
...
| [ListMessages](../../aspose.email.clients.exchange.dav/exchangeclient/listmessages#listmessages_5)(string, int, ExchangeListMessagesOptions) | 列出指定文件夹中的邮件 |
...
| [ListSubFolders](../../aspose.email.clients.exchange.dav/exchangeclient/listsubfolders#listsubfolders)(ExchangeFolderInfo) | 从 parent 获取子公用文件夹的集合 |
| [ListSubFolders](../../aspose.email.clients.exchange.dav/exchangeclient/listsubfolders#listsubfolders_1)(string) | 从 parent 获取子文件夹的集合 |
...
| [ResolveContacts](../../aspose.email.clients.exchange.dav/exchangeclient/resolvecontacts)(string) | 解决不明确的邮箱显示名称。 注意：返回的联系人的最大计数为 100。这是使用交换命令的限制。 |
...
| [Restore](../../aspose.email.clients.exchange.dav/exchangeclient/restore#restore_4)(string, ExchangeFolderInfoCollection, RestoreOptions) | 从指定的个人存储文件恢复指定的交换文件夹。 |
| [SaveMessage](../../aspose.email.clients.exchange.dav/exchangeclient/savemessage#savemessage)(string, Stream) | 保存消息。 |
| [SaveMessage](../../aspose.email.clients.exchange.dav/exchangeclient/savemessage#savemessage_1)(string, string) | 将 uri 指定的邮件消息保存到本地文件系统。邮件消息文件是符合 RFC 822 的格式 (EML)。 如果要解析邮件消息文件，请使用[`MailMessage`](../../aspose.email/mailmessage). |
