...
description: 在出现 Notes 文件夹的指定事件类型时发生
type: docs
weight: 300
url: /zh/net/aspose.email.clients.exchange.webservice/iewsclient/notesfolderservernotifications/
---
## IEWSClient.NotesFolderServerNotifications event

在出现 Notes 文件夹的指定事件类型时发生。
