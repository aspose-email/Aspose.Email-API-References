...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| mailbox | String | 用于初始化文件夹id类。 |
| folder | String | 搜索邮件的文件夹 |
| recursive | Boolean | 表示是否递归列表 |
...
| query | MailQuery | [`MailQuery`](../../../aspose.email.tools.search/mailquery)表示邮件搜索条件。 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| folder | String | 一个文件夹在 |
| recursive | Boolean | 中搜索消息 |
...
| --- | --- | --- |
| folder | String | 一个文件夹在 |
| options | ExchangeListMessagesOptions | 中搜索消息 指定列表设置 |
| extendedProperties | IEnumerable`1 | 检索消息的扩展属性 |
...
| 范围 | 类型 | 描述 |
| --- | --- | --- |
| iDs | IEnumerable`1 | 枚举消息 ID |

### 返回值

[`ExchangeMessageInfoCollection`](../../../aspose.email.clients.exchange/exchangemessageinfocollection)包含消息。
...
[`ExchangeMessageInfoCollection`](../../../aspose.email.clients.exchange/exchangemessageinfocollection)来自收件箱文件夹。
