...
description: 获取或设置委托用户对默认日历文件夹的权限
type: docs
weight: 20
url: /zh/net/aspose.email.clients.exchange.webservice/exchangedelegatepermissions/calendarfolderpermissionlevel/
---
## ExchangeDelegatePermissions.CalendarFolderPermissionLevel property

获取或设置委托用户对默认日历文件夹的权限
