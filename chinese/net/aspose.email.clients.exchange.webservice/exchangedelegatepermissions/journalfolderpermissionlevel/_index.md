...
description: 获取或设置委托用户对默认日记文件夹的权限
type: docs
weight: 50
url: /zh/net/aspose.email.clients.exchange.webservice/exchangedelegatepermissions/journalfolderpermissionlevel/
---
## ExchangeDelegatePermissions.JournalFolderPermissionLevel property

获取或设置委托用户对默认日记文件夹的权限
