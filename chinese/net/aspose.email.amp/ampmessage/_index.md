...
| 姓名 | 描述 |
| --- | --- |
| [AmpMessage](ampmessage)() | 初始化[`MailMessage`](../../aspose.email/mailmessage)类的新实例 |
...
| virtual [AmpHtmlBody](../../aspose.email.amp/ampmessage/amphtmlbody) { get; set; } | 获取消息正文的 AmpHtml 表示。 |
...
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner) | 创建签名消息。 创建指定 MailMessage 的只读副本并为其添加数字签名。 |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2) | 创建签名消息。 创建指定 MailMessage 的只读副本并为其添加数字签名。 |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(CmsSigner, bool) | 创建签名消息。 创建指定 MailMessage 的只读副本并为其添加数字签名。 |
| virtual [AttachSignature](../../aspose.email/mailmessage/attachsignature)(X509Certificate2, bool) | 创建签名消息。 创建指定 MailMessage 的只读副本并为其添加数字签名。 |
...
| virtual [Save](../../aspose.email/mailmessage/save)(string, SaveOptions) | 将消息保存为带有附加选项的文件。 |
