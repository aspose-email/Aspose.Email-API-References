...
type: docs
weight: 17270
url: /zh/net/aspose.email/emlloadoptions/
---
...
| 姓名 | 描述 |
| --- | --- |
| [EmlLoadOptions](emlloadoptions)() | 初始化此类的新实例，该实例可用于从 Eml 格式加载 MailMessage。 |
...
| [PreserveTnefAttachments](../../aspose.email/emlloadoptions/preservetnefattachments) { get; set; } | 控制加载 TNEF 附件行为。 |
