...
description: 初始化ExchangeExceptionaspose.email/exchangeexception类.
type: docs
weight: 10
...
初始化[`ExchangeException`](../../exchangeexception)类.
...
初始化[`ExchangeException`](../../exchangeexception)具有指定错误消息的类。
