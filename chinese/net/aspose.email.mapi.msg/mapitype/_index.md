...
| --- | --- | --- |
| None | `0` | 未设置任何值。 |
| PT_SHORT | `2` | 2 字节，16 位整数 |
| PT_LONG | `3` | 4 字节，一个 32 位整数 |
| PT_FLOAT | `4` | 4 字节，32 位浮点数 |
| PT_DOUBLE | `5` | 8 字节，一个 64 位浮点数 |
| PT_CURRENCY | `6` | 8 字节，一个 64 位有符号、缩放整数表示的十进制货币值，小数点右侧有 4 位 |
| PT_APPTIME | `7` | 8 字节，一个 64 位浮点数，其中整数部分表示自 1899 年 12 月 30 日以来的天数，小数部分表示小数部分午夜后的一天 |
| PT_ERROR | `10` | 4字节，32位整数编码错误信息 |
| PT_BOOLEAN | `11` | 1 字节，限制为 1 或 0 |
| PT_OBJECT | `13` | 属性值是一个 COM 对象 |
| PT_LONGLONG | `20` | 8 字节，64 位整数 |
| PT_UNICODE | `31` | 可变大小，UTF-16LE 编码的 Unicode 字符串，以空字符结尾 (0x0000) |
| PT_STRING8 | `30` | 可变大小，外部指定编码的多字节字符串，以空字符结尾（单个 0 字节）。 |
| PT_SYSTIME | `64` | 8 字节，一个 64 位整数，表示自 1601 年 1 月 1 日以来 100 纳秒间隔的数量 |
| PT_CLSID | `72` | 16 字节，带有 Data1、Data2 和 Data3 字段的 GUID，采用 little-endian 格式 |
| PT_BINARY | `258` | 可变大小，字节数组 |
