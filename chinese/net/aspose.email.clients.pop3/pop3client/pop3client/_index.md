...
description: 初始化 Pop3Clientaspose.email.clients.pop3/pop3client 类的新实例
type: docs
weight: 10
url: /zh/net/aspose.email.clients.pop3/pop3client/pop3client/
---
## Pop3Client() {#constructor}

初始化 [`Pop3Client`](../../pop3client) 类的新实例
...
| port | Int32 | 端口号 |
| username | String | 用户名 |
| tokenProvider | ITokenProvider | TokenProvider 允许检索访问令牌。 |
| securityOptions | SecurityOptions | 邮件客户端的安全模式 |
