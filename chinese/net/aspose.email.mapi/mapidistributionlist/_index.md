...
| 姓名 | 描述 |
| --- | --- |
| [MapiDistributionList](mapidistributionlist#constructor)() | 初始化[`MapiDistributionList`](../mapidistributionlist)类. |
| [MapiDistributionList](mapidistributionlist#constructor_1)(string, MapiDistributionListMemberCollection) | 初始化[`MapiDistributionList`](../mapidistributionlist)类. |
...
| [DisplayName](../../aspose.email.mapi/mapidistributionlist/displayname) { get; set; } | 获取或设置个人通讯组列表的用户可见名称。 |
