...
description: 包含用于计算延迟发送消息多长时间的数字 区域MapiStatus 规范名称PidTagDeferredSendNumber 备用名称PR_DEFERRED_SEND_NUMBER
type: docs
weight: 3790
...
包含用于计算延迟发送消息多长时间的数字。 区域:MapiStatus 规范名称:PidTagDeferredSendNumber 备用名称:PR_DEFERRED_SEND_NUMBER
