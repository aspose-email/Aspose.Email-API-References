...
description: 指定用于编码此消息对象上的非 Unicode 字符串属性的代码页 区域通用 规范名称PidTagMessageCodepage 别名PR_MESSAGE_CODEPAGE
type: docs
weight: 12480
...
指定用于编码此消息对象上的非 Unicode 字符串属性的代码页。 区域:通用 规范名称:PidTagMessageCodepage 别名:PR_MESSAGE_CODEPAGE
