...
description: 指定发送消息的客户端应用程序的名称 区域常规消息属性 规范名称PidLidCurrentVersionName 备用名称dispidCurrentVersionName
type: docs
weight: 3600
...
指定发送消息的客户端应用程序的名称。 区域：常规消息属性 规范名称：PidLidCurrentVersionName 备用名称：dispidCurrentVersionName
