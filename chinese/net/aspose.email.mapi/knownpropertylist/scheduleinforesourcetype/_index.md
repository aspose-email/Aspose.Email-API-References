...
description: 发送时设置为 0x00000000接收时忽略 区域空闲/忙碌属性 规范名称PidTagScheduleInfoResourceType 备用名称PR_SCHDINFO_RESOURCE_TYPE
type: docs
weight: 16900
...
发送时设置为 0x00000000，接收时忽略。 区域：空闲/忙碌属性 规范名称：PidTagScheduleInfoResourceType 备用名称：PR_SCHDINFO_RESOURCE_TYPE
