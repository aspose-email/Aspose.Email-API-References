...
description: 指示消息对象是否没有最终用户可见的附件 区域运行时配置 规范名称PidLidSmartNoAttach 备用名称dispidSmartNoAttach
type: docs
weight: 18070
...
指示消息对象是否没有最终用户可见的附件。 区域：运行时配置 规范名称：PidLidSmartNoAttach 备用名称：dispidSmartNoAttach
