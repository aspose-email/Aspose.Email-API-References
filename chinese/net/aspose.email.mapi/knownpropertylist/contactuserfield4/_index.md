...
description: 包含用于将自定义文本添加到联系人对象的名片表示的文本 区域联系人属性 规范名称PidLidContactUserField4 替代名称dispidContactUserField4
type: docs
weight: 3080
url: /zh/net/aspose.email.mapi/knownpropertylist/contactuserfield4/
---
## KnownPropertyList.ContactUserField4 field

包含用于将自定义文本添加到联系人对象的名片表示的文本。 区域：联系人属性 规范名称：PidLidContactUserField4 替代名称：dispidContactUserField4
