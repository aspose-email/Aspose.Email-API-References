...
description: 指定一个位字段指示会议对象如何更改 区域会议 规范名称PidLidChangeHighlight 别名dispidChangeHighlight
type: docs
weight: 2560
...
指定一个位字段，指示会议对象如何更改。 区域:会议 规范名称:PidLidChangeHighlight 别名:dispidChangeHighlight
