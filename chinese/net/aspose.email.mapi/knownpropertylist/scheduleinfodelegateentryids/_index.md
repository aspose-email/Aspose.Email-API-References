...
description: 指定代表的 EntryID 区域忙/闲属性 规范名称PidTagScheduleInfoDelegateEntryIds 备用名称PR_SCHDINFO_DELEGATE_ENTRYIDS
type: docs
weight: 16730
...
指定代表的 EntryID。 区域：忙/闲属性 规范名称：PidTagScheduleInfoDelegateEntryIds 备用名称：PR_SCHDINFO_DELEGATE_ENTRYIDS
