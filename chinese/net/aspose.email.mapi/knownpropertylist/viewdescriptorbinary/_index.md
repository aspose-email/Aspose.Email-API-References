...
description: 包含视图定义 区域MessageClassDefinedTransmittable 规范名称PidTagViewDescriptorBinary 替代名称PR_VD_BINARY
type: docs
weight: 19250
...
包含视图定义。 区域：MessageClassDefinedTransmittable 规范名称：PidTagViewDescriptorBinary 替代名称：PR_VD_BINARY
