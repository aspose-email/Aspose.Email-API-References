...
description: 指定非日历对象的初始信号时间 区域Reminders 规范名称PidLidReminderTime 替代名称dispidReminderTime
type: docs
weight: 15740
...
指定非日历对象的初始信号时间。 区域：Reminders 规范名称：PidLidReminderTime 替代名称：dispidReminderTime
