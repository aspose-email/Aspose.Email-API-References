...
description: 包含一个无论客户端生成什么值都被服务器忽略的值 区域共享 规范名称PidLidSharingRemoteCrc 替代名称dispidSharingRemoteCrc
type: docs
weight: 17790
...
包含一个无论客户端生成什么值都被服务器忽略的值。 区域:共享 规范名称:PidLidSharingRemoteCrc 替代名称:dispidSharingRemoteCrc
