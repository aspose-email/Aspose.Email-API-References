...
description: 包含一个无论客户端生成什么值服务器都会忽略的值 区域Sharing 规范名称PidLidSharingBrowseUrl 替代名称dispidSharingBrowseUrl
type: docs
weight: 17410
...
包含一个无论客户端生成什么值，服务器都会忽略的值。 区域：Sharing 规范名称：PidLidSharingBrowseUrl 替代名称：dispidSharingBrowseUrl
