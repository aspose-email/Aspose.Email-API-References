...
description: 表示任务的接受状态 区域Tasks 规范名称PidLidTaskAcceptanceState 替代名称dispidTaskDelegValue
type: docs
weight: 18530
...
表示任务的接受状态。 区域：Tasks 规范名称：PidLidTaskAcceptanceState 替代名称：dispidTaskDelegValue
