...
description: 此属性已弃用且不被使用 区域忙/闲属性 规范名称PidTagScheduleInfoFreeBusy 替代名称PR_SCHDINFO_FREEBUSY
type: docs
weight: 16810
...
此属性已弃用且不被使用。 区域:忙/闲属性 规范名称:PidTagScheduleInfoFreeBusy 替代名称:PR_SCHDINFO_FREEBUSY
