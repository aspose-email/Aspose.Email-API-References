...
description: 包含提供有关重复任务的信息的 RecurrencePattern 结构 区域任务 规范名称PidLidTaskRecurrence 替代名称dispidTaskRecur
type: docs
weight: 18780
...
包含提供有关重复任务的信息的 RecurrencePattern 结构。 区域:任务 规范名称:PidLidTaskRecurrence 替代名称:dispidTaskRecur
