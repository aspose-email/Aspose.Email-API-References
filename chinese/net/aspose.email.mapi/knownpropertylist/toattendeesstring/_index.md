...
description: 包含所有可发送与会者的列表这些与会者也是必需的与会者 区域会议 规范名称PidLidToAttendeesString 替代名称dispidToAttendeesString
type: docs
weight: 19020
...
包含所有可发送与会者的列表，这些与会者也是必需的与会者。 区域:会议 规范名称:PidLidToAttendeesString 替代名称:dispidToAttendeesString
