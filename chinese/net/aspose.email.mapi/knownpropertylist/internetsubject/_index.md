...
description: 指定邮件的主题 区域Email 规范名称PidNameInternetSubject 备用名称urnschemasmailheadersubject
type: docs
weight: 11590
...
指定邮件的主题。 区域：Email 规范名称：PidNameInternetSubject 备用名称：urn:schemas:mailheader:subject
