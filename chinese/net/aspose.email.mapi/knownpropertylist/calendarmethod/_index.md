...
description: 指定与约会对象关联的 iCalendar 方法 区域Common 规范名称PidNameCalendarMethod 备用名称urnschemascalendarmethod
type: docs
weight: 2340
...
指定与约会对象关联的 iCalendar 方法。 区域：Common 规范名称：PidNameCalendarMethod 备用名称：urn:schemas:calendar:method
