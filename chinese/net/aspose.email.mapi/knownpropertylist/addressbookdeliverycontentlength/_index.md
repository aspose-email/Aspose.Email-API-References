...
description: 指定收件人可以接收的消息的最大大小以字节为单位 区域地址簿 规范名称PidTagAddressBookDeliveryContentLength 备用名称PR_EMS_AB_DELIV_CONT_LENGTH
type: docs
weight: 350
...
指定收件人可以接收的消息的最大大小（以字节为单位）。 区域:地址簿 规范名称:PidTagAddressBookDeliveryContentLength 备用名称:PR_EMS_AB_DELIV_CONT_LENGTH
