...
description: 指定约会或会议的时区 区域通用 规范名称PidNameCalendarTimeZone 备用名称urnschemascalendartimezone
type: docs
weight: 2410
...
指定约会或会议的时区。 区域:通用 规范名称:PidNameCalendarTimeZone 备用名称:urn:schemas:calendar:timezone
