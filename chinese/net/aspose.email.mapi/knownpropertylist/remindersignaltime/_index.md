...
description: 指定提醒从待处理过渡到过期的时间点 区域Reminders 规范名称PidLidReminderSignalTime 替代名称dispidReminderNextTime
type: docs
weight: 15720
...
指定提醒从待处理过渡到过期的时间点。 区域：Reminders 规范名称：PidLidReminderSignalTime 替代名称：dispidReminderNextTime
