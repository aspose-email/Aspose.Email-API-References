...
description: 包含表示重复系列异常的对象的 ID 区域Meetings 规范名称PidLidGlobalObjectId 替代名称LID_GLOBAL_OBJID
type: docs
weight: 10790
...
包含表示重复系列异常的对象的 ID。 区域：Meetings 规范名称：PidLidGlobalObjectId 替代名称：LID_GLOBAL_OBJID
