...
description: 描述用于检索通讯簿信息的模板中使用的控件 区域地址簿 规范名称PidTagTemplateData 替代名称PR_EMS_TEMPLATE_BLOB
type: docs
weight: 18910
...
描述用于检索通讯簿信息的模板中使用的控件。 区域:地址簿 规范名称:PidTagTemplateData 替代名称:PR_EMS_TEMPLATE_BLOB
