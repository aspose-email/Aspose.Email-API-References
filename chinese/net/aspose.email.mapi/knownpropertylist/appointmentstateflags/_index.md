...
description: 指定描述对象状态的位域 区域会议 规范名称PidLidAppointmentStateFlags 替代名称dispidApptStateFlags
type: docs
weight: 1330
...
指定描述对象状态的位域。 区域:会议 规范名称:PidLidAppointmentStateFlags 替代名称:dispidApptStateFlags
