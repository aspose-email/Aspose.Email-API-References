...
description: 包含一个无论客户端生成什么值都被服务器忽略的值 区域共享 规范名称PidLidSharingAnonymity 替代名称dispidSharingAnonymity
type: docs
weight: 17390
...
包含一个无论客户端生成什么值都被服务器忽略的值。 区域:共享 规范名称:PidLidSharingAnonymity 替代名称:dispidSharingAnonymity
