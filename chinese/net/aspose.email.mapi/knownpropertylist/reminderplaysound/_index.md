...
description: 指定客户端是否在提醒过期时播放声音 区域Reminders 规范名称PidLidReminderPlaySound 替代名称dispidReminderPlaySound
type: docs
weight: 15700
...
指定客户端是否在提醒过期时播放声音。 区域：Reminders 规范名称：PidLidReminderPlaySound 替代名称：dispidReminderPlaySound
