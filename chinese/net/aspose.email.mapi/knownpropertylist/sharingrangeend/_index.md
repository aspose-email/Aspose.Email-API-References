...
description: 包含一个无论客户端生成什么值服务器都会忽略的值 区域Sharing 规范名称PidLidSharingRangeEnd 替代名称dispidSharingRangeEnd
type: docs
weight: 17740
...
包含一个无论客户端生成什么值，服务器都会忽略的值。 区域：Sharing 规范名称：PidLidSharingRangeEnd 替代名称：dispidSharingRangeEnd
