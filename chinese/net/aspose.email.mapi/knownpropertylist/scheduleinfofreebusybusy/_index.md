...
description: 指定空闲/忙碌状态设置为忙碌值的时间块 区域空闲/忙碌属性 规范名称PidTagScheduleInfoFreeBusyBusy 替代名称PR_SCHDINFO_FREEBUSY_BUSY
type: docs
weight: 16830
...
指定空闲/忙碌状态设置为忙碌值的时间块。 区域：空闲/忙碌属性 规范名称：PidTagScheduleInfoFreeBusyBusy 替代名称：PR_SCHDINFO_FREEBUSY_BUSY
