...
description: 指定包含约会或会议描述的资源的 URL 区域通用 规范名称PidNameCalendarDescriptionUrl 替代名称urnschemascalendardescriptionurl
type: docs
weight: 2230
...
指定包含约会或会议描述的资源的 URL。 区域:通用 规范名称:PidNameCalendarDescriptionUrl 替代名称:urn:schemas:calendar:descriptionurl
