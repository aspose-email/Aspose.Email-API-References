...
description: 指示是否可以永久删除标识为垃圾邮件的邮件 区域垃圾邮件 规范名称PidTagJunkPermanentlyDelete 备用名称PR_JUNK_PERMANENTLY_DELETE
type: docs
weight: 11890
...
指示是否可以永久删除标识为垃圾邮件的邮件。 区域:垃圾邮件 规范名称:PidTagJunkPermanentlyDelete 备用名称:PR_JUNK_PERMANENTLY_DELETE
