...
description: 包含一个无论客户端生成什么值都被服务器忽略的值 区域共享 规范名称PidLidSharingRemoteVersion 替代名称dispidSharingRemoteVersion
type: docs
weight: 17890
...
包含一个无论客户端生成什么值都被服务器忽略的值。 区域:共享 规范名称:PidLidSharingRemoteVersion 替代名称:dispidSharingRemoteVersion
