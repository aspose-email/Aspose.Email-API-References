...
description: 包含 PidLidSharingProviderGuid 属性值的十六进制字符串表示形式第 2.266 节 区域共享 规范名称PidNameXSharingProviderGuid 备用名称
type: docs
weight: 19780
...
包含 PidLidSharingProviderGuid 属性值的十六进制字符串表示形式（第 2.266 节）。 区域:共享 规范名称:PidNameXSharingProviderGuid 备用名称:
