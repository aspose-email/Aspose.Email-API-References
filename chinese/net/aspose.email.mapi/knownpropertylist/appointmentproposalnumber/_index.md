...
description: 指定发送了未被组织者接受或拒绝的反提案的与会者数量 区域Meetings 规范名称PidLidAppointmentProposalNumber 替代名称dispidApptProposalNum
type: docs
weight: 1210
...
指定发送了未被组织者接受或拒绝的反提案的与会者数量。 区域：Meetings 规范名称：PidLidAppointmentProposalNumber 替代名称：dispidApptProposalNum
