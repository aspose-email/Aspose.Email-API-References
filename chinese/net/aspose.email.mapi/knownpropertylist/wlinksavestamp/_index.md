...
description: 指定一个整数允许客户端以高概率识别导航快捷方式是否由当前客户端会话保存 区域Configuration 规范名称PidTagWlinkSaveStamp 替代名称
type: docs
weight: 19500
...
指定一个整数，允许客户端以高概率识别导航快捷方式是否由当前客户端会话保存。 区域：Configuration 规范名称：PidTagWlinkSaveStamp 替代名称：
