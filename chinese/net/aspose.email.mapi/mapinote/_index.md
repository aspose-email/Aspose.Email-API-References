...
description: 表示 Outlook Note 对象便签
type: docs
weight: 18530
...
| 姓名 | 描述 |
| --- | --- |
| [MapiNote](mapinote#constructor)() | 初始化[`MapiNote`](../mapinote)类. |
| [MapiNote](mapinote#constructor_1)(string, string) | 初始化[`MapiNote`](../mapinote)类. |
...
| [CreationDate](../../aspose.email.mapi/mapinote/creationdate) { get; set; } | 获取或设置note 的创建日期 |
...
| [XPosition](../../aspose.email.mapi/mapinote/xposition) { get; set; } | 获取或设置距离，以像素为单位， 距离屏幕左边缘 用户界面显示注释对象 |
| [YPosition](../../aspose.email.mapi/mapinote/yposition) { get; set; } | 获取或设置距离，以像素为单位， 距离屏幕顶部边缘 用户界面显示注释对象 |
...
| [Save](../../aspose.email.mapi/mapinote/save#save)(Stream, NoteSaveFormat) | 保存这个[`MapiNote`](../mapinote)使用指定格式到给定的流。 |
| [Save](../../aspose.email.mapi/mapinote/save#save_1)(string, NoteSaveFormat) | 保存这个[`MapiNote`](../mapinote)使用指定格式进入文件。 |
