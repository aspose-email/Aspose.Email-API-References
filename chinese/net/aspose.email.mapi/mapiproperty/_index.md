...
| [MapiProperty](mapiproperty#constructor_5)(long, IList&lt;object&gt;) | 初始化[`MapiProperty`](../mapiproperty) class. 此重载用于创建多值属性，PT_MV_*. |
...
| [MapiProperty](mapiproperty#constructor_4)(long, long, byte[]) | 初始化[`MapiProperty`](../mapiproperty)类. |
