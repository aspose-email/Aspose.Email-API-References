...
description: 表示 Outlook 日记对象
type: docs
weight: 18390
url: /zh/net/aspose.email.mapi/mapijournal/
---
## MapiJournal class
...
| 姓名 | 描述 |
| --- | --- |
| [MapiJournal](mapijournal#constructor)() | 初始化[`MapiJournal`](../mapijournal)类的新实例。 |
| [MapiJournal](mapijournal#constructor_1)(string, string, string, string) | 初始化[`MapiJournal`](../mapijournal)类的新实例。 |
...
| [BriefDescription](../../aspose.email.mapi/mapijournal/briefdescription) { get; set; } | 获取或设置正在记录的活动的简要描述 。 |
...
| [Description](../../aspose.email.mapi/mapijournal/description) { get; set; } | 获取或设置正在记录的活动的描述 。 |
| [DocumentStatus](../../aspose.email.mapi/mapijournal/documentstatus) { get; set; } | 获取或设置文档的状态。 |
| [Duration](../../aspose.email.mapi/mapijournal/duration) { get; } | 获取活动的持续时间。 |
| [EndTime](../../aspose.email.mapi/mapijournal/endtime) { get; set; } | 获取或设置活动结束的时间。 |
| [Flags](../../aspose.email.mapi/mapijournal/flags) { get; set; } | 获取或设置包含有关 Journal 对象的元数据 的标志。 |
...
| [StartTime](../../aspose.email.mapi/mapijournal/starttime) { get; set; } | 获取或设置活动开始的时间。 |
...
| [Save](../../aspose.email.mapi/mapijournal/save#save)(Stream) | 保存指定的流。 |
| [Save](../../aspose.email.mapi/mapijournal/save#save_1)(string) | 保存指定的文件名。 |
