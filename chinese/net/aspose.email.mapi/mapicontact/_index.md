...
| 姓名 | 描述 |
| --- | --- |
| [MapiContact](mapicontact#constructor)() | 初始化 [`MapiContact`](../mapicontact) 类的新实例 |
| [MapiContact](mapicontact#constructor_1)(string, string) | 初始化[`MapiContact`](../mapicontact)类的新实例。 |
| [MapiContact](mapicontact#constructor_2)(string, string, string) | 初始化[`MapiContact`](../mapicontact)类的新实例。 |
| [MapiContact](mapicontact#constructor_3)(string, string, string, string) | 初始化[`MapiContact`](../mapicontact)类的新实例。 |
...
| [ElectronicAddresses](../../aspose.email.mapi/mapicontact/electronicaddresses) { get; set; } | 为最多三个不同的 电子邮件地址 和三个不同的传真地址指定属性 |
...
| [ProfessionalInfo](../../aspose.email.mapi/mapicontact/professionalinfo) { get; set; } | 属性用于存储联系人所代表人员的专业 详细信息 |
...
| [Telephones](../../aspose.email.mapi/mapicontact/telephones) { get; set; } | 为联系人指定电话号码 |

## 方法

| 姓名 | 描述 |
| --- | --- |
| static [FromVCard](../../aspose.email.mapi/mapicontact/fromvcard#fromvcard)(Stream) | 从包含 vCard 的指定流中读取 [`MapiContact`](../mapicontact)。 支持的 vCard 版本为 2.1 和 3.0 |
| static [FromVCard](../../aspose.email.mapi/mapicontact/fromvcard#fromvcard_2)(string) | 从指定的 vCard 文件中读取[`MapiContact`](../mapicontact) 支持的 vCard 版本为2.1 和 3.0 |
| static [FromVCard](../../aspose.email.mapi/mapicontact/fromvcard#fromvcard_1)(Stream, Encoding) | 从包含 vCard 的指定流中读取 [`MapiContact`](../mapicontact)。 支持的 vCard 版本为 2.1 和 3.0 |
| static [FromVCard](../../aspose.email.mapi/mapicontact/fromvcard#fromvcard_3)(string, Encoding) | 从指定的 vCard 文件中读取 [`MapiContact`](../mapicontact) 支持的 vCard 版本为 2.1 和 3.0 |
...
| [Save](../../aspose.email.mapi/mapicontact/save#save)(Stream) | 将此[`MapiContact`](../mapicontact)保存到具有 vCard 格式的给定流中。 支持的 vCard 版本为 2.1 |
| [Save](../../aspose.email.mapi/mapicontact/save#save_3)(string) | 使用默认选项将此[`MapiContact`](../mapicontact)保存到 vCard 文件。 支持的 vCard 版本为 2.1 |
| [Save](../../aspose.email.mapi/mapicontact/save#save_1)(Stream, ContactSaveFormat) | 将此[`MapiContact`](../mapicontact)以使用默认选项的格式保存到给定的流。 支持的保存格式是 vCard |
| [Save](../../aspose.email.mapi/mapicontact/save#save_2)(Stream, ContactSaveOptions) | 使用指定的保存选项将此[`MapiContact`](../mapicontact)保存到给定的流。 支持的保存选项是[`VCardSaveOptions`](../../aspose.email.personalinfo.vcard/vcardsaveoptions) |
| [Save](../../aspose.email.mapi/mapicontact/save#save_4)(string, ContactSaveFormat) | 将此[`MapiContact`](../mapicontact)保存到使用默认选项的格式的指定文件中。 支持的保存格式是 vCard。 |
| [Save](../../aspose.email.mapi/mapicontact/save#save_5)(string, ContactSaveOptions) | 使用指定的保存选项将此[`MapiContact`](../mapicontact)保存到文件中。 支持的保存选项是[`VCardSaveOptions`](../../aspose.email.personalinfo.vcard/vcardsaveoptions) |
