...
description: 表示所有 MapiMessageItem 类的基类并保留 mapi 属性附件收件人的公共集合
type: docs
weight: 18440
url: /zh/net/aspose.email.mapi/mapimessageitembase/
---
## MapiMessageItemBase class

表示所有 MapiMessageItem 类的基类，并保留 mapi 属性、附件、收件人的公共集合。
...
| [BodyHtml](../../aspose.email.mapi/mapimessageitembase/bodyhtml) { get; } | 获取转换为 HTML 的消息的[`BodyRtf`](./bodyrtf)，如果存在，否则为空字符串. |
...
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent)(string, BodyContentType) | 设置正文的内容。 |
| virtual [SetBodyContent](../../aspose.email.mapi/mapimessageitembase/setbodycontent#setbodycontent_1)(string, BodyContentType, bool) | 设置正文的内容。 |
...
| override [SetProperty](../../aspose.email.mapi/mapimessageitembase/setproperty#setproperty_1)(PropertyDescriptor, object) | 设置 MAPI 属性。 |
