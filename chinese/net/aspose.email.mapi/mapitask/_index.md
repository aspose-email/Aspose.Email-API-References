...
| 姓名 | 描述 |
| --- | --- |
| [MapiTask](mapitask#constructor)() | 初始化[`MapiTask`](../mapitask)类. |
| [MapiTask](mapitask#constructor_1)(string, string, DateTime, DateTime) | 初始化[`MapiTask`](../mapitask)类. |
...
| [ActualEffort](../../aspose.email.mapi/mapitask/actualeffort) { get; set; } | 获取或设置 用户实际用于某项任务的分钟数。 |
...
| [DueDate](../../aspose.email.mapi/mapitask/duedate) { get; set; } | 获取或设置用户期望任务上的工作 完成的日期。 |
| [EstimatedEffort](../../aspose.email.mapi/mapitask/estimatedeffort) { get; set; } | 获取或设置用户期望在任务上工作的分钟数 。 |
| [Flags](../../aspose.email.mapi/mapitask/flags) { get; } | 获取Task对象的指示标志。 |
| [History](../../aspose.email.mapi/mapitask/history) { get; set; } | 获取或设置上次对 Task 对象进行的更改类型 。 |
| virtual [ItemId](../../aspose.email.mapi/mapimessageitembase/itemid) { get; } | 项目 ID，与服务器一起使用 |
| [LastUpdate](../../aspose.email.mapi/mapitask/lastupdate) { get; set; } | 获取或设置最近 对 Task 对象所做的更改的日期和时间。 |
...
| [StartDate](../../aspose.email.mapi/mapitask/startdate) { get; set; } | 获取或设置用户 期望开始工作的日期。 |
| [State](../../aspose.email.mapi/mapitask/state) { get; set; } | 获取或设置Task对象的当前赋值 状态。 |
...
| static [FromVTodo](../../aspose.email.mapi/mapitask/fromvtodo#fromvtodo_2)(string) | 从指定的 .ics 文件创建 MapiTask 实例。 |
| static [FromVTodo](../../aspose.email.mapi/mapitask/fromvtodo#fromvtodo_1)(Stream, bool) | 从指定的流创建 MapiTask 的实例。 |
| static [FromVTodo](../../aspose.email.mapi/mapitask/fromvtodo#fromvtodo_3)(string, bool) | 从指定的 .ics 文件创建 MapiTask 实例。 |
...
| [Save](../../aspose.email.mapi/mapitask/save#save)(Stream, TaskSaveFormat) | 保存这个[`MapiTask`](../mapitask)使用指定格式到给定的流。 |
| [Save](../../aspose.email.mapi/mapitask/save#save_1)(string, TaskSaveFormat) | 保存这个[`MapiTask`](../mapitask)使用指定格式进入文件。 |
