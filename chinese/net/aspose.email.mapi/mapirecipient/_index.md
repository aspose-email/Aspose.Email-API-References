...
| 姓名 | 描述 |
| --- | --- |
| [AddressType](../../aspose.email.mapi/mapirecipient/addresstype) { get; } | 获取 邮件接收者或发送者的地址类型。 |
...
| [DisplayName](../../aspose.email.mapi/mapirecipient/displayname) { get; set; } | 获取或设置消息的显示名称 收件人或发件人。 |
