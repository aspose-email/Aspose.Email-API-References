...
type: docs
weight: 18620
url: /zh/net/aspose.email.mapi/mapirecipient/
---
## MapiRecipient class
...
| 姓名 | 描述 |
| --- | --- |
| [AddressType](../../aspose.email.mapi/mapirecipient/addresstype) { get; } | 获取 消息接收者或发送者的地址类型。 |
| virtual [CodePage](../../aspose.email.mapi/mapipropertycontainer/codepage) { get; } | 获取代码页。 |
| [Content](../../aspose.email.mapi/mapirecipient/content) { get; } | 获取内容。 |
| [DisplayName](../../aspose.email.mapi/mapirecipient/displayname) { get; set; } | 获取或设置消息 收件人或发件人的显示名称。 |
| [EmailAddress](../../aspose.email.mapi/mapirecipient/emailaddress) { get; set; } | 获取或设置 邮件收件人或发件人的电子邮件地址。 |
| [NamedProperties](../../aspose.email.mapi/mapirecipient/namedproperties) { get; } | 获取消息的命名属性。 |
| [OrganizationEmailAddress](../../aspose.email.mapi/mapirecipient/organizationemailaddress) { get; } | 获取组织电子邮件地址。 |
| virtual [Properties](../../aspose.email.mapi/mapipropertycontainer/properties) { get; } | 获取属性的集合。 |
| [PropertyStream](../../aspose.email.mapi/mapirecipient/propertystream) { get; } | 获取属性流。 |
| [RecipientClass](../../aspose.email.mapi/mapirecipient/recipientclass) { get; } | 获取处方的类型。 |
| [RecipientTrackStatus](../../aspose.email.mapi/mapirecipient/recipienttrackstatus) { get; set; } | 收件人对会议请求的响应状态。 |
| [RecipientType](../../aspose.email.mapi/mapirecipient/recipienttype) { get; } | 获取收件人或发件人的类型。 |
| [SubStorages](../../aspose.email.mapi/mapirecipient/substorages) { get; } | 获取子存储。 |
