...
description: MessageInfo 表示从 Graph 服务获取的服务器项信息
type: docs
weight: 15990
url: /zh/net/aspose.email.clients.graph/messageinfo/
---
## MessageInfo class

MessageInfo 表示从 Graph 服务获取的服务器项信息。
...
| virtual [ItemId](../../aspose.email.clients.graph/messageinfo/itemid) { get; } | 获取消息 URI。 |
